...
Wrong conclusions trigger real operational harm: overtime at the wrong facility, bad reroutes, missed equipment repair, and weekend peak failure.
...
Full normative contract in [§ B. SOLUTION](#b-solution).
...
```text
[View report] [View evidence] [View source] [Run locally]
```
