...
def _incident_graph_spec() -> ApplicationGraphSpec:

    """Single-node graph; revision and acceptance are owned by the platform Decision System."""
...
def prepare_incident_execution_runtime(
    ...
    *,
    ...
    rewire_scenario_decision_wiring(composition.platform)
