# Software Supply Chain Compromise Investigation and Release Containment
...
_Short problem-story abstract (4–8 sentences). Summarize what happened, who has the problem, why it matters, what the naive answer gets wrong, and what the scenario demonstrates. No platform internals or implementation detail._
...
_Full normative PASS/FAIL contract in [Scenario Specification § B](SCENARIO_SPEC.md#pass)._
