-- ERL-QUAL-004 — core PostgreSQL schema (enterprise payment uncertainty recovery)
-- Architecture: docs/ERL_QUAL_004_POSTGRESQL_DATA_MODEL_ARCHITECTURE.md
-- Zones: commerce (application knowledge) | external_sor (integration + SoR truth) | reconciliation
...
-- ---------------------------------------------------------------------------
-- Commerce zone — enterprise buyer and application-owned state
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- External SoR zone — integration effect and authoritative external reality
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Reconciliation zone — audit persistence (no workflow engine)
-- ---------------------------------------------------------------------------
