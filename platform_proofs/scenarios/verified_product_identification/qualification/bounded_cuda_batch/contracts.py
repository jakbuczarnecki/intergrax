...
BOUNDED_CUDA_THROUGHPUT_QUALIFICATION_CLOSEOUT = BoundedCudaThroughputQualificationCloseout(
    ...
    batch_evidence=(
        BatchVariantQualificationEvidence(
            ...
            safe=True,
            selected=True,
            notes="SAFE; selected highest-throughput qualified variant",
        ),
        BatchVariantQualificationEvidence(
            batch_size=4,
            ...
            safe=False,
            selected=False,
            notes="UNSAFE; throughput regressed versus batch 1",
        ),
        BatchVariantQualificationEvidence(
            batch_size=8,
            ...
            safe=False,
            selected=False,
            notes="UNSAFE; throughput regressed versus batch 4",
        ),
        BatchVariantQualificationEvidence(
            batch_size=16,
            ...
            safe=True,
            selected=False,
            notes="SAFE; no regression versus batch 8, but slower than selected batch 1",
        ),
        BatchVariantQualificationEvidence(
            batch_size=32,
