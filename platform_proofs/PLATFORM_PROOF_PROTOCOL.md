...
- Every scenario **MUST** satisfy **Scenario Platform Integration and Pluginability** (Platform First, `## Platform Capability Adoption`, `## Platform Pluginability Audit`, Scenario Architecture Review before enterprise / library acceptance). Normative detail: [PLATFORM_PROOF_AUTHORING_GUIDE.md § Scenario platform integration and pluginability governance](PLATFORM_PROOF_AUTHORING_GUIDE.md#scenario-platform-integration-and-pluginability-governance). Reference scenario: `scenarios/verified_product_identification/`.
