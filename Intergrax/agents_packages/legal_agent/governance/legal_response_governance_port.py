...
Wired from :class:`~intergrax.agents_packages.legal_agent.steps.legal_finalize_answer_step.LegalFinalizeAnswerStep`
...
Ready-made implementations: :mod:`intergrax.agents_packages.legal_agent.governance.legal_response_governance_impl`.
"""
