...
2. `docs/architecture/LLM_ADAPTERS.md` — hub read-scope + one `architecture/satellites/` satellite max
3. `docs/plan/LLM_ADAPTERS.md` — hub + one `plan/satellites/` satellite max
