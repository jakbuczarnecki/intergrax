...
**Audit map layers:** 4–5, 8, 23–24 · compact slice: [`audit_slices/UNIFIED_EXECUTION_RUNTIME.md`](../guides/audit_slices/UNIFIED_EXECUTION_RUNTIME.md)  
...
**Load first:** [`docs/guides/audit_slices/UNIFIED_EXECUTION_RUNTIME.md`](../guides/audit_slices/UNIFIED_EXECUTION_RUNTIME.md) — compact slice (layers **4–5, 8, 23–24**); replaces bulk IDEAL + AUDIT_MAP + full plan/arch reads.
...
1. **`docs/guides/audit_slices/UNIFIED_EXECUTION_RUNTIME.md`** — mandatory; follow slice plan/arch/IDEAL scope lines
2. `docs/architecture/UNIFIED_EXECUTION_RUNTIME.md` — hub read-scope + one `architecture/satellites/` satellite max
3. `docs/plan/UNIFIED_EXECUTION_RUNTIME.md` — hub + one `plan/satellites/` satellite max
4. `docs/audit/README.md` — shared production Harness checklist
5. `@docs/guides/AGENT_CREATION_GUIDE.md` **Appendix H (governance control plane)** — on demand
...
See **Code entry** in `docs/guides/audit_slices/UNIFIED_EXECUTION_RUNTIME.md` — then inspect:
