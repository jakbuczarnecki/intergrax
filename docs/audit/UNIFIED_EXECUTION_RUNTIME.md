...
2. `docs/architecture/UNIFIED_EXECUTION_RUNTIME.md` — hub read-scope + one `architecture/arch/` satellite max
3. `docs/plan/UNIFIED_EXECUTION_RUNTIME.md` — hub + one `plan/plan/` satellite max
