...
Table of contents + sections for audit-map layers **11b** + registers tied to **Known open gaps**. Skip historical paydown logs unless a gap ID points there.
...
- Otherwise: `IDEAL_HARNESS_AI_ARCHITECTURE.md` — sections for layers **11b** only
- `INTEGRAX_HARNESS_AUDIT_MAP.md` — layers **11b** + maturity §5 only
...
1. `docs/guides/IDEAL_HARNESS_AI_ARCHITECTURE.md` — **layers 11b only** (see §0)
2. `docs/architecture/CODE_CRAFT.md` — **scoped sections** (see §0)
3. `docs/plan/CODE_CRAFT.md` — **scoped sections only** (see §0) — do **not** load the full file
4. `docs/guides/INTEGRAX_HARNESS_AUDIT_MAP.md` — **layers 11b** + §5 maturity
