...
1. **Read only:** `docs/architecture/<DOMAIN>.md` · `docs/plan/<DOMAIN>.md` · `docs/audit/<DOMAIN>.md`
...
4. **Classify** findings P0–P4 ([`LAYER_COMPLETION_MODE.md`](../guides/LAYER_COMPLETION_MODE.md) §Step 3).
