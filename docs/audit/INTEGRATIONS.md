...
Table of contents + sections for audit-map layers **13** + registers tied to **Known open gaps**. Skip historical paydown logs unless a gap ID points there.
...
- Otherwise: `IDEAL_HARNESS_AI_ARCHITECTURE.md` — sections for layers **13** only
- `INTEGRAX_HARNESS_AUDIT_MAP.md` — layers **13** + maturity §5 only
...
1. `docs/guides/IDEAL_HARNESS_AI_ARCHITECTURE.md` — **layers 13 only** (see §0)
2. `docs/architecture/INTEGRATIONS.md` — **scoped sections** (see §0)
3. `docs/plan/INTEGRATIONS.md` — **scoped sections only** (see §0) — do **not** load the full file
4. `docs/guides/INTEGRAX_HARNESS_AUDIT_MAP.md` — **layers 13** + §5 maturity
