...
**Load first:** [`docs/guides/audit_slices/MEMORY.md`](../guides/audit_slices/MEMORY.md) — compact slice (layers **15**); replaces bulk IDEAL + AUDIT_MAP + full plan/arch reads.
...
1. **`docs/guides/audit_slices/MEMORY.md`** — mandatory; follow slice plan/arch/IDEAL scope lines
2. `docs/architecture/MEMORY.md` — hub read-scope + one `architecture/satellites/` satellite max
3. `docs/plan/MEMORY.md` — hub + one `plan/satellites/` satellite max
4. `docs/audit/README.md` — shared production Harness checklist
5. `@docs/guides/AGENT_CREATION_GUIDE.md` **Appendix G** — on demand
...
See **Code entry** in `docs/guides/audit_slices/MEMORY.md` — then inspect:
