...
Table of contents + sections for audit-map layers **15** + registers tied to **Known open gaps**. Skip historical paydown logs unless a gap ID points there.
...
- Otherwise: `IDEAL_HARNESS_AI_ARCHITECTURE.md` — sections for layers **15** only
- `INTEGRAX_HARNESS_AUDIT_MAP.md` — layers **15** + maturity §5 only
...
1. `docs/guides/IDEAL_HARNESS_AI_ARCHITECTURE.md` — **layers 15 only** (see §0)
2. `docs/architecture/MEMORY.md` — **scoped sections** (see §0)
3. `docs/plan/MEMORY.md` — **scoped sections only** (see §0) — do **not** load the full file
4. `docs/guides/INTEGRAX_HARNESS_AUDIT_MAP.md` — **layers 15** + §5 maturity
