...
2. `docs/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md` — hub read-scope + one `architecture/satellites/` satellite max
3. `docs/plan/AGENT_CONTRACTS_AND_ASSEMBLY.md` — hub + one `plan/satellites/` satellite max
