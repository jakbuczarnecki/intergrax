...
Table of contents + sections for audit-map layers **L4 AHI** + registers tied to **Known open gaps**. Skip historical paydown logs unless a gap ID points there.
...
- Otherwise: `IDEAL_HARNESS_AI_ARCHITECTURE.md` — sections for layers **L4 AHI** only
- `INTEGRAX_HARNESS_AUDIT_MAP.md` — layers **L4 AHI** + maturity §5 only
...
1. `docs/guides/IDEAL_HARNESS_AI_ARCHITECTURE.md` — **layers L4 AHI only** (see §0)
2. `docs/architecture/ADAPTIVE_HARNESS_INTELLIGENCE.md` — **scoped sections** (see §0)
3. `docs/plan/ADAPTIVE_HARNESS_INTELLIGENCE.md` — **scoped sections only** (see §0) — do **not** load the full file
4. `docs/guides/INTEGRAX_HARNESS_AUDIT_MAP.md` — **layers L4 AHI** + §5 maturity
