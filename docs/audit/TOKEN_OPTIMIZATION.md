...
1. `docs/audit/README.md` — shared production Harness checklist and feature prompt guidance.
2. `docs/features/README.md` — multi-layer feature documentation structure.
...
|-------|------|-------------------|
| `TOKEN-1` | Feature architecture and domain sync | `docs/features/plan/TOKEN_OPTIMIZATION.md` + affected domain docs |
| `TOKEN-2` | OutputPolicy runtime | `docs/plan/UNIFIED_EXECUTION_RUNTIME.md` / `docs/plan/AGENT_CONTRACTS_AND_ASSEMBLY.md` |
...
| `TOKEN-6` | Telemetry and regression gates | `docs/plan/OBSERVABILITY.md` + affected domain plans |
...
- docs/features/architecture/TOKEN_OPTIMIZATION.md sections
- docs/features/plan/TOKEN_OPTIMIZATION.md sections
...
```text
Where does Token Optimization live in docs/features?
