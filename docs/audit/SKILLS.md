...
**Audit map layers:** 12 · [`INTEGRAX_HARNESS_AUDIT_MAP.md`](../guides/INTEGRAX_HARNESS_AUDIT_MAP.md)  
...
2. `docs/architecture/SKILLS.md` — architecture canon (incl. audit registers if present)
3. `docs/plan/SKILLS.md` — implementation plan and gap IDs
