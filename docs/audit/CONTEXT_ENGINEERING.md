...
2. `docs/architecture/CONTEXT_ENGINEERING.md` — hub read-scope + one `architecture/arch/` satellite max
3. `docs/plan/CONTEXT_ENGINEERING.md` — hub + one `plan/plan/` satellite max
