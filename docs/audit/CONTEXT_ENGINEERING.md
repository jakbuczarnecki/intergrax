...
**Audit map layers:** 16 · compact slice: [`audit_slices/CONTEXT_ENGINEERING.md`](../guides/audit_slices/CONTEXT_ENGINEERING.md)  
...
**Load first:** [`docs/guides/audit_slices/CONTEXT_ENGINEERING.md`](../guides/audit_slices/CONTEXT_ENGINEERING.md) — compact slice (layers **16**); replaces bulk IDEAL + AUDIT_MAP + full plan/arch reads.
...
1. **`docs/guides/audit_slices/CONTEXT_ENGINEERING.md`** — mandatory; follow slice plan/arch/IDEAL scope lines
2. `docs/architecture/CONTEXT_ENGINEERING.md` — hub read-scope + one `architecture/satellites/` satellite max
3. `docs/plan/CONTEXT_ENGINEERING.md` — hub + one `plan/satellites/` satellite max
4. `docs/audit/README.md` — shared production Harness checklist
5. `@docs/guides/AGENT_CREATION_GUIDE.md` **Appendix L** — on demand
...
See **Code entry** in `docs/guides/audit_slices/CONTEXT_ENGINEERING.md` — then inspect:
