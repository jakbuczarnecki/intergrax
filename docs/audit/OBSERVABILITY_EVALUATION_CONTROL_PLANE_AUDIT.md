...
**Target architecture docs:** `docs/architecture/OBSERVABILITY.md`, `docs/architecture/satellites/OBSERVABILITY_extended_depth.md`  
**Target plan docs:** `docs/plan/OBSERVABILITY.md`, proposed `docs/plan/satellites/OBSERVABILITY_eval_control_plane.md`  
**Date:** 2026-06-24  
...
### 16.1 `docs/architecture/OBSERVABILITY.md`
...
### 16.2 `docs/architecture/satellites/OBSERVABILITY_extended_depth.md`
...
### 16.3 `docs/architecture/CRITIC_VERIFICATION.md`
...
### 16.4 `docs/architecture/TIER3_APPLICATION_ENVIRONMENT.md`
...
### 17.1 `docs/plan/OBSERVABILITY.md`

Add a compact entry pointing to a new satellite:

```text
docs/plan/satellites/OBSERVABILITY_eval_control_plane.md
```
...
docs/audit/OBSERVABILITY_EVALUATION_CONTROL_PLANE_AUDIT.md
...
Read first:
1. docs/audit/OBSERVABILITY_EVALUATION_CONTROL_PLANE_AUDIT.md
2. docs/architecture/OBSERVABILITY.md
3. docs/architecture/satellites/OBSERVABILITY_extended_depth.md
4. docs/architecture/CRITIC_VERIFICATION.md
5. docs/architecture/TIER3_APPLICATION_ENVIRONMENT.md or the relevant satellite if the hub points there
6. docs/plan/OBSERVABILITY.md
7. docs/plan/satellites/OBSERVABILITY_audit_history.md
8. docs/audit/README.md

Required documentation changes:
1. Add a concise canonical summary of Observability & Evaluation Control Plane to docs/architecture/OBSERVABILITY.md.
2. Add full target architecture sections to docs/architecture/satellites/OBSERVABILITY_extended_depth.md.
3. Add a cross-reference in docs/architecture/CRITIC_VERIFICATION.md explaining the boundary between CVL and OECP.
...
5. Update docs/plan/OBSERVABILITY.md with a compact pointer to a new plan satellite.
6. Create docs/plan/satellites/OBSERVABILITY_eval_control_plane.md with phased implementation register.
...
- The full audit remains in docs/audit/OBSERVABILITY_EVALUATION_CONTROL_PLANE_AUDIT.md.
