...
2. `docs/architecture/RELIABILITY_FAILURE_AND_HITL.md` — hub read-scope + one `architecture/arch/` satellite max
3. `docs/plan/RELIABILITY_FAILURE_AND_HITL.md` — hub + one `plan/plan/` satellite max
