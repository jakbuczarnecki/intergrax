...
Table of contents + sections for audit-map layers **22** + registers tied to **Known open gaps**. Skip historical paydown logs unless a gap ID points there.
...
- Otherwise: `IDEAL_HARNESS_AI_ARCHITECTURE.md` — sections for layers **22** only
- `INTEGRAX_HARNESS_AUDIT_MAP.md` — layers **22** + maturity §5 only
...
1. `docs/guides/IDEAL_HARNESS_AI_ARCHITECTURE.md` — **layers 22 only** (see §0)
2. `docs/architecture/RELIABILITY_FAILURE_AND_HITL.md` — **scoped sections** (see §0)
3. `docs/plan/RELIABILITY_FAILURE_AND_HITL.md` — **scoped sections only** (see §0) — do **not** load the full file
4. `docs/guides/INTEGRAX_HARNESS_AUDIT_MAP.md` — **layers 22** + §5 maturity
