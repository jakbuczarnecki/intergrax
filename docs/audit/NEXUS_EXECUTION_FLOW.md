...
2. `docs/architecture/NEXUS_EXECUTION_FLOW.md` — hub read-scope + one `architecture/arch/` satellite max
3. `docs/plan/NEXUS_EXECUTION_FLOW.md` — hub + one `plan/plan/` satellite max
