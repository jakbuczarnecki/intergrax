...
**Audit map layers:** 8–10 · [`INTEGRAX_HARNESS_AUDIT_MAP.md`](../guides/INTEGRAX_HARNESS_AUDIT_MAP.md)  
...
2. `docs/architecture/NEXUS_EXECUTION_FLOW.md` — architecture canon (incl. audit registers if present)
3. `docs/plan/NEXUS_EXECUTION_FLOW.md` — implementation plan and gap IDs
