...
Canonical public positioning is defined in [INTERGRAX_PUBLIC_POSITIONING.md](INTERGRAX_PUBLIC_POSITIONING.md). All outreach drafts must remain consistent with it.
...
- Route pilot or partner-fit discussions to [PARTNERS.md](../../PARTNERS.md).
...
| guaranteed partnership | design-partner discovery under [PARTNERS.md](../../PARTNERS.md) |
...
| we support all use cases | [USE_CASES.md](../../USE_CASES.md) maps current validation areas |
...
| [../../EVALUATION_GUIDE.md](../../EVALUATION_GUIDE.md) | Reader-facing evaluation paths |
