...
| **Phase CRIT-V — Critic & Verification Layer** | **Active** (Band 2ak) — **15/24 Done** (CRIT-V-0–3.5) · [CVL architecture](CRITIC_VERIFICATION_LAYER_ARCHITECTURE.md) · [ADR-CRITIC-001](adr/ADR-CRITIC-001.md) |
