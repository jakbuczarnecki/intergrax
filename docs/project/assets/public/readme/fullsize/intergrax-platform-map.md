# Intergrax Platform Map

<picture>
  <source
    media="(prefers-color-scheme: dark)"
    srcset="../intergrax-platform-map-dark.png"
  >
  <source
    media="(prefers-color-scheme: light)"
    srcset="../intergrax-platform-map-light.png"
  >
  <img
...
[Open light image](../intergrax-platform-map-light.png) ·
[Open dark image](../intergrax-platform-map-dark.png)
