...
2. Run the local demo if consistent with [LICENSE](../../../../LICENSE) and [docs/project/community/COLLABORATION.md](../../community/COLLABORATION.md) (see [BUILD_AND_DEPLOY.md](../../applications/attestation_demo/docs/BUILD_AND_DEPLOY.md)).
