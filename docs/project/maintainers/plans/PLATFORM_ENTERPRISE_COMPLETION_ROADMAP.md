...
| **EBH-2F-R2-R1-R1** | Pre-built Integration Category Contract Integrity | Pre-built dependency injection musi walidować dokładnie category-specific contract przez canonical `contract_for_category`; legacy weak bypass tests usunięte; negative proofs + gate extension. | **[ ] CURRENT** |
...
| EBH-2F-R2-R1-R1 | — | CURRENT — pre-built integration category contract integrity & legacy test reconciliation. |
