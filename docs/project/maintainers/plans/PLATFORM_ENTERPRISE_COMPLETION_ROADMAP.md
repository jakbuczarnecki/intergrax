...
| HARNESS-QINF-01 | Harness Global Qualification Inventory Reconciliation | Reconcile global `test_harness_01_gates.py` allowlists/inventories with separately qualified EE/UCA/suspended-operation surfaces (W3 recertification inventory drift). Qualification infrastructure only unless reconciliation exposes a real bypass. | **[ ] CURRENT** |
...
| HARNESS-QINF-01 | — | **CURRENT** — reconcile global Harness qualification inventory (`test_harness_01_gates.py`) before HARNESS-W4/final Harness closure. |
