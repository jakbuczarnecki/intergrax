...
| **EBH-2F-R2** | Integration Plugin Contract Typing & Registration Purity | Usunięcie `Any`, weak factory contract i reflection-based `CONTRACT_SPECS` z publicznej plugin boundary; jeden jawny typed registration path (`contract_specs` / `integration_contract_specs`) oraz architecture gates. | **[ ] CURRENT** |
...
| EBH-2F-R2 | — | CURRENT — integration plugin contract typing & registration purity (blocker surfaced by independent audit at `8c89bdfa046bbf124ed838b64834bdc825bb8f57`). |
