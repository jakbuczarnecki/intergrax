...
| **EBH-2G** | RAG Contract Boundary Hardening | Certyfikacja retrieval/search/reranking/storage jako jednego pluginowalnego subsystemu z canonical contracts, jednym ownership i wymiennymi backendami. | **[ ] CURRENT** (final parent RAG recertification after independently closed R1 + R2) |
