...
| File | Change |
|------|--------|
| `docs/project/technical/guides/INTERGRAX_HARNESS_NARRATIVE.md` | External-facing one-page narrative — harness vs agent framework, proof path, boundaries, audience |
