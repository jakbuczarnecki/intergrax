...
**Status:** Domain registered - **MP-1 — CLOSED / FINAL INDEPENDENT REVIEW PASS**; **MP-2 — APPROVED / CLOSED**; **MP-3 — ENTERPRISE CERTIFIED / CLOSED**; **MP-5F — ENTERPRISE SOURCE INTEGRATION CERTIFIED / CLOSED**; **MP-5 — ENTERPRISE CERTIFIED / CLOSED**; **MP-6 — ENTERPRISE CERTIFIED / CLOSED**; **MP-7 — ENTERPRISE BOUNDARY CERTIFIED / CLOSED** (Tier-3 consumability; not LKW product adoption). Canonical Multiplayer maturity: [`capabilities/architecture/MULTIPLAYER_AI.md`](../../capabilities/architecture/MULTIPLAYER_AI.md)#current-enterprise-maturity-boundary
**Current active task:** *(none for CW core)* — Multiplayer next capability phase **MP-8 — PLANNED / NOT STARTED**; final hardening **MP-FINAL-2…4** per capability plan.
...
| Field | Value |
|-------|-------|
| **Status** | **FROZEN / ACCEPTED** — ADR-MP-004 **Accepted**; implementation **ENTERPRISE CERTIFIED / CLOSED** (MP-3H) |
...
| **Next step** | *(none — MP-3 closed)*. **Historical (superseded):** **MP-5F — NEXT** |
...
| **ID** | MP-3G |
| **Priority** | P1 |
| **Status** | **APPROVED / CLOSED** (integration semantics certified) |
...
| **ID** | MP-3H |
| **Priority** | P1 |
| **Status** | **APPROVED / CLOSED** — MP-3H enterprise certification complete |
...
| **Next step** | **MP-5E — APPROVED / CLOSED** |

### MP-5E — Default composition implementation
...
| Field | Value |
|-------|-------|
| **Status** | **APPROVED / CLOSED** — implementation-ready roadmap frozen; MP-3 runtime **ENTERPRISE CERTIFIED / CLOSED** |
...
| **Next step** | *(none — MP-3 closed)*. **MP-7 — ENTERPRISE BOUNDARY CERTIFIED / CLOSED**; **MP-6 — ENTERPRISE CERTIFIED / CLOSED**. **Historical (superseded):** **MP-7 — … — NEXT** |

### MP-6A — Activity & Provenance ownership / contract architecture gate

| Field | Value |
|-------|-------|
| **Status** | **MP-6A — CLOSED / RECERTIFIED** (**MP-6A-C1**) |
| **Purpose** | Freeze MP-6 ownership, typed activity/provenance contracts (gate), ADR-MP-007, docs sync, architecture gates |
...
| **Next step** | **MP-6B — CLOSED / RECERTIFIED** |

| Field | Value |
|-------|-------|
| **Status** | **CLOSED** (subject to independent audit) |
| **Purpose** | Scoped idempotency; `CollaborativeActivityTypeId` / `CollaborativeActivitySourceId`; opaque pagination cursor vs event-time ordering |

### MP-6A-C1-R1 — Atomic append position & materialization boundary
...
| **Next step** | **MP-6C — CLOSED / RECERTIFIED** |
...
|-------|-------|
| **Status** | **CLOSED / RECERTIFIED** (subject to independent audit) |
| **Purpose** | Injectable read authorization before provider; tenant/workspace scoped `CollaborativeActivityQuery`; opaque scope-bound cursor; keyset pagination by `append_position` (no `OFFSET`; `occurred_at` not continuation watermark) |
