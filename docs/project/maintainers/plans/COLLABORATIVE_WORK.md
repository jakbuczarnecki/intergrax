...
- MP-6E scoped read/query (MP-6A–**MP-6D** **CLOSED**; ownership **FROZEN** via ADR-MP-007; MP-5 via ADR-MP-006; MP-4 via ADR-MP-005 — see [`DECISION_APPROVAL_GOVERNANCE.md`](DECISION_APPROVAL_GOVERNANCE.md))
