...
| P2-003 | `contract_capture` reflection at registration | `integrations/registry/contract_capture.py` | **MIGRATION_REQUIRED** — B1 DATA & PERSISTENCE WAVE **IMPLEMENTED_PENDING_INDEPENDENT_AUDIT** (44 explicit B1 keys; 143 reflective built-ins remain outside B1) |
