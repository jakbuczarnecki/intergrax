...
- Established enterprise buyer/budget.
- Fragmented cross-functional workflow.
- High auditability and decision value.
- Credible bounded pilot.

---

## 3. Current product hypothesis

Move a real vendor request from evidence gathering through review to a defensible decision.
...
| User-facing job (selection record) | Move a real vendor request from evidence gathering through review to a defensible decision |

---

## 5. Selection caveat / differentiation risk

End-to-end TPRM orchestration is already an active category. Orchestration alone is **not** claimed as unique. Future product work must narrow the initial wedge. Initial wedge still requires sharpening at portfolio level.
...
- What is wedge beyond generic orchestration?
- Does product produce a defensible decision rather than collect documents?
- Is this standalone buying need or incumbent TPRM feature?
- How do we avoid commodity questionnaire automation?
- What evidence/auditability materially improves the decision?
