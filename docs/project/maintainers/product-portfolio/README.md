...
Future program control covers **all actively developed products** in the program:
...
| Product selection record | **Being frozen** (see selection record below) |
...
| Multi-product governance / control mechanism | **To be defined in subsequent tasks** |
...
|----------|------------------------|
| Why these new products were selected | [PRODUCT_PORTFOLIO_SELECTION.md](PRODUCT_PORTFOLIO_SELECTION.md) |
| General reusable cross-product proof methodology | [PRODUCT_REUSE_PROOF.md](../plans/PRODUCT_REUSE_PROOF.md) |
...
- program governance (`MULTI_PRODUCT_PROGRAM.md`)
- live portfolio status (`PORTFOLIO_STATUS.md`)
- platform impact ledger (`PLATFORM_IMPACT_LEDGER.md`)
