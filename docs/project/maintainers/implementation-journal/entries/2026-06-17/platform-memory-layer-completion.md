...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/MEMORY.md` |
| Plan | `docs/project/maintainers/plans/MEMORY.md` — MEM-VEC-3.*, MEM-DEPTH-5.2, MEM-DEPTH-4.2 |
| ADR | `docs/project/technical/adr/entries/2026-06-14/ADR-MEM-002.md` (extended wiring only) |
...
- `docs/project/architecture/MEMORY.md`, `docs/project/maintainers/plans/MEMORY.md` — layer completion sync
