...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/TOOLS.md` TOOL-ENG status |
...
- `docs/project/maintainers/plans/TOOLS.md` — Phase TOOLS-LC register
- `docs/project/architecture/TOOLS.md` — Full Harness LC maturity note
