...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/ADAPTIVE_HARNESS_INTELLIGENCE.md` |
| Plan | `docs/project/maintainers/plans/ADAPTIVE_HARNESS_INTELLIGENCE.md` Phase AHI-LC |
