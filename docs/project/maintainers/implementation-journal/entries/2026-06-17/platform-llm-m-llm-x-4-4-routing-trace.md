...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/LLM_ADAPTERS.md` §Routing |
| Plan | `docs/project/maintainers/plans/LLM_ADAPTERS.md` M-LLM-X.4.4 |
...
- `docs/project/maintainers/plans/LLM_ADAPTERS.md` — M-LLM-X.4.4 Done
