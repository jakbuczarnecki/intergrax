...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/RELIABILITY_FAILURE_AND_HITL.md` |
| Plan | `docs/project/maintainers/plans/RELIABILITY_FAILURE_AND_HITL.md` Phase RELIABILITY-LC |
