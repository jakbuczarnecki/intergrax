...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/ELASTIC_CAPACITY_AND_SCALING.md` |
| Plan | `docs/project/maintainers/plans/ELASTIC_CAPACITY_AND_SCALING.md` Phase ECP-LC |
