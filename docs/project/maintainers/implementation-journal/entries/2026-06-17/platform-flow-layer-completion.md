...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/NEXUS_EXECUTION_FLOW.md` |
| Plan | `docs/project/maintainers/plans/NEXUS_EXECUTION_FLOW.md` AUDIT-IDEAL-6.6 |
| Delivery | `docs/project/maintainers/plans/LLM_ADAPTERS.md` M-LLM-X.5 |
| Code | `intergrax/agents/authoring/llm_router.py` |

## Changed artifacts

- `docs/project/maintainers/plans/NEXUS_EXECUTION_FLOW.md` — AUDIT-IDEAL-6.6 → Done
