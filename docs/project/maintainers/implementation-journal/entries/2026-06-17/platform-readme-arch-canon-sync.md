...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/CODE_CRAFT.md` |
| Plan | `docs/project/maintainers/plans/CODE_CRAFT.md` · `docs/project/maintainers/plans/PLATFORM_FOUNDATION.md` P1-ARCH-03 |
| Debt | `docs/project/technical/guides/ARCHITECTURE_DEBT_REGISTER.md` — P1-ARCH-03 |

## Changed artifacts

- `README.md` — ECC status in Overview; Project snapshot date and maturity wording
- `docs/project/technical/guides/ARCHITECTURE_DEBT_REGISTER.md` — P1-ARCH-03 closed
- `docs/project/maintainers/plans/CODE_CRAFT.md` — doc inconsistency row
- `docs/project/maintainers/plans/PLATFORM_FOUNDATION.md` — Appendix B.1 P1-ARCH-03 row
