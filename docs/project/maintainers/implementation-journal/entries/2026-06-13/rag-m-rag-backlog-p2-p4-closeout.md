...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/RAG.md` |
| Plan | `docs/project/maintainers/plans/RAG.md` — M-RAG-BACKLOG |
| Integrations | `docs/project/maintainers/plans/INTEGRATIONS.md` — H-INT-GRAPH |
