...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md` §15 · §19 · §20 · §40.13 |
| Plan | `docs/project/maintainers/plans/AGENT_CONTRACTS_AND_ASSEMBLY.md` Phase AUDIT-IDEAL · §6.1bd |
| Master register | `docs/project/maintainers/plans/AUDIT_IDEAL_2026.md` rows 19.1 · 20.1 · 31.1 |
