...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/CONTEXT_ENGINEERING.md` §8.4, §17 |
| Plan | `docs/project/maintainers/plans/CONTEXT_ENGINEERING.md` CE-PROV-WIRE sprint B1 |
...
- `docs/project/maintainers/plans/CONTEXT_ENGINEERING.md`, `docs/project/architecture/CONTEXT_ENGINEERING.md` — B1 status
