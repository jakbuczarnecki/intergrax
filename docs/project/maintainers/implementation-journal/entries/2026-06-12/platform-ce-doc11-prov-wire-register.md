...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/CONTEXT_ENGINEERING.md` §8.4, §16 |
| Plan | `docs/project/maintainers/plans/CONTEXT_ENGINEERING.md` — CE-PROV-WIRE, CE-DOC.11, sprints B0–B4 |
