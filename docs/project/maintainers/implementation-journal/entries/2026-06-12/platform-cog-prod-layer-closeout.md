...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/REASONING_AND_COGNITION.md` §2, §16, §21 |
| Plan | `docs/project/maintainers/plans/REASONING_AND_COGNITION.md` Phase COG-PROD |
