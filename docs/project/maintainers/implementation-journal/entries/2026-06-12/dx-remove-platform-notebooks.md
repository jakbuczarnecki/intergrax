...
| Plan | `docs/project/maintainers/plans/EXPERIMENTATION_AND_DEVELOPER_EXPERIENCE.md` D.4 |
| ADR | none — hygiene only |

## Changed artifacts

- `notebooks/` — removed (entire directory)
- `docs/project/maintainers/plans/EXPERIMENTATION_AND_DEVELOPER_EXPERIENCE.md` — D.4 row
- `docs/project/maintainers/plans/PLATFORM_FOUNDATION.md`, `ORCHESTRATION.md`, `CRITIC_VERIFICATION.md`, `OBSERVABILITY.md` — D.4 sections
- `docs/project/technical/guides/EXTENSION_AUTHOR_GUIDE.md`, `HARNESS_ENVIRONMENT.md` — stale notebook references
