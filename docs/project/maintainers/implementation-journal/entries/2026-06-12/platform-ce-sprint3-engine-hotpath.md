...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/CONTEXT_ENGINEERING.md` §9.4, §17 |
| Plan | `docs/project/maintainers/plans/CONTEXT_ENGINEERING.md` — S3 Done; CE-3.1, CE-3.2, CE-3.9, CE-3.10 |
| ADR | `docs/project/technical/adr/entries/2026-06-08/ADR-MEM-001.md` (compiler budget semantics) |
