...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/CONTEXT_ENGINEERING.md` §7.2–7.3, §17 |
| Plan | `docs/project/maintainers/plans/CONTEXT_ENGINEERING.md` — S1 Done; CE-1.1–1.4, CE-1.6, CE-2.6 |
| ADR | `docs/project/technical/adr/entries/2026-06-12/ADR-CTX-001.md` (no new ADR) |
...
- `docs/project/architecture/CONTEXT_ENGINEERING.md`, `docs/project/maintainers/plans/CONTEXT_ENGINEERING.md` — status updates
