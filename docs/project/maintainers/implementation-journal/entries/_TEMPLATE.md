...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/<DOMAIN>.md` or `agents/<slug>/ARCHITECTURE.md` |
| Plan | `docs/project/maintainers/plans/<DOMAIN>.md` row / phase |
| ADR | `docs/project/technical/adr/entries/YYYY-MM-DD/ADR-XXX-NNN.md` or `agents/<slug>/adr/` |
