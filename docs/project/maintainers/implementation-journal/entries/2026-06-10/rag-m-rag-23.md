...
| Plan | `docs/project/maintainers/plans/RAG.md` Wave 1 step 1.1 **M-RAG.23 Done** |
...
- `docs/project/architecture/RAG.md`, `docs/project/maintainers/plans/RAG.md` — gap closure
...
- Next: M-RAG.24 or M-RAG.25 per `docs/project/maintainers/plans/RAG.md` Wave 2 priority.
