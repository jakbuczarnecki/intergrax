...
- Plan: `docs/project/maintainers/plans/AGENT_CONTRACTS_AND_ASSEMBLY.md` §6.1aw step 8.4 (ACP-MIG-4)
...
- `scripts/maintenance/audit_agent_fleet_legacy.py` migrated set
