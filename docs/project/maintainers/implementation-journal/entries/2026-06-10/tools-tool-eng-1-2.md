...
status: completed
commit: aa0a3e61
adr: docs/project/technical/adr/entries/2026-06-10/ADR-TOOL-001.md
---
...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/TOOLS.md` |
| Plan | `docs/project/maintainers/plans/TOOLS.md` TOOL-ENG-1, TOOL-ENG-2 |
| ADR | `docs/project/technical/adr/entries/2026-06-10/ADR-TOOL-001.md` |

## Changed artifacts

- `intergrax/runtime/nexus/tools/tool_runtime.py`
- `docs/project/technical/adr/entries/2026-06-10/ADR-TOOL-001.md`
- `docs/project/architecture/TOOLS.md`, `docs/project/maintainers/plans/TOOLS.md`
