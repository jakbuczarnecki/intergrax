...
Layer 12 revalidation confirmed L3 maturity (M-RAG-DEPTH Done, OTel + tenant isolation gates green). Registered four ops/prompt hygiene rows in `docs/project/maintainers/plans/RAG.md` §6.1av. Noted Windows pytest teardown crash as environment note.
