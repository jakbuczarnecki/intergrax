...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/LLM_ADAPTERS.md` § Enterprise domain maturity register |
| Plan | `docs/project/maintainers/plans/LLM_ADAPTERS.md` Wave M-LLM-X-8 · M-LLM-X-14 |
...
- Docs: `docs/project/architecture/LLM_ADAPTERS.md`, `docs/project/maintainers/plans/LLM_ADAPTERS.md`, `USAGE.md`, hub, journal
