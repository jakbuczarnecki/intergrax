...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/EXPERIMENTATION_AND_DEVELOPER_EXPERIENCE.md` §43.2 |
| Plan | `docs/project/maintainers/plans/EXPERIMENTATION_AND_DEVELOPER_EXPERIENCE.md` — DX-IDEA-01, DX-IDEA-02 |
...
- `docs/project/maintainers/plans/EXPERIMENTATION_AND_DEVELOPER_EXPERIENCE.md` — DX-IDEA phase register
- `docs/project/architecture/EXPERIMENTATION_AND_DEVELOPER_EXPERIENCE.md` — §43.2 surface row
