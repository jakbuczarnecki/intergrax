...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/LLM_ADAPTERS.md` § Routing strict enterprise closeout |
| Plan | `docs/project/maintainers/plans/LLM_ADAPTERS.md` Wave M-LLM-X-12 |
