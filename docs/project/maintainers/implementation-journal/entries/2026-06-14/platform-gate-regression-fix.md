...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/SKILLS.md` |
| Plan | `docs/project/maintainers/plans/SKILLS.md` · `docs/project/maintainers/plans/AGENT_CONTRACTS_AND_ASSEMBLY.md` §40.12 |
...
- `scripts/maintenance/audit_agent_fleet_legacy.py` — `boundary_demo` migrated roster
