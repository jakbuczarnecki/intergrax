...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/CONTEXT_ENGINEERING.md` §11, §16, §17 |
| Plan | `docs/project/maintainers/plans/CONTEXT_ENGINEERING.md` CE-10.3, CE-HANDLE-FILL, sprints C1–C2 |
| ADR | none |
