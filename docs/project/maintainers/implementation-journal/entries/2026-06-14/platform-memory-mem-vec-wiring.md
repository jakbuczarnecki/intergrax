...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/MEMORY.md` §5.3, §6.4–6.5, §17 |
| Plan | `docs/project/maintainers/plans/MEMORY.md` Phase MEM-VEC MEMV1/MEMV2 |
| ADR | `docs/project/technical/adr/entries/2026-06-14/ADR-MEM-002.md` |
