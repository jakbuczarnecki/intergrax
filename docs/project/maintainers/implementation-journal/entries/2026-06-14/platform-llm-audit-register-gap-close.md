...
Synced traceability in `docs/project/maintainers/plans/LLM_ADAPTERS.md` and register IDs in `docs/audit_results/LLM_ADAPTERS.md`.
...
| Audit instruction | `docs/audit_results/LLM_ADAPTERS.md` — known gaps table |
