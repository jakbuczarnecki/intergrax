...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/CONTEXT_ENGINEERING.md` §8.3–§8.4, §16 |
| Plan | `docs/project/maintainers/plans/CONTEXT_ENGINEERING.md` CE-PROV-WIRE sprints B2–B4 |
