...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/LLM_ADAPTERS.md` — audit register LC-3 closeout |
| Plan | `docs/project/maintainers/plans/LLM_ADAPTERS.md` — sprint LC-2b/LC-3 Done |
