...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/TOOLS.md` §Tool selection modes |
| Plan | `docs/project/maintainers/plans/TOOLS.md` TOOL-ENG-DOC.4, TOOL-ENG-13/14/15 |
| Flow | `docs/project/architecture/NEXUS_EXECUTION_FLOW.md` §15 |
| ADR | none — DOC only |

## Changed artifacts

- `docs/project/architecture/TOOLS.md` — selection modes canon, maturity matrix, gap register
