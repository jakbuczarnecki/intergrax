...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/TIER3_APPLICATION_ENVIRONMENT.md` §40.2 · §46.3 |
| Plan | `docs/project/maintainers/plans/TIER3_APPLICATION_ENVIRONMENT.md` APP-PROD-6 · fidelity matrix |
| ADR | none — lint only |
...
- `docs/project/maintainers/plans/TIER3_APPLICATION_ENVIRONMENT.md` — fidelity + phase status sync
- `docs/project/architecture/TIER3_APPLICATION_ENVIRONMENT.md` — §40.2 · §42.4 · §46.3 sync
