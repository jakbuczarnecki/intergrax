...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/TIER3_APPLICATION_ENVIRONMENT.md` §32.6, §42–§43, §47–§48 |
...
- `docs/project/architecture/TIER3_APPLICATION_ENVIRONMENT.md` — runtime depth sections
- `docs/project/maintainers/plans/TIER3_APPLICATION_ENVIRONMENT.md` — H-APP-CON register update
