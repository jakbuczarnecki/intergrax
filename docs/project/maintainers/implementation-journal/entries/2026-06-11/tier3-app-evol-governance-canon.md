...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/TIER3_APPLICATION_ENVIRONMENT.md` §49 |
| Plan | `docs/project/maintainers/plans/TIER3_APPLICATION_ENVIRONMENT.md` Phase H-APP-EVOL |
| Agent lifecycle | `intergrax/contracts/agent_lifecycle_state.py`, `agent_lifecycle_governance.py` |
| Capability semver | UAEP §42.27 |

## Changed artifacts

- `docs/project/architecture/TIER3_APPLICATION_ENVIRONMENT.md` — §49, TOC, §46 maturity
- `docs/project/maintainers/plans/TIER3_APPLICATION_ENVIRONMENT.md` — H-APP-EVOL phase
