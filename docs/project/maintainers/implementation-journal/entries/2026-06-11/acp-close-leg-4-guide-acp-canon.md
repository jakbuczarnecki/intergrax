...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md` §45 |
| Plan | `ACP-CLOSE-LEG-4` |
| ADR | none |

## Changed artifacts

- `docs/project/technical/guides/AGENT_CREATION_GUIDE.md` — ACP-canonical author path
- `docs/project/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md` — §45 checklist items 11–13
- `docs/project/maintainers/plans/AGENT_CONTRACTS_AND_ASSEMBLY.md` — LEG-4 **Done**
