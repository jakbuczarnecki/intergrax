...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md` §25.5.1–§25.5.2 |
| Plan | `docs/project/maintainers/plans/AGENT_CONTRACTS_AND_ASSEMBLY.md` ACP-TOK-2 |
| Cross-plan | `docs/project/maintainers/plans/TIER3_APPLICATION_ENVIRONMENT.md` §43 kernel hard cap row |
