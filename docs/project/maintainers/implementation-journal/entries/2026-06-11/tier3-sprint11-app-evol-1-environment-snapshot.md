...
status: completed
commit: pending
adr: docs/project/technical/adr/entries/2026-06-12/ADR-APP-002.md
---
...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/TIER3_APPLICATION_ENVIRONMENT.md` §49.1.2 |
| Plan | `docs/project/maintainers/plans/TIER3_APPLICATION_ENVIRONMENT.md` APP-EVOL-1 · §6.2y step 8 |
| ADR | `docs/project/technical/adr/entries/2026-06-12/ADR-APP-002.md` |
