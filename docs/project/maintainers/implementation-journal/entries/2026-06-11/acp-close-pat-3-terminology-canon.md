...
| Link | Target |
|------|--------|
| Architecture | `docs/project/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md` §29.0 · §22–§23 · §27 |
| Plan | `ACP-CLOSE-PAT-3` |
| ADR | none |

## Changed artifacts

- `docs/project/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md` — §29.0, planes, flows, GAP-ACP-07 Closed
- `docs/project/technical/guides/AGENT_CREATION_GUIDE.md` — §1 terminology canon; AC.1/AC.2/AC.3 dedupe
- `docs/project/maintainers/plans/AGENT_CONTRACTS_AND_ASSEMBLY.md` — PAT-3 **Done**
