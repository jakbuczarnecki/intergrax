...
- Execution graph audit & canonical DAG design (P0): [`INTEGRAX_QUALIFICATION_EXECUTION_GRAPH_AUDIT_AND_OPTIMIZATION_DESIGN.md`](../qualification/INTEGRAX_QUALIFICATION_EXECUTION_GRAPH_AUDIT_AND_OPTIMIZATION_DESIGN.md)
