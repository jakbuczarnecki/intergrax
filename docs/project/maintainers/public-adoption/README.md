...
|------|----------|---------|
| 0 | [Intergrax Public Positioning](../../overview/INTERGRAX_PUBLIC_POSITIONING.md) | Maintainer contract for exact first-contact message, product hierarchy, audience value, and CTA language |
...
| 1a | [Public Product Experience Roadmap](../../overview/PUBLIC_PRODUCT_EXPERIENCE_ROADMAP.md) | Layer 5 product-experience transformation program, audience contract, and PX phase status |
...
`PUBLIC_DOCUMENTATION_ARCHITECTURE.md#primary-cta-and-reader-progression-contract`

Public reader route map:
`../PUBLIC_DOCUMENTATION_MAP.md#start-by-what-you-want-to-do`
...
```text
docs/project/maintainers/public-adoption/curated_public_issues.yml
```
