...
| GR-4 | Policy Resolution & Catalog Requalification | **BLOCKED UNTIL INDEPENDENT GITHUB AUDIT** (after GR-3) | Close PG-FIX-B/D qualification gaps | GR-3 | G2C, PG-FIX-B/D | Yes | Precedence + catalog tests |
