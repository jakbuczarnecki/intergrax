...
| GR-5-R3 | Task / HumanPauseCoordinator projection alignment | CANDIDATE CLOSED | `WAITING_FOR_HUMAN` derived from canonical state | GR-5-R2 | — | Yes | Projection parity tests |
| GR-5-R4 | Execution Engine Internal HITL Orchestration Alignment | PLANNED | Internal orchestration via port | GR-5-R2 | — | Yes | Orchestration HITL qual |
