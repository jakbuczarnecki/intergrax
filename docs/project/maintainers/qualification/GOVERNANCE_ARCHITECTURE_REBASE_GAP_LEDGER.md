...
| GOV-GAP-008 | P1 | Strategy coverage | G3B Nexus/UAEP-heavy COVERED rows | Matrix for INFERENCE/AGENTIC/ORCHESTRATION | “Nexus works” ≠ platform proof | **GR-10-FINAL:** INFERENCE PRE_MODEL **QUALIFIED**; AGENTIC policy **PARTIAL** (**GR-10-R3** UAEP `PolicyDecision` authority); ORCHESTRATION partial rows per §9 | `tests/qualification/governance/strategy/` + matrix §9 | GR-10 | GR-10-R3 (UAEP AGENT_DECISION) | `GOVERNED_EXECUTION.md` §G3B | **PARTIAL** |
