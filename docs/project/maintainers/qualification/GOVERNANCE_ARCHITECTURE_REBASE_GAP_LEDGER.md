...
| GOV-GAP-008 | P1 | Strategy coverage | G3B Nexus/UAEP-heavy COVERED rows | Matrix for INFERENCE/AGENTIC/ORCHESTRATION | “Nexus works” ≠ platform proof | **INFERENCE PRE_MODEL** runtime identity **GR-10-R2-R1** candidate closed; AGENTIC/ORCHESTRATION strategy qualification residuals remain | `tests/qualification/governance/strategy/` + matrix §9 | GR-10 | GR-10 final requalification | `GOVERNED_EXECUTION.md` §G3B | **PARTIAL** |
