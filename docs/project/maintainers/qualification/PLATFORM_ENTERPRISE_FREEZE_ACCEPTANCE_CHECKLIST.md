...
| FRZ-CTR-01 | Contracts / abstraction | consumers depend on contracts | EBH-2*, EBH-3, EBH-4 | OPEN | EBH-2F-R2-R1-R1-R1-R1-R1 (in progress): catalog `resolve()` vs profile-aware `CategoryIntegrationInstance` result precision. |
...
| FRZ-TYP-02 | Strong typing | Any at semantic boundaries = 0 unless evidence-backed transport reason | EBH-2* | OPEN | EBH-2F-R2-R1-R1-R1-R1-R1 (in progress): narrow catalog `resolve()` to `PlatformIntegrationContract`; profile paths keep `CategoryIntegrationInstance`. |
| FRZ-TYP-03 | Strong typing | generic object semantic seams = 0 | EBH-2* | OPEN | EBH-2F-R2-R1-R1-R1-R1-R1 (in progress): separate catalog vs profile validators; no false-broad catalog result types. |
...
| FRZ-REG-09 | Regression / qualification infrastructure | critical invariant protected by code/test, not docs only | QUAL-X | OPEN | EBH-2F-R2-R1-R1-R1-R1-R1 extends R2 gate: distinct AST return annotations for `resolve` vs profile surfaces + `IntegrationFactory` proof (in progress). |
...
| EBH-2F-R2-R1-R1-R1-R1-BLOCKER | `77054d545143b86a2fb3082448919adfcc1e3a5a` | Independent audit rejected EBH-2F-R2-R1-R1-R1-R1 closure: profile-aware `CategoryIntegrationInstance` accepted, but catalog-only `resolve()` over-declared union including DI-only `ExternalWorkIntegration`. Tracked as EBH-2F-R2-R1-R1-R1-R1-R1 CURRENT. | FRZ-BND-02, FRZ-BND-03, FRZ-OWN-01, FRZ-OWN-02, FRZ-OWN-05, FRZ-CTR-01, FRZ-CTR-04, FRZ-CTR-05, FRZ-CTR-06, FRZ-TYP-01, FRZ-TYP-02, FRZ-TYP-03, FRZ-TYP-06, FRZ-PLG-01, FRZ-PLG-02, FRZ-PLG-04, FRZ-REG-02, FRZ-REG-09 | Blocker evidence; FRZ rows remain OPEN until independent closure at platform scope. |
