...
| FRZ-REG-03 | Regression / qualification infrastructure | negative tests prove gates detect violations | QUAL-X | OPEN | **EBH-2I** (`4958c7e4…`): CSP + dependency negative proofs in `test_ebh_2i_final_rescan_gate.py` (parent scope). |
