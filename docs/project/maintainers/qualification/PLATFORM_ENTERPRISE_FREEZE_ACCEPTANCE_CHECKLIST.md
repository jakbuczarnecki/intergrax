...
| FRZ-CTR-01 | Contracts / abstraction | consumers depend on contracts | EBH-2*, EBH-3, EBH-4 | OPEN | EBH-2F-R2-R1 (in progress): canonical `resolve` / `resolve_from_profile` materialize `PlatformIntegrationContract`, not `Any`. |
...
| FRZ-TYP-02 | Strong typing | Any at semantic boundaries = 0 unless evidence-backed transport reason | EBH-2* | OPEN | EBH-2F-R2-R1 (in progress): audit `7611cc8b352c29af38c964e70f675967d2e959cd` — `resolve` / contract spec semantic `Any`. |
...
| FRZ-REG-09 | Regression / qualification infrastructure | critical invariant protected by code/test, not docs only | QUAL-X | OPEN | EBH-2F-R2-R1 extends gates to `registry/factory.py` + `contract_spec.py` (in progress). |
...
| EBH-2F-R2-R1-BLOCKER | `7611cc8b352c29af38c964e70f675967d2e959cd` | Independent audit rejected EBH-2F-R2 closure: `resolve` / `resolve_from_profile` → `Any`, `IntegrationContractFactory = Callable[..., Any]`, semantic `Any` on `IntegrationContractSpec`. Tracked as EBH-2F-R2-R1 CURRENT. | FRZ-CTR-01, FRZ-CTR-03, FRZ-CTR-05, FRZ-TYP-01, FRZ-TYP-02, FRZ-TYP-03, FRZ-TYP-04, FRZ-TYP-06, FRZ-PLG-01, FRZ-PLG-02, FRZ-REG-02, FRZ-REG-09 | Blocker evidence; FRZ rows remain OPEN until independent closure at platform scope. |
