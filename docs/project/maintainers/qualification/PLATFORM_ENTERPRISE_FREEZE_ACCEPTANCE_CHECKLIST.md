...
| FRZ-CTR-01 | Contracts / abstraction | consumers depend on contracts | EBH-2*, EBH-3, EBH-4 | OPEN | EBH-2F-R2-R1-R1 (in progress): pre-built `instance_for_category` must satisfy canonical category contract via `contract_for_category`, same as factory path. |
...
| FRZ-TYP-02 | Strong typing | Any at semantic boundaries = 0 unless evidence-backed transport reason | EBH-2* | OPEN | EBH-2F-R2-R1-R1 (in progress): audit `8570c8440ddf75d1256f58ecb5182d9a1a441ec5` — weak pre-built category contract acceptance. |
| FRZ-TYP-03 | Strong typing | generic object semantic seams = 0 | EBH-2* | OPEN | EBH-2F-R2-R1-R1 (in progress): reject plain `object()` pre-built bindings at canonical accessor. |
...
| FRZ-REG-09 | Regression / qualification infrastructure | critical invariant protected by code/test, not docs only | QUAL-X | OPEN | EBH-2F-R2-R1-R1 extends R2 gate: `instance_for_category` + factory category contract validation (in progress). |
...
| EBH-2F-R2-R1-BLOCKER | `8570c8440ddf75d1256f58ecb5182d9a1a441ec5` | Independent audit rejected EBH-2F-R2-R1 pre-built closure: `instance_for_category` accepted generic `PlatformIntegrationContract`, wrong category, and plain objects. Tracked as EBH-2F-R2-R1-R1 CURRENT. | FRZ-CTR-01, FRZ-TYP-02, FRZ-TYP-03, FRZ-TYP-06, FRZ-PLG-02, FRZ-REG-02, FRZ-REG-09 | Blocker evidence; FRZ rows remain OPEN until independent closure at platform scope. |
