...
| FRZ-CTR-01 | Contracts / abstraction | consumers depend on contracts | EBH-2*, EBH-3, EBH-4 | OPEN | EBH-2F-R2-R1-R1-R1-R1 (in progress): canonical `CategoryIntegrationInstance` must truthfully type registry-backed and DI-only category resolution results. |
...
| FRZ-TYP-02 | Strong typing | Any at semantic boundaries = 0 unless evidence-backed transport reason | EBH-2* | OPEN | EBH-2F-R2-R1-R1-R1-R1 (in progress): truthful category result typing without false `PlatformIntegrationContract` annotations. |
| FRZ-TYP-03 | Strong typing | generic object semantic seams = 0 | EBH-2* | OPEN | EBH-2F-R2-R1-R1-R1-R1 (in progress): reject plain `object()` pre-built bindings; no semantic `object` result types on resolution API. |
...
| FRZ-REG-09 | Regression / qualification infrastructure | critical invariant protected by code/test, not docs only | QUAL-X | OPEN | EBH-2F-R2-R1-R1-R1-R1 extends R2 gate: `CategoryIntegrationInstance` + pyright on resolution surfaces (in progress). |
...
| EBH-2F-R2-R1-R1-R1-BLOCKER | `fd7a12f773406d1c7babb79388aba30526a17aa6` | Independent audit rejected EBH-2F-R2-R1-R1-R1 closure: category contract resolution unified, but public result APIs still annotated as `PlatformIntegrationContract` while `external_work` legally returns `ExternalWorkIntegration`. Tracked as EBH-2F-R2-R1-R1-R1-R1 CURRENT. | FRZ-CTR-01, FRZ-CTR-04, FRZ-CTR-05, FRZ-CTR-06, FRZ-TYP-01, FRZ-TYP-02, FRZ-TYP-03, FRZ-TYP-06, FRZ-PLG-01, FRZ-PLG-02, FRZ-PLG-04, FRZ-REG-02, FRZ-REG-09 | Blocker evidence; FRZ rows remain OPEN until independent closure at platform scope. |
