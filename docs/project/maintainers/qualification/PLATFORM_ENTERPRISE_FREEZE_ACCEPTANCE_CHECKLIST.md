...
| FRZ-REG-05 | Regression / qualification infrastructure | stale inventories = 0 | QUAL-X | OPEN | **HARNESS-QINF-01** (pending independent closure): bidirectional Nexus importer + RuntimeToolInvoker reference reconciliation gates (parent scope; not global PASS). |
