...
| --- | --- | --- | --- | --- | --- |
| FRZ-BND-01 | Layer boundaries | canonical layer model documented | EBH-2*, EBH-3, EBH-4 | OPEN | **EBH-2H** (`86fafaa…`): Memory contract boundary hardening on audited HEAD — canonical Memory contracts and sanctioned composition (parent scope; not global PASS). |
