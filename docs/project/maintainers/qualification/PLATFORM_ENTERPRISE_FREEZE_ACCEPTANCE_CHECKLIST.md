...
| FRZ-PLG-03 | Pluginability | provider discovery has explicit owner | EBH-2*, EBH-5 | OPEN | **EBH-2G-R2-R1** (`be7e817…`): provider discovery owner = Integration catalog (R2-R1 scope). **EBH-2G-R2** (`29c721356…`): parent recertification — Graph Store discovery/selection/materialization owner = Integrations (R2 parent scope). |
| FRZ-PLG-04 | Pluginability | provider selection has explicit owner | EBH-2*, EBH-5 | OPEN | **EBH-2G-R2-R1** (`be7e817…`): provider selection owner = IntegrationProfile / Integration resolver (R2-R1 scope). **EBH-2G-R2** (`29c721356…`): canonical `IntegrationProfile` selection path revalidated (R2 parent scope). |
