...
**Load first:** [`docs/project/technical/guides/audit_slices/AGENT_CONTRACTS_AND_ASSEMBLY.md`](../guides/audit_slices/AGENT_CONTRACTS_AND_ASSEMBLY.md) — compact slice (layers **17–20, 31 · ACP §21**); replaces bulk IDEAL + AUDIT_MAP + full plan/arch reads.
