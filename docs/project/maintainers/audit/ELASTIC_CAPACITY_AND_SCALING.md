...
**Audit map layers:** 30 · compact slice: [`audit_slices/ELASTIC_CAPACITY_AND_SCALING.md`](../guides/audit_slices/ELASTIC_CAPACITY_AND_SCALING.md)  
...
**Load first:** [`docs/project/technical/guides/audit_slices/ELASTIC_CAPACITY_AND_SCALING.md`](../guides/audit_slices/ELASTIC_CAPACITY_AND_SCALING.md) — compact slice (layers **30**); replaces bulk IDEAL + AUDIT_MAP + full plan/arch reads.
