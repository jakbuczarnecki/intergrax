...
**Audit map layers:** 7 · compact slice: [`audit_slices/REASONING_AND_COGNITION.md`](../guides/audit_slices/REASONING_AND_COGNITION.md)  
...
**Load first:** [`docs/project/technical/guides/audit_slices/REASONING_AND_COGNITION.md`](../guides/audit_slices/REASONING_AND_COGNITION.md) — compact slice (layers **7**); replaces bulk IDEAL + AUDIT_MAP + full plan/arch reads.
