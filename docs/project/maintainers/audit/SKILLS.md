...
**Load first:** [`docs/project/technical/guides/audit_slices/SKILLS.md`](../guides/audit_slices/SKILLS.md) — compact slice (layers **12**); replaces bulk IDEAL + AUDIT_MAP + full plan/arch reads.
