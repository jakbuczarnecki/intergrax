...
**Load first:** [`docs/project/technical/guides/audit_slices/CRITIC_VERIFICATION.md`](../guides/audit_slices/CRITIC_VERIFICATION.md) — compact slice (layers **25 (depth)**); replaces bulk IDEAL + AUDIT_MAP + full plan/arch reads.
...
See **Code entry** in `docs/project/technical/guides/audit_slices/CRITIC_VERIFICATION.md` — then inspect:
