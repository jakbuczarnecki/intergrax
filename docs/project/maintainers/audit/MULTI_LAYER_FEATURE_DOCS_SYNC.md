...
This fact must be visible in project-level documentation, not hidden only in `docs/project/capabilities/README.md`.
...
Do **not** create `docs/project/maintainers/plans/<FEATURE>.md` for multi-layer features.
...
- Read `docs/project/capabilities/README.md` first.
- Read `docs/project/architecture/intergrax_runtime_architecture.md`.
- Read `docs/project/technical/guides/INTERGRAX_DEVELOPMENT_STRATEGY.md`.
...
- `README.md` must mention `docs/project/capabilities/README.md` and the paired feature architecture/plan structure.
...
docs/project/capabilities/README.md
```

If `docs/project/architecture/intergrax_runtime_architecture.md` already contains the new structure, only verify and refine links if needed.
...
docs/project/technical/guides/LAYER_COMPLETION_MODE.md
docs/project/technical/guides/AGENT_INSTRUCTIONS.md
```
...
```text
docs/project/maintainers/audit/README.md
docs/project/maintainers/audit/IDEA_AUDIT_ORCHESTRATOR.md
docs/project/maintainers/audit/ORCHESTRATOR.md
docs/project/maintainers/audit/IMPLEMENT_ORCHESTRATOR.md
docs/project/maintainers/audit/LAYER_COMPLETION_ORCHESTRATOR.md
docs/project/maintainers/bootstrap/README.md
docs/project/maintainers/bootstrap/idea_audit.txt
```

Update these so future idea audits know that cross-layer features should be documented under `docs/project/capabilities/architecture` and `docs/project/capabilities/plan`, not as plan-only files under `docs/project/maintainers/plans`.
...
1. `Current platform maturity` paragraph, after the sentence about `docs/project/architecture/<DOMAIN>.md` ↔ `docs/project/maintainers/plans/<DOMAIN>.md`.
...
- Do not create `docs/project/maintainers/plans/<FEATURE>.md`.
...
- `docs/project/technical/guides/INTERGRAX_DEVELOPMENT_STRATEGY.md`,
- `docs/project/maintainers/audit/README.md`,
- `docs/project/technical/DOCUMENTATION_MAP.md` if present,
