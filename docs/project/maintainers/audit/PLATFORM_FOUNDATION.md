...
**Audit map layers:** 1–2, 32 · compact slice: [`audit_slices/PLATFORM_FOUNDATION.md`](../guides/audit_slices/PLATFORM_FOUNDATION.md)  
...
Verify Intergrax is developed as a **Harness AI / Agent OS** — the runtime is the durable product, agents are replaceable — with enforced four-tier boundaries, 24 domain-pair documentation governance, gate maintenance discipline, and strategic alignment to IDEAL_HARNESS_AI_ARCHITECTURE.
...
**Load first:** [`docs/project/technical/guides/audit_slices/PLATFORM_FOUNDATION.md`](../guides/audit_slices/PLATFORM_FOUNDATION.md) — compact slice (layers **1–2, 32**); replaces bulk IDEAL + AUDIT_MAP + full plan/arch reads.
...
See **Code entry** in `docs/project/technical/guides/audit_slices/PLATFORM_FOUNDATION.md` — then inspect:

```text
docs/project/architecture/intergrax_runtime_architecture.md (hub)
...
7. Documentation model: hub-only `docs/` root; 24 architecture↔plan pairs 1:1; no monolithic plan.
