...
**Load first:** [`docs/project/technical/guides/audit_slices/TOOLS.md`](../guides/audit_slices/TOOLS.md) — compact slice (layers **11**); replaces bulk IDEAL + AUDIT_MAP + full plan/arch reads.
