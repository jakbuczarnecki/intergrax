...
**Load first:** [`docs/project/technical/guides/audit_slices/CONTEXT_ENGINEERING.md`](../guides/audit_slices/CONTEXT_ENGINEERING.md) — compact slice (layers **16**); replaces bulk IDEAL + AUDIT_MAP + full plan/arch reads.
...
See **Code entry** in `docs/project/technical/guides/audit_slices/CONTEXT_ENGINEERING.md` — then inspect:
