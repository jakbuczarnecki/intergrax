...
**Load first:** [`docs/project/technical/guides/audit_slices/TIER3_APPLICATION_ENVIRONMENT.md`](../guides/audit_slices/TIER3_APPLICATION_ENVIRONMENT.md) — compact slice (layers **3, 28**); replaces bulk IDEAL + AUDIT_MAP + full plan/arch reads.
...
See **Code entry** in `docs/project/technical/guides/audit_slices/TIER3_APPLICATION_ENVIRONMENT.md` — then inspect:
