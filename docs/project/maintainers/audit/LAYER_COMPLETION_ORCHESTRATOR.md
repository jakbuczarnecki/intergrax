...
**Per-domain LCM canon:** [`LAYER_COMPLETION_MODE.md`](../../technical/guides/LAYER_COMPLETION_MODE.md)
...
For each `<DOMAIN>`, execute [`LAYER_COMPLETION_MODE.md`](../../technical/guides/LAYER_COMPLETION_MODE.md) Steps 1 → 1A → 2 → 3 → 4 → 5 → 6.
