...
**Load first:** [`docs/project/technical/guides/audit_slices/OBSERVABILITY.md`](../guides/audit_slices/OBSERVABILITY.md) — compact slice (layers **21, 30**); replaces bulk IDEAL + AUDIT_MAP + full plan/arch reads.
...
See **Code entry** in `docs/project/technical/guides/audit_slices/OBSERVABILITY.md` — then inspect:
