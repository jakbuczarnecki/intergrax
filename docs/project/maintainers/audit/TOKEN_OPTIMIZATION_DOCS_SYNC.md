...
branch: development
source_instruction: docs/project/maintainers/audit/TOKEN_OPTIMIZATION.md
feature_architecture: docs/project/capabilities/architecture/TOKEN_OPTIMIZATION.md
feature_plan: docs/project/capabilities/plan/TOKEN_OPTIMIZATION.md
...
Use `docs/project/maintainers/audit/TOKEN_OPTIMIZATION.md` as the source instruction and perform a **documentation-only sync**.
...
- Read `docs/project/maintainers/audit/TOKEN_OPTIMIZATION.md` first.
- Read `docs/project/capabilities/README.md` to understand multi-layer feature structure.
- Read existing `docs/project/capabilities/architecture/TOKEN_OPTIMIZATION.md` and `docs/project/capabilities/plan/TOKEN_OPTIMIZATION.md` if present.
...
1. Add a short architecture reference to `docs/project/capabilities/architecture/TOKEN_OPTIMIZATION.md`.
...
At minimum, ensure `docs/project/capabilities/plan/TOKEN_OPTIMIZATION.md` contains:
