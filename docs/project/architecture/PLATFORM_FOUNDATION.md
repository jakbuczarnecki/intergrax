...
| **Domain / scenario attribution** *(ai_incident DS-E2E-12)* | Deterministic `supporting_evidence_ids` / `contradicting_evidence_ids` binding at claim conversion — **not** model-owned |
