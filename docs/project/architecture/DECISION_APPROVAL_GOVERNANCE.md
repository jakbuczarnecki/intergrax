...
**Status:** **MP-4R3 CLOSED** · **MP-4R4 CLOSED** (Collaborative `DecisionProposalRef` binding; Multiplayer-owned association only) · **MP-4R5 — READY_FOR_FINAL_INDEPENDENT_CLOSURE_AUDIT** (operation-outcome evidence adoption; WorkItem ↔ DecisionProposalRef association — **deferred** frozen Evidence Plane gap) · **MP-4R2** closed · **MP-4R1** closed · **MP-4R0** closed · legacy **MP-4A** `SUPERSEDED_BY_MP4R0` · **MP-4B** `RETIRED` (MP-4R1) · **MP-4C** `RETIRED` (MP-4R2) · **MP-4D** `RETIRED` (MP-4R2) · legacy MP-4E…MP-4H **cancelled/replaced** by MP-4R1…MP-4R8
