...
**Cross-refs:** [`SYSTEM_INVARIANTS.md`](../technical/guides/SYSTEM_INVARIANTS.md) §9 · [`MATURITY_TAXONOMY.md`](../technical/guides/MATURITY_TAXONOMY.md) · [`NEXUS_EXECUTION_FLOW.md`](NEXUS_EXECUTION_FLOW.md) §12.2 (S8) · [`ORCHESTRATION.md`](ORCHESTRATION.md) · [`ADAPTIVE_HARNESS_INTELLIGENCE.md`](ADAPTIVE_HARNESS_INTELLIGENCE.md#governance-boundary) · [`OBSERVABILITY.md`](OBSERVABILITY.md#observability-event-spine) · [`INTEGRATIONS.md`](INTEGRATIONS.md#integration-layer-contract) · [`TIER3_APPLICATION_ENVIRONMENT.md`](TIER3_APPLICATION_ENVIRONMENT.md)
...
- external enterprise claims require **P5/E5** according to [`MATURITY_TAXONOMY.md`](../technical/guides/MATURITY_TAXONOMY.md).
...
- Is maturity stated using [`MATURITY_TAXONOMY.md`](../technical/guides/MATURITY_TAXONOMY.md)?
...
[`IDEAL_HARNESS_AI_ARCHITECTURE.md`](../technical/guides/IDEAL_HARNESS_AI_ARCHITECTURE.md):
