...
| Try the primary LKW product path | [LKW Quick Start](../product/lkw/QUICKSTART.md) | Run the supported indexed product evaluation |
...
**Supported product evaluation:** [LKW Quick Start](../product/lkw/QUICKSTART.md)

The LKW Quick Start is the supported product path for trying the indexed workspace workflow.

**Bounded technical reviewer evidence:** [LKW Platform Proof](../proofs/LKW_PLATFORM_PROOF.md)
...
**Featured platform-capability proof:** [Token Optimization guide](../capabilities/token_optimization/README.md)

Covers implemented deterministic mechanisms, cache-aware execution, protected-region validation, receipts, and a **bounded vLLM** proof path. Claim guardrails: [TOKEN_OPTIMIZATION_CLAIMS.md](../capabilities/TOKEN_OPTIMIZATION_CLAIMS.md).
