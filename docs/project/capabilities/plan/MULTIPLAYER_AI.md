...
**Next task after MP-2 gate:** COLLAB-WORK-2B — repository ports + in-memory reference
...
|-------|-------|
| **Priority** | P1 |
| **Status** | **IMPLEMENTATION IN PROGRESS** — COLLAB-WORK-2A APPROVED / CLOSED |
...
| **Next implementation row** | **COLLAB-WORK-2B** |
