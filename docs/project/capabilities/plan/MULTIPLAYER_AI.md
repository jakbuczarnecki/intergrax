...
| **Next step** | **MP-7 — IN PROGRESS** (MP-7B boundary qualified; MP-6 — **ENTERPRISE CERTIFIED / CLOSED**) |
...
|-------|-------|
| **Priority** | P2 |
| **Status** | **IN PROGRESS** — **MP-7A CLOSED / CERTIFIED**; **MP-7B — TIER-3 MULTIPLAYER CONSUMER BOUNDARY QUALIFIED / CLOSED**; **MP-7 — IN PROGRESS** |
