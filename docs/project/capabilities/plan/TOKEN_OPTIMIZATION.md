...
1. `docs/project/capabilities/architecture/TOKEN_OPTIMIZATION.md` (read-scope block only)
2. `docs/project/capabilities/plan/TOKEN_OPTIMIZATION.md` (read-scope block + active TOKEN phase only)
...
| `TOKEN-5` / `TOKEN-5A` MemorySummaryCompressor (helper-only first slice) | `docs/project/maintainers/plans/MEMORY.md` |
...
Owner plan: [`docs/project/maintainers/plans/OBSERVABILITY.md`](../../maintainers/plans/OBSERVABILITY.md) Phase TOKEN-OBS; early slice **TOKEN-6A-lite** defines telemetry shape only.
...
- public claim guardrails added in `docs/project/capabilities/TOKEN_OPTIMIZATION_CLAIMS.md`
...
- canonical architecture section in `docs/project/capabilities/architecture/TOKEN_OPTIMIZATION.md`
- detailed cache-prefix stabilization addendum update in `docs/project/capabilities/architecture/TOKEN_OPTIMIZATION_CACHE_PREFIX_STABILIZATION.md`
...
Safe evidence: [`docs/project/proofs/token_optimization/token-10i-qwen3-14b-awq-feasibility.md`](../../proofs/token_optimization/token-10i-qwen3-14b-awq-feasibility.md).
...
**Domain plan rows:** `TOKEN-UER-1` in `docs/project/maintainers/plans/UNIFIED_EXECUTION_RUNTIME.md`.
...
**Domain plan rows:** `TOKEN-UER-2` in `docs/project/maintainers/plans/UNIFIED_EXECUTION_RUNTIME.md`.
...
**Domain plan rows:** `TOKEN-TOOLS-1A` (Done / Closed) and `TOKEN-TOOLS-1B` (Planned) in `docs/project/maintainers/plans/TOOLS.md`.
...
**Domain plan rows:** `TOKEN-CE-1A` (Done / Closed), `TOKEN-CE-1B` (Planned), and `TOKEN-CE-2` (Planned) in `docs/project/maintainers/plans/CONTEXT_ENGINEERING.md`.
...
**Domain plan rows:** `TOKEN-MEM-1` in `docs/project/maintainers/plans/MEMORY.md`.
...
**Domain plan rows:** `TOKEN-OBS-1` and `TOKEN-OBS-2` in `docs/project/maintainers/plans/OBSERVABILITY.md`.
...
**Domain plan rows:** `TOKEN-AHI-1` in `docs/project/maintainers/plans/ADAPTIVE_HARNESS_INTELLIGENCE.md`.
...
- docs/project/maintainers/plans/UNIFIED_EXECUTION_RUNTIME.md rows TOKEN-UER-1/TOKEN-UER-2
