...
**New required (implementation):** MP-4B…MP-4H slices per [`DECISION_APPROVAL_GOVERNANCE` plan](../../maintainers/plans/DECISION_APPROVAL_GOVERNANCE.md).

**Next active task:** **MP-4B** — Decision contracts.
