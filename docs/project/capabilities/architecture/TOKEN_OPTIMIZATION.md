...
**Source audit instruction:** [`../../../audit_results/2026-08-18/TOKEN_OPTIMIZATION.md`](../../../audit_results/2026-08-18/TOKEN_OPTIMIZATION.md)
...
Do not create `docs/project/maintainers/plans/TOKEN_OPTIMIZATION.md` unless Token Optimization is later promoted into a full domain with a matching `docs/project/architecture/TOKEN_OPTIMIZATION.md`.
...
Provider-cache attribution must be measured separately from content-reduction savings. Provider integration rows: `TOKEN-LLM-2`, `TOKEN-LLM-3` in [`docs/project/maintainers/plans/LLM_ADAPTERS.md`](../../maintainers/plans/LLM_ADAPTERS.md). Runtime wiring: **TOKEN-10B**–**TOKEN-10D**.
...
2. Update the affected `docs/project/architecture/<DOMAIN>.md` file.
3. Add implementation rows to the affected `docs/project/maintainers/plans/<DOMAIN>.md` file.
4. Keep `docs/project/capabilities/plan/TOKEN_OPTIMIZATION.md` as the coordination map.
