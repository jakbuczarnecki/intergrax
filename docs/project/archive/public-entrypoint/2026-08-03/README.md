...
Strategic direction: [Development Strategy](docs/project/technical/guides/INTERGRAX_DEVELOPMENT_STRATEGY.md) · [System invariants](docs/project/technical/guides/SYSTEM_INVARIANTS.md) · Ideal target: [IDEAL_HARNESS_AI_ARCHITECTURE.md](docs/project/technical/guides/IDEAL_HARNESS_AI_ARCHITECTURE.md) · **Agent model canon:** [AGENT_CONTRACTS_AND_ASSEMBLY.md](docs/project/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md) §13–§40
...
**Harness baseline:** **32/32** audit layers at **L3** ([scorecard](scripts/gates/harness_maturity_report.py) · [IDEAL_HARNESS_L3](docs/project/maintainers/plans/IDEAL_HARNESS_L3.md) · [audit map §5](docs/project/technical/guides/INTEGRAX_HARNESS_AUDIT_MAP.md#5-maturity-scoring-model) · [Maturity Taxonomy](docs/project/technical/guides/MATURITY_TAXONOMY.md)).

Maturity uses **L0–L4** levels (not arbitrary percentages) — navigation summaries in this README. Authoritative readiness claims use the four-axis **A/I/P/E** vocabulary in [MATURITY_TAXONOMY.md](docs/project/technical/guides/MATURITY_TAXONOMY.md). Per-domain evidence lives in **domain-layer pairs**: `docs/project/architecture/<DOMAIN>.md` ↔ `docs/project/maintainers/plans/<DOMAIN>.md`. **Cross-layer capabilities** use **multi-layer feature pairs**: `docs/project/capabilities/architecture/<FEATURE>.md` ↔ `docs/project/capabilities/plan/<FEATURE>.md` — see [Multi-layer feature docs](docs/project/capabilities/README.md).

| Area | Maturity | Evidence / open gap |
|------|----------|---------------------|
| **Agent contracts (ACP)** | **L3** | [Phase ACP](docs/project/maintainers/plans/AGENT_CONTRACTS_AND_ASSEMBLY.md) **Done** · fleet `on_next_step` migration ongoing |
| **Tools** | **L3** | [TOOL-ENG](docs/project/maintainers/plans/TOOLS.md) closeout **Done** · deferred: hierarchical LLM category pass |
| **Tier-3 hosts** | **L3** (depth partial) | [APP-PROD](docs/project/maintainers/plans/TIER3_APPLICATION_ENVIRONMENT.md) gates **Done** · §22 profile bundles M1–M3 **Done** · enterprise distribution **P4** |
| **Memory** | **L3** | [MEM / MEM-VEC / MEM-DEPTH](docs/project/maintainers/plans/MEMORY.md) **Done** · L3 harness · P2 depth: procedural store, org LTM parity, per-step budget caps before CE collect |
| **RAG** | **L3** (profile-driven) | [M-RAG-DEPTH / GRAPH](docs/project/maintainers/plans/RAG.md) **Done** · Tier-3 `RagProfile` required · autonomous parser/chunker/retriever selection **Frozen/P4** → AHI |
| **Adaptive harness (AHI)** | **L4-ready** (mechanisms) | [W-ADAPT](docs/project/maintainers/plans/ADAPTIVE_HARNESS_INTELLIGENCE.md) **Done** · L4 runtime mechanisms implemented · production L4 evidence requires product-host run volume |

**Also at L3:** LLM adapters · Observability · Nexus flow · UAEP · Skills · Integrations — full index in [architecture hub](docs/project/architecture/intergrax_runtime_architecture.md).
...
You may clone, install, run, test, and modify the repository locally for non-production evaluation; create GitHub forks and pull requests; and participate in technical collaboration as described in [COLLABORATION.md](COLLABORATION.md) and [CONTRIBUTING.md](CONTRIBUTING.md). Intergrax is **not** open source. Controlled internal evaluation by organizations — including multiple Evaluation Participants — and collaboration on Authorized Forks are permitted. Production use, commercial use, hosting, and redistribution require **explicit written permission**. Contributors retain copyright in their contributions but license submitted Code Contributions and Documentation Contributions to the maintainer upon submission under the terms in [LICENSE](LICENSE). Full terms: [LICENSE](LICENSE).

Active public feedback paths are listed in the [Public Issue Index](docs/project/maintainers/public-adoption/PUBLIC_ISSUE_INDEX.md). Use it to choose the right curated issue for proof-path feedback, documentation clarity, integration feedback, or design-partner interest.
...
Use the [Public Issue Index](docs/project/maintainers/public-adoption/PUBLIC_ISSUE_INDEX.md) to choose the right entry point.
...
- Builders working on [attestation](docs/project/overview/case-studies/BOUNDARYATTEST_ATTESTATION_POC.md), receipts, boundary events, auditability, observability, or agent governance
...
- **Operational readiness is measurable** — [Agent Production Readiness Scoreboard](docs/project/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md#4015-agent-production-readiness-scoreboard) (contract, runtime, policy, observability, checkpointing, idempotency, security, evaluation, lifecycle, routing).
- **Agents are swappable** — capability-based routing (`research.web_search`), not hardcoded class names in Nexus.

**Canonical decisions:** [ADR-AGENT-001](docs/project/technical/adr/entries/2026-06-11/ADR-AGENT-001.md) (Nexus stays Agent OS) · [ADR-AGENT-002](docs/project/technical/adr/entries/2026-06-11/ADR-AGENT-002.md) (`Agent.run()` facade) · [ADR-AGENT-003](docs/project/technical/adr/entries/2026-06-11/ADR-AGENT-003.md) (step loop + dual observability).

**Implementation status:** architecture **decision-complete** (§13–§40); delivery via plan [Phase ACP](docs/project/maintainers/plans/AGENT_CONTRACTS_AND_ASSEMBLY.md) (typed contracts → step loop → fleet migration → prod gates). Today: UAEP bridge + Nexus path; target: typed `on_next_step` on all roster agents.

**Deep dive:** [Agent Creation Guide — Appendix AC](docs/project/technical/guides/AGENT_CREATION_GUIDE.md#appendix-ac--agent-run-cognitive-patterns-and-environment-acp) · [Architecture hub — agent in environment](docs/project/architecture/intergrax_runtime_architecture.md#agent-in-the-harness-environment)
...
See [Harness Environment — core certification](docs/project/technical/guides/HARNESS_ENVIRONMENT.md#core-certification-evidence-path-hep).
...
**Full workflow:** [Agent Creation Guide](docs/project/technical/guides/AGENT_CREATION_GUIDE.md) · **Contributing setup:** [CONTRIBUTING.md](CONTRIBUTING.md)

After running the quick start, share structured feedback via [#186 README quick start feedback](https://github.com/jakbuczarnecki/intergrax/issues/186) or choose another path from the [Public Issue Index](docs/project/maintainers/public-adoption/PUBLIC_ISSUE_INDEX.md).
...
**Next steps:** After the proof path, inspect `build/evidence/posture/posture.md` first, then drill into the individual evidence reports. For roadmap and status, see [HARNESS_EVIDENCE_PACK.md](docs/project/maintainers/plans/HARNESS_EVIDENCE_PACK.md). For architecture framing, see [EXPERIMENTATION_AND_DEVELOPER_EXPERIENCE_production_gates.md](docs/project/architecture/satellites/EXPERIMENTATION_AND_DEVELOPER_EXPERIENCE_production_gates.md).
...
|--------|-----|------------|
| **Scaffold a new agent** | `python -m intergrax.scaffold new-agent …` | [Agent Creation Guide](docs/project/technical/guides/AGENT_CREATION_GUIDE.md) |
| **Build a Tier-3 application** | `new-application` / `new-stack` | [applications/USAGE.md](applications/USAGE.md) |
| **Connect integrations** | `IntegrationProfile` + Tier-3 wiring | [architecture/INTEGRATIONS.md](docs/project/architecture/INTEGRATIONS.md) |
| **Attach tools and skills** | `ToolProfile`, `SkillProfile`, `skill_ids` on contract | [architecture/TOOLS.md](docs/project/architecture/TOOLS.md) · [architecture/SKILLS.md](docs/project/architecture/SKILLS.md) |
| **Run through Nexus** | Lab or product host → `NexusLoop` → `Agent.run()` / `AgentEngine` | [NEXUS_EXECUTION_FLOW.md](docs/project/architecture/NEXUS_EXECUTION_FLOW.md) · [Agent model](#the-agent-model--why-architects-choose-intergrax) |
| **Inspect traces** | `/debug/tasks/{id}/trace`, `intergrax.debug` | [HARNESS_ENVIRONMENT.md](docs/project/technical/guides/HARNESS_ENVIRONMENT.md) |
| **Evaluate execution** | Evaluation profile, online registry, CVL hooks | [CRITIC_VERIFICATION.md](docs/project/architecture/CRITIC_VERIFICATION.md) |
| **Ephemeral code craft** | Dynamic codegen loop in sandbox (**Done** ECC-0…ECC-6) | [CODE_CRAFT.md](docs/project/architecture/CODE_CRAFT.md) |
| **Extend via plugins** | `ToolPlugin`, `IntegrationPlugin`, `SkillPlugin` EPs | [EXTENSION_AUTHOR_GUIDE.md](docs/project/technical/guides/EXTENSION_AUTHOR_GUIDE.md) |
...
**Vocabulary canon:** [architecture/PLATFORM_FOUNDATION.md §5.3](docs/project/architecture/PLATFORM_FOUNDATION.md) · **Target model:** [IDEAL_HARNESS_AI_ARCHITECTURE.md](docs/project/technical/guides/IDEAL_HARNESS_AI_ARCHITECTURE.md)
...
New capabilities start in the lab (`lab_application`, pytest, debug API). Capabilities that ship to users graduate through maturity gates. Business agents (Phase K) require **explicit product prioritization** — default harness queue is [gate maintenance](docs/project/maintainers/plans/PLATFORM_FOUNDATION.md#61-harness-platform-maintenance-default--band-1).

Details: [INTERGRAX_DEVELOPMENT_STRATEGY.md](docs/project/technical/guides/INTERGRAX_DEVELOPMENT_STRATEGY.md) · [HARNESS_ENVIRONMENT.md](docs/project/technical/guides/HARNESS_ENVIRONMENT.md)
...
Canon: [architecture/PLATFORM_FOUNDATION.md §5.2](docs/project/architecture/PLATFORM_FOUNDATION.md) · Hub: [intergrax_runtime_architecture.md](docs/project/architecture/intergrax_runtime_architecture.md)
...
Catalogs: [INTEGRATIONS.md](docs/project/architecture/INTEGRATIONS.md) · [TOOLS.md](docs/project/architecture/TOOLS.md) · [SKILLS.md](docs/project/architecture/SKILLS.md)
...
Canon: [AGENT_CONTRACTS_AND_ASSEMBLY.md](docs/project/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md) · Plan: [Phase ACP](docs/project/maintainers/plans/AGENT_CONTRACTS_AND_ASSEMBLY.md) · [UNIFIED_EXECUTION_RUNTIME.md](docs/project/architecture/UNIFIED_EXECUTION_RUNTIME.md) · [NEXUS_EXECUTION_FLOW.md](docs/project/architecture/NEXUS_EXECUTION_FLOW.md) · [ORCHESTRATION.md §50–§54](docs/project/architecture/ORCHESTRATION.md)
...
|-------|--------------|--------|--------------|------|-------------------|
| **Integrations** | **197** slugs · **31** contract categories (116 STABLE · 81 BETA) | [`intergrax/integrations/`](intergrax/integrations) | [INTEGRATIONS.md](docs/project/architecture/INTEGRATIONS.md) | [plan/INTEGRATIONS.md](docs/project/maintainers/plans/INTEGRATIONS.md) | Per-provider USAGE.md under `intergrax/integrations/providers/` |
| **Tools** | **200** `tool_id`s · **49** bundles | [`intergrax/tools/`](intergrax/tools) | [TOOLS.md](docs/project/architecture/TOOLS.md) | [plan/TOOLS.md](docs/project/maintainers/plans/TOOLS.md) | [intergrax/tools/USAGE.md](intergrax/tools/USAGE.md) |
| **Skills** | **150** `skill_id`s · **42** bundles | [`intergrax/skills/`](intergrax/skills) | [SKILLS.md](docs/project/architecture/SKILLS.md) | [plan/SKILLS.md](docs/project/maintainers/plans/SKILLS.md) | Per-skill `USAGE.md` under `intergrax/skills/providers/{bundle}/{skill_id}/` |

**Control plane (profiles, wiring, resolver):** [AGENT_CREATION_GUIDE.md Appendix J](docs/project/technical/guides/AGENT_CREATION_GUIDE.md#appendix-j--tools--skills-control-plane) · **Extension plugins:** [EXTENSION_AUTHOR_GUIDE.md](docs/project/technical/guides/EXTENSION_AUTHOR_GUIDE.md)

**Skill bundles (42):** `agent`, `billing`, `browser`, `cache`, `catalog`, `cloud_platform`, `code`, `codecraft`, `collaboration`, `context`, `cost`, `crm`, `data`, `dev`, `eval`, `filesystem`, `gitlab`, `graph`, `harness`, `health`, `hitl`, `http`, `identity`, `interaction`, `jira`, `knowledge`, `legal`, `memory`, `message_bus`, `metrics`, `ml`, `modality`, `notify`, `openai`, `ops`, `platform`, `rag`, `research`, `sandbox`, `storage`, `vector_store`, `workspace` — **150** skills — full index in [SKILLS.md](docs/project/architecture/SKILLS.md).
...
|---------|----------------|---------------|
| **Integrations** | **197** providers · `intergrax/integrations/` | [architecture/INTEGRATIONS.md](docs/project/architecture/INTEGRATIONS.md) · [plan](docs/project/maintainers/plans/INTEGRATIONS.md) |
| **Tools** | **200** catalog tools · **49** bundles · `intergrax/tools/` | [architecture/TOOLS.md](docs/project/architecture/TOOLS.md) · [plan](docs/project/maintainers/plans/TOOLS.md) · [USAGE](intergrax/tools/USAGE.md) |
| **Skills** | **150** skills · **42** bundles · `intergrax/skills/` | [architecture/SKILLS.md](docs/project/architecture/SKILLS.md) · [plan](docs/project/maintainers/plans/SKILLS.md) |
| **LLM adapters** | 19 providers · typed `LLMAdapterResponse` | [architecture/LLM_ADAPTERS.md](docs/project/architecture/LLM_ADAPTERS.md) |
| **RAG** | Retrieval, ingest, hybrid/graph/agentic (profile-configured) · golden + load/soak gates | [architecture/RAG.md](docs/project/architecture/RAG.md) · [plan](docs/project/maintainers/plans/RAG.md) |
| **Ephemeral Code Craft** | Dynamic codegen, test/fix loop, sandbox promotion (**Done** ECC-0…ECC-6) | [architecture/CODE_CRAFT.md](docs/project/architecture/CODE_CRAFT.md) · [plan](docs/project/maintainers/plans/CODE_CRAFT.md) |
| **Memory** | STM/LTM, context compiler, Knowledge vs LTM boundary | [architecture/MEMORY.md](docs/project/architecture/MEMORY.md) · [plan](docs/project/maintainers/plans/MEMORY.md) |
| **Modality / ML** | Vision, speech, classical ML via catalog tools | [architecture/MODALITY.md](docs/project/architecture/MODALITY.md) |
| **Governance & HITL** | Policy bundle, budgets, shadow workspace, sandbox | [UAEP §42.11](docs/project/architecture/UNIFIED_EXECUTION_RUNTIME.md) · [Appendix H](docs/project/technical/guides/AGENT_CREATION_GUIDE.md#appendix-h--governance-policy--observability-control-plane) |
| **LLM guardrails** | Vendor scanners via Integration `llm_guardrail` (M.12) | [INTEGRATIONS §47](docs/project/architecture/INTEGRATIONS.md) · [UAEP §42.11.6](docs/project/architecture/UNIFIED_EXECUTION_RUNTIME.md) · [ADR-GR-001](docs/project/technical/adr/entries/2026-06-09/ADR-GR-001.md) |
| **Observability** | Event bus, trace DB, unified journal, OTLP | [architecture/OBSERVABILITY.md](docs/project/architecture/OBSERVABILITY.md) |
| **Plugins** | pip-installable integration/tool/skill catalogs | [EXTENSION_AUTHOR_GUIDE.md](docs/project/technical/guides/EXTENSION_AUTHOR_GUIDE.md) |

**Control-plane authoring maps:** [AGENT_CREATION_GUIDE.md](docs/project/technical/guides/AGENT_CREATION_GUIDE.md) Appendices A–U · **32-layer audit:** [INTEGRAX_HARNESS_AUDIT_MAP.md](docs/project/technical/guides/INTEGRAX_HARNESS_AUDIT_MAP.md)
...
Full index: [`applications/README.md`](applications/README.md) · Composition engine: [`intergrax/applications/USAGE.md`](intergrax/applications/USAGE.md) · Tier-3 guide: [Appendix F](docs/project/technical/guides/AGENT_CREATION_GUIDE.md#appendix-f--tier-3-application-environment)
...
> **Doc roles and Cursor workflow:** [DOCUMENTATION_MAP.md](docs/project/technical/DOCUMENTATION_MAP.md) — single navigation hub (human · operator · AI agent).

### Quick doc routing

| You need… | Read |
|-----------|------|
| Map of all doc roles | [DOCUMENTATION_MAP.md](docs/project/technical/DOCUMENTATION_MAP.md) |
| Architecture hub + domain pairs | [intergrax_runtime_architecture.md](docs/project/architecture/intergrax_runtime_architecture.md) |
| Cursor audit / implement session | [bootstrap/README.md](docs/project/maintainers/bootstrap/README.md) → [audit/README.md](docs/project/maintainers/audit/README.md) |
| AI agent instructions (full) | [AGENT_INSTRUCTIONS.md](docs/project/technical/guides/AGENT_INSTRUCTIONS.md) |
| Milestone history | [implementation-journal/README.md](docs/project/maintainers/implementation-journal/README.md) |

### Internal documentation routing

| I want to… | Read |
|------------|------|
| Understand strategic direction | [INTERGRAX_DEVELOPMENT_STRATEGY.md](docs/project/technical/guides/INTERGRAX_DEVELOPMENT_STRATEGY.md) |
| **Rules you must not break** | [SYSTEM_INVARIANTS.md](docs/project/technical/guides/SYSTEM_INVARIANTS.md) — `SYS-INV-*` index (P2-ARCH-01) |
| **Close out a full harness layer** | [LAYER_COMPLETION_MODE.md](docs/project/technical/guides/LAYER_COMPLETION_MODE.md) |
| Understand the platform | [intergrax_runtime_architecture.md](docs/project/architecture/intergrax_runtime_architecture.md) → pick a domain pair |
| Exploring multi-layer platform features | [Multi-layer feature docs](docs/project/capabilities/README.md) |
| **Token Optimization Engine** | [Engine guide](docs/project/capabilities/token_optimization/README.md) · [architecture](docs/project/capabilities/architecture/TOKEN_OPTIMIZATION.md) · [plan](docs/project/capabilities/plan/TOKEN_OPTIMIZATION.md) |
| **Understand the agent model** | [The agent model](#the-agent-model--why-architects-choose-intergrax) · [AGENT_CONTRACTS §13–§40](docs/project/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md) · [ADR-AGENT-001..003](docs/project/technical/adr/entries/2026-06-11/ADR-AGENT-001.md) |
| See implementation status | [plan/PLATFORM_FOUNDATION.md](docs/project/maintainers/plans/PLATFORM_FOUNDATION.md) · [plan ACP](docs/project/maintainers/plans/AGENT_CONTRACTS_AND_ASSEMBLY.md) |
| Create a new agent | [AGENT_CREATION_GUIDE.md](docs/project/technical/guides/AGENT_CREATION_GUIDE.md) · [Appendix AC](docs/project/technical/guides/AGENT_CREATION_GUIDE.md#appendix-ac--agent-run-cognitive-patterns-and-environment-acp) |
| Full Nexus execution flow | [NEXUS_EXECUTION_FLOW.md](docs/project/architecture/NEXUS_EXECUTION_FLOW.md) |
| See catalog sizes (integrations / tools / skills) | [Tier-0 catalog summary](#tier-0-catalog-summary) |
| Wire integrations / tools / skills | [INTEGRATIONS.md](docs/project/architecture/INTEGRATIONS.md) · [TOOLS.md](docs/project/architecture/TOOLS.md) · [SKILLS.md](docs/project/architecture/SKILLS.md) · [Appendix J](docs/project/technical/guides/AGENT_CREATION_GUIDE.md#appendix-j--tools--skills-control-plane) |
| RAG engine / retrieval | [RAG.md](docs/project/architecture/RAG.md) · [plan/RAG.md](docs/project/maintainers/plans/RAG.md) · [Appendix K §K.5](docs/project/technical/guides/AGENT_CREATION_GUIDE.md#appendix-k--integration--rag-control-plane) |
| Ephemeral Code Craft | [CODE_CRAFT.md](docs/project/architecture/CODE_CRAFT.md) · [plan/CODE_CRAFT.md](docs/project/maintainers/plans/CODE_CRAFT.md) |
| All agents / applications | [agents/README.md](agents/README.md) · [applications/README.md](applications/README.md) |
| Harness audit (32 layers) | [INTEGRAX_HARNESS_AUDIT_MAP.md](docs/project/technical/guides/INTEGRAX_HARNESS_AUDIT_MAP.md) |
| Business backlog only | [plan/PLATFORM_FOUNDATION.md §6.3a](docs/project/maintainers/plans/PLATFORM_FOUNDATION.md#63a-business-backlog-register-consolidated) |

**AI context:** [llms.txt](llms.txt) · [llms-full.txt](llms-full.txt) · [AGENTS.md](AGENTS.md) (stub) · [AGENT_INSTRUCTIONS.md](docs/project/technical/guides/AGENT_INSTRUCTIONS.md) · [CURSOR_TOKEN_SETUP.md](docs/project/technical/guides/CURSOR_TOKEN_SETUP.md) · [CONTRIBUTING.md](CONTRIBUTING.md)
...
- [Maturity Taxonomy](docs/project/technical/guides/MATURITY_TAXONOMY.md) — four-axis A/I/P/E readiness vocabulary.
- [Agent Author Minimal Path](docs/project/technical/guides/AGENT_AUTHOR_MINIMAL_PATH.md) — safe Tier-2 agent authoring path.
- [Tier-3 Product Hypothesis Contract](docs/project/technical/guides/TIER3_PRODUCT_HYPOTHESIS_CONTRACT.md) — required before new application hosts.
- [Cursor Token Setup](docs/project/technical/guides/CURSOR_TOKEN_SETUP.md) — keeps Cursor context bounded.

### Canonical map

| Area | Links |
|------|-------|
| **Strategy & hub** | [Strategy](docs/project/technical/guides/INTERGRAX_DEVELOPMENT_STRATEGY.md) · [System invariants](docs/project/technical/guides/SYSTEM_INVARIANTS.md) · [Layer completion](docs/project/technical/guides/LAYER_COMPLETION_MODE.md) · [Architecture hub](docs/project/architecture/intergrax_runtime_architecture.md) · [Ideal model](docs/project/technical/guides/IDEAL_HARNESS_AI_ARCHITECTURE.md) |
| **Domain canon (22 pairs)** | `docs/project/architecture/{DOMAIN}.md` ↔ `docs/project/maintainers/plans/{DOMAIN}.md` — indexed in [hub](docs/project/architecture/intergrax_runtime_architecture.md) |
| **Multi-layer features** | `docs/project/capabilities/architecture/{FEATURE}.md` ↔ `docs/project/capabilities/plan/{FEATURE}.md` — [features/README.md](docs/project/capabilities/README.md) |
| **Execution** | [UAEP / §42](docs/project/architecture/UNIFIED_EXECUTION_RUNTIME.md) · [Nexus flow](docs/project/architecture/NEXUS_EXECUTION_FLOW.md) · [Orchestration](docs/project/architecture/ORCHESTRATION.md) |
| **Authoring** | [Agent guide](docs/project/technical/guides/AGENT_CREATION_GUIDE.md) · [Extension guide](docs/project/technical/guides/EXTENSION_AUTHOR_GUIDE.md) · [applications/USAGE.md](applications/USAGE.md) |
| **Operations** | [HARNESS_ENVIRONMENT.md](docs/project/technical/guides/HARNESS_ENVIRONMENT.md) · [infra/README.md](infra/README.md) |
| **ADRs** | [docs/project/technical/adr/README.md](docs/project/technical/adr/README.md) |

**Documentation boundary:** platform `docs/` describe the Harness / Agent OS. Each business environment and agent maintains its own `ARCHITECTURE.md` and local plan — see [Strategy §Documentation boundary](docs/project/technical/guides/INTERGRAX_DEVELOPMENT_STRATEGY.md#documentation-boundary).
...
| Dimension | Status |
|-----------|--------|
| **Platform maturity** | **32/32 L3** harness baseline — see [Current platform maturity](#current-platform-maturity) · [Maturity Taxonomy](docs/project/technical/guides/MATURITY_TAXONOMY.md); default [gate maintenance](docs/project/maintainers/plans/PLATFORM_FOUNDATION.md#61-harness-platform-maintenance-default--band-1) active |
| **Active development** | Default queue: [§6.1 gate maintenance](docs/project/maintainers/plans/PLATFORM_FOUNDATION.md#61-harness-platform-maintenance-default--band-1) · depth bands: [MEM-DEPTH](docs/project/maintainers/plans/MEMORY.md), [CRIT-V](docs/project/maintainers/plans/CRITIC_VERIFICATION.md), [OBS-BUS](docs/project/maintainers/plans/OBSERVABILITY.md) |
| **Business agents** | Phase K — **end of plan** until explicit product prioritization ([§6.3](docs/project/maintainers/plans/PLATFORM_FOUNDATION.md#63-end-of-plan--deferred-product-work-only)) |
...
| Capability | Doc |
|------------|-----|
| **Adaptive Harness Intelligence (L4)** | [architecture/ADAPTIVE_HARNESS_INTELLIGENCE.md](docs/project/architecture/ADAPTIVE_HARNESS_INTELLIGENCE.md) |
| **Critic & Verification (PEV)** | [architecture/CRITIC_VERIFICATION.md](docs/project/architecture/CRITIC_VERIFICATION.md) |
| **Reasoning & cognition** | [architecture/REASONING_AND_COGNITION.md](docs/project/architecture/REASONING_AND_COGNITION.md) |
| **Elastic capacity** | [architecture/ELASTIC_CAPACITY_AND_SCALING.md](docs/project/architecture/ELASTIC_CAPACITY_AND_SCALING.md) |
| **Ephemeral Code Craft** | [architecture/CODE_CRAFT.md](docs/project/architecture/CODE_CRAFT.md) · [ADR-CODECRAFT-001](docs/project/technical/adr/entries/2026-06-10/ADR-CODECRAFT-001.md) |

Full phase tracker: [plan/PLATFORM_FOUNDATION.md](docs/project/maintainers/plans/PLATFORM_FOUNDATION.md) · [intergrax_runtime_architecture.md](docs/project/architecture/intergrax_runtime_architecture.md)
...
[infra/README.md](infra/README.md) · [infra/PORTS.md](infra/PORTS.md) · Lab stack: [HARNESS_ENVIRONMENT.md](docs/project/technical/guides/HARNESS_ENVIRONMENT.md)
...
| Resource | Purpose |
|----------|---------|
| [docs/project/maintainers/public-adoption/PUBLIC_LAUNCH_CHECKLIST.md](docs/project/maintainers/public-adoption/PUBLIC_LAUNCH_CHECKLIST.md) | Maintainer checklist for public outreach readiness |
| [docs/project/maintainers/public-adoption/OUTREACH_KIT.md](docs/project/maintainers/public-adoption/OUTREACH_KIT.md) | Maintainer-facing outreach drafts for technical reviewers, integration builders and design partners |
| [AGENTS.md](AGENTS.md) | Cursor auto-load stub — tiers, boundaries, pointers |
| [docs/project/technical/guides/AGENT_INSTRUCTIONS.md](docs/project/technical/guides/AGENT_INSTRUCTIONS.md) | Full instructions for AI coding agents |
