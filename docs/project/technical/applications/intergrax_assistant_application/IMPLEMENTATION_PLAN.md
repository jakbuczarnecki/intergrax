...
Platform maintenance queue: [`§6.1`](../../../architecture/intergrax_runtime_architecture.md).
Business backlog pattern: [`§6.3a`](../../../architecture/intergrax_runtime_architecture.md#63a-business-backlog-register-consolidated) (IAA tracked locally, not in platform §6.3a until promoted).
