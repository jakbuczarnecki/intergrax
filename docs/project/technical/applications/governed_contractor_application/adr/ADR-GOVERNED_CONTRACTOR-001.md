...
| **Related** | [`ARCHITECTURE.md`](../ARCHITECTURE.md) · [`IMPLEMENTATION_PLAN.md`](../IMPLEMENTATION_PLAN.md) · [`ADR-EXTERNAL_CONTRACTOR_ADAPTER-001`](../../../agents/external_contractor_adapter/adr/ADR-EXTERNAL_CONTRACTOR_ADAPTER-001.md) |
