...
> Layout canon: [`applications/USAGE.md`](../../../../../applications/USAGE.md) · Engine API: [`intergrax/applications/USAGE.md`](../../../../../applications/USAGE.md)
...
```bash
uv sync --project applications/governed_contractor_application
uv run python scripts/build/build_application_image.py --application governed_contractor_application --tag governed-contractor-application:local
```
