...
**Tier-2 adapter:** [`docs/project/technical/agents/external_contractor_adapter/ARCHITECTURE.md`](../../agents/external_contractor_adapter/ARCHITECTURE.md)

**Collaboration boundary:** Intergrax is **source-available** for evaluation and technical partner discovery. It is **not** open source. Production, commercial, and redistribution use require explicit permission — see repository [`../../../community/COLLABORATION.md`](../../../community/COLLABORATION.md) and [`LICENSE`](../../../../../LICENSE). This vertical is a **proof path**, not a production-readiness or certification claim.
...
Reusable platform capability — not a quote lifecycle engine ([ADR-GOVERNED-CONTINUATION-001](../../adr/entries/2026-07-20/ADR-GOVERNED-CONTINUATION-001.md)):
...
Meaningful external side effects are authorized by the **platform policy boundary** before provider-bound execution ([ADR-POLICY-SIDE-EFFECT-001](../../adr/entries/2026-07-20/ADR-POLICY-SIDE-EFFECT-001.md)).
...
After a meaningful side effect succeeds under policy ALLOW, Tier-2 composes `GovernedProofProfile` ([ADR-GOVERNED-PROOF-001](../../adr/entries/2026-07-20/ADR-GOVERNED-PROOF-001.md)). The host may surface it later (GEC-7+); it must not treat the profile as a signed receipt or authorization token.
...
| ADR | [`ADR-EXTWORK-002`](../../adr/entries/2026-07-20/ADR-EXTWORK-002.md) |
...
| ADRs | [`ADR-EXTWORK-001`](../../adr/entries/2026-07-20/ADR-EXTWORK-001.md), [`ADR-EXTWORK-002`](../../adr/entries/2026-07-20/ADR-EXTWORK-002.md) |
