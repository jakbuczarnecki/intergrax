...
**Status:** binding process gate from `PLATFORM-CAPABILITY-AUDIT-GATE-1`. Governing rule: [`PRODUCT_FIRST_MVP.md` — Mandatory platform capability audit and architecture decision gate](../../../maintainers/plans/PRODUCT_FIRST_MVP.md#mandatory-platform-capability-audit-and-architecture-decision-gate).
