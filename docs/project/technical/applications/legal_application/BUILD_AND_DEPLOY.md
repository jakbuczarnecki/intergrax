        ...
        > Quick overview: [`README.md`](../../../../../applications/legal_application/README.md) · Layout canon: [`applications/USAGE.md`](../../../../../applications/USAGE.md) · Engine API: [`intergrax/applications/USAGE.md`](../../../../../applications/USAGE.md)
        ...
        Metrics HTTP (optional): ``register_llm_metrics_routes(app)`` → ``GET /metrics/llm``. See [architecture/LLM_ADAPTERS.md](../../../architecture/LLM_ADAPTERS.md).
