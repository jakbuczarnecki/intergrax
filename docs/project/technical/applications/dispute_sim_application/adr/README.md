...
Platform ADRs: [`../../docs/project/technical/adr/README.md`](README.md)
...
| ADR | Title | Status |
|-----|-------|--------|
| [ADR-DISPUTE_SIM-001](ADR-DISPUTE_SIM-001.md) | Four-agent split for Dispute Simulation Workspace | Accepted |
