...
| `docs/project/technical/applications/attestation_demo/IMPLEMENTATION_PLAN.md` | Task checklist |
| `applications/attestation_demo/docs/project/technical/adr/` | Application ADRs (ADR-ATTESTATION_DEMO-001) |
