...
Platform plan: [`docs/project/architecture/intergrax_runtime_architecture.md`](../../../architecture/intergrax_runtime_architecture.md) · Phase AA-ORG
...
| HITL authoring | `docs/project/technical/guides/AGENT_CREATION_GUIDE.md` Appendix H |
