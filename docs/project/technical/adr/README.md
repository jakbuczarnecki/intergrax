# Intergrax Harness â€” Architecture Decision Records
...
| [ADR-ADAPT-002](entries/2026-06-22/ADR-ADAPT-002.md) | ADAS (Agent Design Search) inside AHI â€” not a separate layer | Accepted |
...
| [ADR-LLM-003](entries/2026-06-19/ADR-LLM-003.md) | LLM routing rules â€” Protocol contract and custom rule classes | Accepted |
...
| [ADR-CRITIC-001](entries/2026-06-07/ADR-CRITIC-001.md) | Critic & Verification Layer â€” tier-separated PEV verify stack | Accepted |
| [ADR-MEM-001](entries/2026-06-08/ADR-MEM-001.md) | Context Compiler â€” global budget allocator and degradation ladder | Accepted |
| [ADR-OBS-001](entries/2026-06-08/ADR-OBS-001.md) | Harness Observability Spine â€” unified bus for all tiers | Accepted |
| [ADR-SCALE-001](entries/2026-06-08/ADR-SCALE-001.md) | Harness Elastic Capacity Plane â€” complement K8s HPA | Accepted |
...
| [ADR-AGENT-001](entries/2026-06-11/ADR-AGENT-001.md) | Agent cognitive patterns as Tier-2 library â€” Nexus remains Agent OS | Accepted |
...
| [ADR-OBS-002](entries/2026-06-13/ADR-OBS-002.md) | Unsigned Execution Boundary Export (EBE) â€” partner PoC side channel | Accepted |
| [ADR-OBS-004](entries/2026-06-19/ADR-OBS-004.md) | EBE-9 host-side boundary event signing (Ed25519 statement) | Accepted |
| [ADR-OBS-003](entries/2026-06-17/ADR-OBS-003.md) | Layered runtime event identity â€” spine + event_kind + EventCatalog | Accepted |
| [ADR-MOD-001](entries/2026-06-19/ADR-MOD-001.md) | Speech provider slug identity via Integration Library (no enum) | Accepted |
| [ADR-SEC-001](entries/2026-06-19/ADR-SEC-001.md) | Security & Trust Planes â€” S1/S2/S3 discipline and `intergrax.security_defenses` EP | Accepted |
...
**Consolidation:** platform ownership, lifecycle, and invariants for GEC-0â€¦GEC-6 â€” [`docs/project/technical/platform/governed_external_execution.md`](../platform/governed_external_execution.md).
