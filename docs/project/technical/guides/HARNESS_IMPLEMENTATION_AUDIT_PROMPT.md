...
**Per-domain deep audits:** [`../audit/README.md`](../../maintainers/audit/README.md) — copy-paste prompts for each of the 22 domain pairs (RAG, Tools, Memory, Context Engineering, …)

**New idea intake (before build):** [`../bootstrap/idea_audit.txt`](../../maintainers/bootstrap/idea_audit.txt) — Mode I; [`../audit/IDEA_AUDIT_ORCHESTRATOR.md`](../../maintainers/audit/IDEA_AUDIT_ORCHESTRATOR.md)
...
1. Open [`../audit/<DOMAIN>.md`](../../maintainers/audit/README.md#domain-index-22-pairs) (e.g. [`../audit/RAG.md`](../../maintainers/audit/RAG.md)).
...
For **all 22 domain pairs** in one session, use [`../bootstrap/01_audit_all_domains.txt`](../../maintainers/bootstrap/01_audit_all_domains.txt) (Mode A) or [`../audit/README.md`](../../maintainers/audit/README.md) for other modes.
