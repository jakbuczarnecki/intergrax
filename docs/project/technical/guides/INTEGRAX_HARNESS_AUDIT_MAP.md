...
Each layer below maps to a **domain pair** (`docs/project/architecture/<DOMAIN>.md` ↔ `docs/project/maintainers/plans/<DOMAIN>.md`). Routing index: [`intergrax_runtime_architecture.md`](../../architecture/intergrax_runtime_architecture.md) (Audit map routing table).
