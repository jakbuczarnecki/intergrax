...
See [`plan/ORCHESTRATION.md`](../../maintainers/plans/ORCHESTRATION.md) §6.1av ORCH-MAINT-01/04 and [`plan/TIER3_APPLICATION_ENVIRONMENT.md`](../../maintainers/plans/TIER3_APPLICATION_ENVIRONMENT.md) T3-MAINT-02.
...
| Domain audit | [`../../../audit_results/TIER3_APPLICATION_ENVIRONMENT.md`](../../../audit_results/TIER3_APPLICATION_ENVIRONMENT.md) |

---

## 8. Domain runtime signals and Tier-3 hooks (OBS-EVOL-9)

**Canon:** [`architecture/OBSERVABILITY.md`](../../architecture/OBSERVABILITY.md) §4.4 · [`ADR-OBS-003`](../adr/entries/2026-06-17/ADR-OBS-003.md) · plan [`OBS-EVOL-9`](../../maintainers/plans/OBSERVABILITY.md#phase-obs-evol-9--layered-event-catalog-p1-arch-02)
