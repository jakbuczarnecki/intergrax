...
**Parent audit prompt:** [`docs/project/maintainers/audit/CODE_CRAFT.md`](../../../maintainers/audit/CODE_CRAFT.md) §0
...
| Source | Read only |
|--------|-----------|
| `docs/project/technical/guides/IDEAL_HARNESS_AI_ARCHITECTURE.md` | Sections matching audit-map layers 11b |
| `docs/project/technical/guides/INTEGRAX_HARNESS_AUDIT_MAP.md` | Layers 11b · maturity §5 |
...
| `docs/project/maintainers/plans/CODE_CRAFT.md` | **Read-scope:** Hub §6 · [`plan/satellites/`](../plan/satellites) satellites on demand |
| `docs/project/architecture/CODE_CRAFT.md` | Read-scope block + TOC sections for layers 11b |

## Code entry (grep first — F5-B)

- `docs/project/architecture/CODE_CRAFT.md` — read-scope block only
- `docs/project/maintainers/plans/CODE_CRAFT.md` — read-scope block only
