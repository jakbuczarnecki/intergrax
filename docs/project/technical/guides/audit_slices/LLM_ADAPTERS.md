...
**Parent audit prompt:** [`docs/project/maintainers/audit/LLM_ADAPTERS.md`](../../../maintainers/audit/LLM_ADAPTERS.md) §0
...
| Source | Read only |
|--------|-----------|
| `docs/project/technical/guides/IDEAL_HARNESS_AI_ARCHITECTURE.md` | Sections matching audit-map layers 6 |
| `docs/project/technical/guides/INTEGRAX_HARNESS_AUDIT_MAP.md` | Layers 6 · maturity §5 |
...
| `docs/project/maintainers/plans/LLM_ADAPTERS.md` | **Read-scope:** Hub §6 · [`plan/satellites/`](../plan/satellites) satellites on demand |
| `docs/project/architecture/LLM_ADAPTERS.md` | Read-scope block + TOC sections for layers 6 |

## Code entry (grep first — F5-B)

- `docs/project/architecture/LLM_ADAPTERS.md` — read-scope block only
- `docs/project/maintainers/plans/LLM_ADAPTERS.md` — read-scope block only
