...
**Parent audit prompt:** [`docs/project/maintainers/audit/MODALITY.md`](../../../maintainers/audit/MODALITY.md) §0
...
| Source | Read only |
|--------|-----------|
| `docs/project/technical/guides/IDEAL_HARNESS_AI_ARCHITECTURE.md` | Sections matching audit-map layers 29 |
| `docs/project/technical/guides/INTEGRAX_HARNESS_AUDIT_MAP.md` | Layers 29 · maturity §5 |
...
| `docs/project/maintainers/plans/MODALITY.md` | **Read-scope:** Hub §6 · [`plan/satellites/`](../plan/satellites) satellites on demand |
| `docs/project/architecture/MODALITY.md` | Read-scope block + TOC sections for layers 29 |

## Code entry (grep first — F5-B)

- `docs/project/architecture/MODALITY.md` — read-scope block only
- `docs/project/maintainers/plans/MODALITY.md` — read-scope block only
