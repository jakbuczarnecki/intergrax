...
**Parent audit prompt:** [`docs/project/maintainers/audit/CONTEXT_ENGINEERING.md`](../../../maintainers/audit/CONTEXT_ENGINEERING.md) §0
...
| Source | Read only |
|--------|-----------|
| `docs/project/technical/guides/IDEAL_HARNESS_AI_ARCHITECTURE.md` | Sections matching audit-map layers 16 |
| `docs/project/technical/guides/INTEGRAX_HARNESS_AUDIT_MAP.md` | Layers 16 · maturity §5 |
...
| `docs/project/maintainers/plans/CONTEXT_ENGINEERING.md` | **Read-scope:** Hub §6 · [`plan/satellites/`](../plan/satellites) satellites on demand |
| `docs/project/architecture/CONTEXT_ENGINEERING.md` | Read-scope block + TOC sections for layers 16 |

## Code entry (grep first — F5-B)

- `docs/project/architecture/CONTEXT_ENGINEERING.md` — read-scope block only
- `docs/project/maintainers/plans/CONTEXT_ENGINEERING.md` — read-scope block only
