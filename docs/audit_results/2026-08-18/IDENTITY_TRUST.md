...
### Evidence-conformance correction — 2026-08-18

- Initial publication omitted Protocol v2.2 line ranges in `Location`.
- Initial publication also omitted the mandatory `Provider / backend abstraction` report section.
- This correction adds only those required evidence/reporting elements.
- `audited_sha`, observations, finding IDs, severity, category, confidence, verdict, operator decisions, remediation blocks, architecture targets and plan state are unchanged.
...
- **Location:**
  - `intergrax/contracts/agent_run.py:L24-L39` — `RequestIdentity` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/agents/runtime_request_bridge.py:L24-L64` — `runtime_request_to_agent_run` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/applications/_shared/harness_auth.py:L94-L108` — `is_harness_identity_token_valid` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `applications/research_application/serving/fastapi_router.py:L25-L37` — `ResearchRunService.run_pipeline` @ `6fbc5e4928963ecd386456158b0753662fed209b`
- **Reproduction:**
...
- **Location:**
  - `intergrax/contracts/delegation.py:L23-L30` — `DelegationSpec.permission_scopes` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/contracts/subtask_contract.py:L12-L19` — `SubtaskContract.permission_scopes` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/interactions/actor_resolution.py:L40-L51` — `narrow_delegation_scopes` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/nexus/execution/graph_executor.py:L113-L132` — `GraphExecutor` `max_delegation_depth` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/nexus/execution/graph_executor.py:L947-L973` — `_emit_delegation_granted` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/nexus/execution/graph_executor.py:L1037-L1043` — `max_delegation_depth` validation @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/collaborative_work/authority.py:L61-L98` — `CollaborativeWorkAuthorityResolver` @ `6fbc5e4928963ecd386456158b0753662fed209b`
- **Reproduction:**
...
- **Location:**
  - `intergrax/runtime/human/pause.py:L199-L212` — `HumanPauseCoordinator.resolve_human_response` exact-correlation guards @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/task/task_contract.py:L96-L108` — `HumanApprovalResolution` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/human/models.py:L30-L43` — `HumanDecisionRecord` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/human/models.py:L53-L72` — `build_human_decision_record` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/nexus/orchestration/human_response.py:L39-L49` — `persist_human_decision` (`user_id=task.user_id`) @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/nexus/orchestration/intake_runner.py:L113-L125` — `HUMAN_APPROVAL_RECEIVED` emission @ `6fbc5e4928963ecd386456158b0753662fed209b`
- **Reproduction:**
...
- **Location:**
  - `intergrax/runtime/nexus/orchestration/intake_runner.py:L69-L71` — pause/request correlation inputs @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/nexus/orchestration/intake_runner.py:L101-L111` — APPROVE resume requires bound identity @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/applications/_shared/harness_task_routes.py:L115-L137` — shared resume route @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/applications/_shared/task_control.py:L73-L90` — `resume_task_with_token` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/debug/hitl_service.py:L70-L75` — `DebugHitlResumeService.resume_with_human_response` pause/request materialization @ `6fbc5e4928963ecd386456158b0753662fed209b`
- **Reproduction:**
...
- **Location:**
  - `intergrax/contracts/execution_identity.py:L101-L123` — `ActiveExecutionIdentity` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/nexus/nexus_loop.py:L195-L199` — `ActiveExecutionIdentity` binding @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/nexus/orchestration/intake_runner.py:L101-L110` — APPROVE path uses bound identity @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/human/hitl_hooks.py:L52-L54` — `human_approval_hook_context` (`run_id=task.task_id`) @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/hooks/nexus_lifecycle_hooks.py:L35-L37` — `nexus_lifecycle_hook_context` (`run_id=task.task_id`) @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/nexus/orchestration/hitl_runner.py:L119-L121` — REJECT `runtime_event_from_task_state(..., run_id=task.task_id)` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/nexus/orchestration/hitl_runner.py:L165-L167` — ESCALATE `runtime_event_from_task_state(..., run_id=task.task_id)` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/nexus/orchestration/human_response.py:L49-L49` — `persist_human_decision` `run_id=task.task_id` @ `6fbc5e4928963ecd386456158b0753662fed209b`
- **Reproduction:**
...
- **Location:**
  - `intergrax/contracts/actor_identity.py:L18-L32` — `ActorIdentity`, `allows_scope` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/contracts/task_envelope.py:L53-L57` — `TaskEnvelope.with_actor` @ `6fbc5e4928963ecd386456158b0753662fed209b`
  - `intergrax/runtime/interactions/actor_resolution.py:L13-L33` — `resolve_actor_from_task` @ `6fbc5e4928963ecd386456158b0753662fed209b`
- **Reproduction:**
...
|---------|-----------------------|-------------------------------|----------------------|----------------|--------------------|
| Identity provider | `IdentityProviderBackend` | IntegrationProfile / Tier-3 identity wiring | harness + integration profile wiring | `ABSTRACTION_PRESERVED` | `intergrax/integrations/contracts/identity_provider.py:L32-L39`; `intergrax/applications/_shared/harness_auth.py:L87-L91` @ `6fbc5e4928963ecd386456158b0753662fed209b`; no new vendor/backend leakage finding in IDENTITY_TRUST |
| FastAPI Core authentication | `AuthProvider` → `AuthContext` | middleware-resolved context | FastAPI Core auth middleware | `ABSTRACTION_PRESERVED` | `intergrax/fastapi_core/auth/provider.py:L13-L25`; `intergrax/fastapi_core/auth/context.py:L12-L22` @ `6fbc5e4928963ecd386456158b0753662fed209b`; positive control; finding 01 is principal-binding/adoption, not concrete-vendor leakage |
| Application identity provider resolution | controlled Tier-3/provider resolution | composition-owned Tier-3 harness auth state | Tier-3 identity wiring | `COMPOSITION_ONLY` | `intergrax/applications/_shared/harness_auth.py:L87-L91` @ `6fbc5e4928963ecd386456158b0753662fed209b`; concrete identity provider selection remains outside generic runtime logic |
| ActorIdentity / RequestIdentity | — | — | — | `NOT_APPLICABLE` | finding 06 is platform identity-contract coherence, not vendor coupling |

AUDIT-4 discovered no new independent provider/backend abstraction finding. IdentityProviderBackend and FastAPI Core AuthProvider remain valid provider-neutral boundaries on the inspected paths.
