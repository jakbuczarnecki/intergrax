...
> **Original path:** docs\project\maintainers\plans\satellites\AGENT_CONTRACTS_AND_ASSEMBLY_audit_history.md
...
| ACP-ADR.1 | ACP0 | **ADR-AGENT-001** accepted | **Done** | `docs/project/technical/adr/entries/2026-06-11/ADR-AGENT-001.md` | Linked from architecture §21 |
| ACP-ADR.2 | ACP0 | **ADR-AGENT-002** accepted — `run()` facade | **Done** | `docs/project/technical/adr/entries/2026-06-11/ADR-AGENT-002.md` | Linked from architecture §29 |
...
| ACP-ADR.3 | ACP0 | **ADR-AGENT-003** accepted — `on_next_step` + dual observability | **Done** | `docs/project/technical/adr/entries/2026-06-11/ADR-AGENT-003.md` | Linked from architecture §31–§32 |
...
| ACP-MIG-1 | ACP-MIG | **Fleet inventory auditor** — legacy surface per agent (`uaep`/`runtime_engine`/`dict state`) | **Done** | `scripts/maintenance/audit_agent_fleet_legacy.py` | JSON report for all `agents/*` packages |
