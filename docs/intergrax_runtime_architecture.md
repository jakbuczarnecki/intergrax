...
| LLM adapters (typed envelope + ModelCatalog + routing L5) | [`architecture/LLM_ADAPTERS.md`](architecture/LLM_ADAPTERS.md) · [`intergrax/llm_adapters/USAGE.md`](../intergrax/llm_adapters/USAGE.md) | M-LLM-R **Done** · routing X-9…X-13 **Done** · **M-LLM-X.8 + X-14** Planned (enterprise domain) |
