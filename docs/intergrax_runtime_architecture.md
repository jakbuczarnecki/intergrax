...
| **SLACK-KNOWLEDGE-FOUNDATION-1** | Platform Slack knowledge read surface (bot + optional knowledge user token on same WebClient), Vendor Knowledge adapter, durable sync proof | **DONE** |
