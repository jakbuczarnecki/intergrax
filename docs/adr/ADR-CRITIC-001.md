...
| **Related** | [`CRITIC_VERIFICATION_LAYER_ARCHITECTURE.md`](../CRITIC_VERIFICATION_LAYER_ARCHITECTURE.md) · canon §55 · Phase CRIT-V |
...
**LLM-as-judge is opt-in** via `CriticProfile` — not mandatory on every run (consistent with [`NEXUS_EXECUTION_FLOW_REFERENCE.md`](../NEXUS_EXECUTION_FLOW_REFERENCE.md) §18).
...
- Architecture: [`CRITIC_VERIFICATION_LAYER_ARCHITECTURE.md`](../CRITIC_VERIFICATION_LAYER_ARCHITECTURE.md)
