...
This document is an **alpha/product-validation narrative**. It is not a finished SaaS offering, a production guarantee, or a license grant. See [LICENSE](../../LICENSE) and [COLLABORATION.md](../../COLLABORATION.md).
...
Share structured feedback via the collaboration tracks in [COLLABORATION.md](../../COLLABORATION.md) and [ROADMAP.md](../../ROADMAP.md), or through curated public issues when available.
...
| Document | Purpose |
|----------|---------|
| [Local Knowledge Workspace architecture](../../applications/local_workspace_application/ARCHITECTURE.md) | Technical architecture baseline for the Tier-3 application |
...
| [Intergrax Harness Narrative](../guides/INTERGRAX_HARNESS_NARRATIVE.md) | External harness narrative |
| [Agent Creation Guide](../guides/AGENT_CREATION_GUIDE.md) | Authoring agents and applications on Intergrax |
