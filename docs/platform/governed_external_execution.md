...
**Status:** Architecture closure (GEC-0…GEC-6.1) — 2026-07-20  
...
- [`docs/architecture/RELIABILITY_FAILURE_AND_HITL.md`](../architecture/RELIABILITY_FAILURE_AND_HITL.md) — GEC-4…GEC-6 composition sections
...
4. Supply MeaningfulSideEffectEvaluator + principal + real run_id
```
