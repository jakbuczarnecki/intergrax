# Drop-In Knowledge Mode – Runtime Design

## 1. Purpose

Drop-In Knowledge Mode is a **high-level runtime layer** for Intergrax.
...
1. **High-level, low-friction API**  
   - One main entrypoint (e.g. `DropInKnowledgeRuntime.ask()`).
...
- Drop-In Knowledge Mode can operate in two modes:
