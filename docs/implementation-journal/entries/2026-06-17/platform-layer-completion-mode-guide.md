...
| Link | Target |
|------|--------|
| Guide | `docs/guides/LAYER_COMPLETION_MODE.md` |
| Plan | `docs/plan/PLATFORM_FOUNDATION.md` P2-DOC-LC-1 |
| Operator paste | `_external_apps/cursorai iteracyjna instrukcja v2.txt` (gitignored) |

## Changed artifacts

- `docs/guides/LAYER_COMPLETION_MODE.md` — new
