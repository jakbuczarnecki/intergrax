...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/CONTEXT_ENGINEERING.md` §2–§3, §16 |
| Plan | `docs/plan/CONTEXT_ENGINEERING.md` — iteration III audit register |
| Cross-domain | `docs/plan/LLM_ADAPTERS.md` M-LLM-X.3 · `ADR-LLM-002` |
...
- `docs/plan/CONTEXT_ENGINEERING.md` — AUD-CE-12 closed; CE-LLM-X Done; iteration III register
- `docs/architecture/CONTEXT_ENGINEERING.md` — last pass date; budget row CE-LLM-X note
