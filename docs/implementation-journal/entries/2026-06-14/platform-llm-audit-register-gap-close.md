...
Synced traceability in `docs/plan/LLM_ADAPTERS.md` and register IDs in `docs/audit/LLM_ADAPTERS.md`.
...
| Audit instruction | `docs/audit/LLM_ADAPTERS.md` — known gaps table |
