...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md` §12 · §29 · §32.0 · §37.1–2 |
| Plan | `docs/plan/AGENT_CONTRACTS_AND_ASSEMBLY.md` Wave 0 |
...
- `scripts/check_agent_typed_state.py` — CI guard
...
uv run python scripts/check_agent_typed_state.py
```
