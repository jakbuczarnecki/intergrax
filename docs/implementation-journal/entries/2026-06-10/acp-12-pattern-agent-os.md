...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md` §21–§26 · §35 |
| Plan | `docs/plan/AGENT_CONTRACTS_AND_ASSEMBLY.md` ACP-12 |

## Changed artifacts

- `tests/acceptance/agent_os/test_acp_pattern_agents.py` — five pattern acceptance tests
- `docs/plan/AGENT_CONTRACTS_AND_ASSEMBLY.md` — ACP-12 Done; removed stale duplicate ACP-13 Planned row
