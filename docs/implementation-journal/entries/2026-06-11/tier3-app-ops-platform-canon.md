...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/TIER3_APPLICATION_ENVIRONMENT.md` §49.2.4, §50 |
| Plan | `docs/plan/TIER3_APPLICATION_ENVIRONMENT.md` Phase H-APP-OPS |
...
- `docs/architecture/TIER3_APPLICATION_ENVIRONMENT.md` — §49.2.4, §50, TOC, §46 maturity
- `docs/plan/TIER3_APPLICATION_ENVIRONMENT.md` — H-APP-OPS phase + freeze note
