...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/TIER3_APPLICATION_ENVIRONMENT.md` §24–§45 |
...
| Agent cross-ref | `docs/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md` §39.8 |

## Changed artifacts

- `docs/architecture/TIER3_APPLICATION_ENVIRONMENT.md` — APP-CON canon
- `docs/plan/TIER3_APPLICATION_ENVIRONMENT.md` — H-APP-CON phase
- `docs/intergrax_runtime_architecture.md` — hub Application section
- `docs/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md` — §39.8 canonical home pointer
