...
| Link | Target |
|------|--------|
| Prior delivery | `docs/implementation-journal/entries/2026-06-19/observability-ebe-9-host-signing.md` |
| EBE-8 validation | `docs/implementation-journal/entries/2026-06-19/observability-ebe-8-partner-validated.md` |
...
- `docs/plan/OBSERVABILITY.md` — EBE-9 partner-validated acceptance
- `docs/architecture/OBSERVABILITY.md` — §18 EBE-9 validation pins + non-goals cleanup
