...
status: completed
commit: pending
adr: docs/adr/entries/2026-06-12/ADR-TOOL-003.md
---
...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/TOOLS.md` §Invocation patterns · engine gap register |
| Plan | `docs/plan/TOOLS.md` Phase TOOL-ENG · §Layer completion sprints |
| ADR | `docs/adr/entries/2026-06-12/ADR-TOOL-003.md` |
...
- `docs/plan/TOOLS.md`, `docs/architecture/TOOLS.md` — status sync
