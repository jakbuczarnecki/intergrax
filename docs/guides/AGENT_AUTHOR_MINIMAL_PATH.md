...
It does not replace [`docs/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md`](../architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md).  
It is the practical authoring shortcut derived from that architecture and from [`docs/guides/SYSTEM_INVARIANTS.md`](SYSTEM_INVARIANTS.md).
