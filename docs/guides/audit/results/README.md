...
Dated outputs from **orchestrated** harness audits ([`ORCHESTRATOR.md`](../ORCHESTRATOR.md)).
...
Copy [`TEMPLATE_DOMAIN_RESULT.md`](../TEMPLATE_DOMAIN_RESULT.md) when writing `<DOMAIN>.md`.
