...
GAP-RAG-19 agentic retriever override · GAP-RAG-21 no RAG load/soak gate · GAP-RAG-22 semantic chunking size guard · `pinecone`/`milvus`/`vespa` beta until ops soak
