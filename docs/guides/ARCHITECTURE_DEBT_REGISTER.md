...
| DEBT-ECP-02 | §30 Ops | Production elasticity — live signal bridge, K8s/Celery adapters, E2E loop | platform | ECP-PROD | AUDIT-IDEAL-30.4 | **Partial** (HITL queue + live cluster remain) |
