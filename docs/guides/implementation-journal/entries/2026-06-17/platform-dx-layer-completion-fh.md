...
- `docs/plan/EXPERIMENTATION_AND_DEVELOPER_EXPERIENCE.md` — Phase DX-LC register
- `docs/architecture/EXPERIMENTATION_AND_DEVELOPER_EXPERIENCE.md` — Full Harness LC note
- `docs/guides/audit/EXPERIMENTATION_AND_DEVELOPER_EXPERIENCE.md` — sync
