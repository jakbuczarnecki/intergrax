...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/PLATFORM_FOUNDATION.md` |
| Plan | `docs/plan/PLATFORM_FOUNDATION.md` P1-ARCH-02 |
| OBS delivery | `docs/plan/OBSERVABILITY.md` OBS-EVOL-9 |
| ADR | `docs/adr/entries/2026-06-17/ADR-OBS-003.md` |
| Process | `docs/guides/LAYER_COMPLETION_MODE.md` |
| Progress | `docs/_external/layer_completion_progress.json` |

## Changed artifacts

- `docs/plan/PLATFORM_FOUNDATION.md` — P1-ARCH-02 → Done (×2)
- `docs/intergrax_runtime_architecture.md` — OBS-EVOL-9 hub status
- `docs/guides/audit/OBSERVABILITY.md` — audit instruction sync
