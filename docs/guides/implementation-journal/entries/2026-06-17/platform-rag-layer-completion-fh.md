...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/RAG.md` — Architecturally Mature |
| Plan | `docs/plan/RAG.md` Phase RAG-LC |
| Prior LC | `entries/2026-06-17/platform-rag-layer-completion-iii.md` |

## Changed artifacts

- `docs/plan/RAG.md` — Phase RAG-LC register
- `docs/architecture/RAG.md` — Full Harness LC maturity note
- `docs/guides/audit/RAG.md` — GAP-RAG gaps closed
