...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/UNIFIED_EXECUTION_RUNTIME.md` |
| Plan | `docs/plan/UNIFIED_EXECUTION_RUNTIME.md` AUDIT-IDEAL-5.1 |
...
- `docs/plan/UNIFIED_EXECUTION_RUNTIME.md` — AUDIT-IDEAL-5.1 → Done
