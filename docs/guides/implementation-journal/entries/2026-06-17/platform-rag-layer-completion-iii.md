...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/RAG.md` — M-RAG-ITERATION-III |
| Plan | `docs/plan/RAG.md` — Phase M-RAG-ITERATION-III |
...
- Docs: `docs/architecture/RAG.md`, `docs/plan/RAG.md`, `docs/guides/audit/RAG.md`
