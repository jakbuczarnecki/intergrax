...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/CRITIC_VERIFICATION.md` §7.3 |
| Plan | `docs/plan/CRITIC_VERIFICATION.md` — CVL-LC-3/4, backlog |
...
- `docs/architecture/CRITIC_VERIFICATION.md`, `docs/plan/CRITIC_VERIFICATION.md`
