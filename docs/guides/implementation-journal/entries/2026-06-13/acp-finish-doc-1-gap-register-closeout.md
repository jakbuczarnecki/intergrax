...
Updated `docs/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md` §25.4–§25.5, §28.3, §36.4, §40.13 to **Closed/Done** for token budget depth. Marked **ACP-FINISH-DOC-1 Done** in plan register §6.1bc. Regenerated domain audit prompt via `generate_domain_audit_prompts.py`.
...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md` §25.4 · §25.5 · §28.3 · §36.4 · §40.13 |
| Plan | `docs/plan/AGENT_CONTRACTS_AND_ASSEMBLY.md` ACP-FINISH · §6.1bc |
| Cross-plan | `docs/architecture/TIER3_APPLICATION_ENVIRONMENT.md` §43 |
| Audit prompt | `docs/guides/audit/AGENT_CONTRACTS_AND_ASSEMBLY.md` |
