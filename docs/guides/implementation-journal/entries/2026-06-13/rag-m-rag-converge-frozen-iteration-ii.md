...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/RAG.md` — §Production readiness, §Maturity, GAP-RAG-39/40 |
| Plan | `docs/plan/RAG.md` — Phase M-RAG-CONVERGE |
| Tool surface | `intergrax/tools/providers/rag/service.py` |

## Changed artifacts

- `docs/architecture/RAG.md` — M-RAG.59 doc convergence
- `docs/plan/RAG.md` — M-RAG-CONVERGE phase register
