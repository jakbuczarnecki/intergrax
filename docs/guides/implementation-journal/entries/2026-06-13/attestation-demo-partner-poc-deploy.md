...
status: completed
commit: pending
adr: docs/adr/entries/2026-06-13/ADR-OBS-002.md · applications/attestation_demo/adr/ADR-ATTESTATION_DEMO-001.md
---
...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/OBSERVABILITY.md` §18 · `applications/attestation_demo/ARCHITECTURE.md` |
| Plan | `docs/plan/OBSERVABILITY.md` Phase EBE |
| ADR | `docs/adr/entries/2026-06-13/ADR-OBS-002.md` · `applications/attestation_demo/adr/ADR-ATTESTATION_DEMO-001.md` |
...
- `docs/architecture/OBSERVABILITY.md` — §18 EBE
- `docs/plan/OBSERVABILITY.md` — Phase EBE register
- `docs/adr/entries/2026-06-13/ADR-OBS-002.md` — harness ADR
