...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/AGENT_CONTRACTS_AND_ASSEMBLY.md` §25.5.3 · §30.8 |
| Plan | `docs/plan/AGENT_CONTRACTS_AND_ASSEMBLY.md` ACP-TOK-3 |
| Cross-plan | `docs/plan/TIER3_APPLICATION_ENVIRONMENT.md` §43 host notify row |
