...
Extended `docs/architecture/LLM_ADAPTERS.md` with AUDIT-IDEAL §6 cross-ref table, LLM-AUDIT-14/15 register rows, 16-dimension M-LLM-R conformance matrix, structured output (6.1 Done) subsection, CI vendor-import guard, anti-patterns table, and clarified preflight vs history-layer token gaps.

Synced traceability in `docs/plan/LLM_ADAPTERS.md` and register IDs in `docs/guides/audit/LLM_ADAPTERS.md`.
...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/LLM_ADAPTERS.md` — §Audit register, §Anti-patterns, §M-LLM-R conformance |
| Plan | `docs/plan/LLM_ADAPTERS.md` — M-LLM-X traceability |
| Audit instruction | `docs/guides/audit/LLM_ADAPTERS.md` — known gaps table |

## Changed artifacts

- `docs/architecture/LLM_ADAPTERS.md`
- `docs/plan/LLM_ADAPTERS.md`
- `docs/guides/audit/LLM_ADAPTERS.md`
