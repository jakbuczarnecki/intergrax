...
| Link | Target |
|------|--------|
| Architecture | `docs/architecture/ELASTIC_CAPACITY_AND_SCALING.md` §1.1, §22 |
| Plan | `docs/plan/ELASTIC_CAPACITY_AND_SCALING.md` Phase ECP-PROD |
| ADR | `docs/adr/entries/2026-06-08/ADR-SCALE-001.md` |
