...
- `docs/architecture/MEMORY.md` — vector catalog, wiring contract, episodic recall target
- `docs/plan/MEMORY.md` — Phase MEM-VEC register (MEM-VEC-0.1–3.2)
- `docs/architecture/CONTEXT_ENGINEERING.md` — semantic session recall use case + fragment source
- `docs/guides/EXTENSION_AUTHOR_GUIDE.md` — `SessionTurnIndexStore` plugin row
