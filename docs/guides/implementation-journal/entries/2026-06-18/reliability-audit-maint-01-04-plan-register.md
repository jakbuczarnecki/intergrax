...
Layer 17 revalidation confirmed L3 maturity (REL + REL-ADV Done, reliability/resilience CI scripts green, HITL acceptance tests passed). Registered four IDEAL-L3 W2 depth and cross-domain wiring rows in `docs/plan/RELIABILITY_FAILURE_AND_HITL.md` §6.1av.
...
| Link | Target |
|------|--------|
| Plan | `docs/plan/RELIABILITY_FAILURE_AND_HITL.md` §6.1av |
| Audit result | `docs/guides/audit/results/2026-06-18/RELIABILITY_FAILURE_AND_HITL.md` |
