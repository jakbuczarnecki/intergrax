...
Layer 15 revalidation confirmed L3 architecture (W-ML Done, modality CI scripts green) with **two failing unit tests** in `tests/unit/model_inference/`. Registered MOD-MAINT-01/02 as **P2 test/code fixes** (not environment waivers) plus docs/depth rows in `docs/plan/MODALITY.md` §6.1av.
...
| Link | Target |
|------|--------|
| Plan | `docs/plan/MODALITY.md` §6.1av |
| Audit result | `docs/guides/audit/results/2026-06-18/MODALITY.md` |
