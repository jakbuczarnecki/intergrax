...
Layer 6 revalidation confirmed L3+ maturity (GAP-ACP 37/37 Closed, fleet 17/17). Identified AS-3 violation on `boundary_demo` author-time `allowed_tools` while ACP close CI passes. Registered three P2/P3 maintenance rows in `docs/plan/AGENT_CONTRACTS_AND_ASSEMBLY.md` §6.1av and updated audit result artifact.
...
| Link | Target |
|------|--------|
| Plan | `docs/plan/AGENT_CONTRACTS_AND_ASSEMBLY.md` §6.1av |
| Audit result | `docs/guides/audit/results/2026-06-18/AGENT_CONTRACTS_AND_ASSEMBLY.md` |
