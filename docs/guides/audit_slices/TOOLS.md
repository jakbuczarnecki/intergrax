...
| `docs/plan/TOOLS.md` | **Hub:** Hub §6 open rows · [`plan/plan/`](../plan/plan/) satellites on demand |
| `docs/architecture/TOOLS.md` | TOC sections for layers 11 · see Cursor read scope block |
