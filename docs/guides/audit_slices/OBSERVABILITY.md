...
| `docs/plan/OBSERVABILITY.md` | **Hub:** Hub §6 open rows · [`plan/plan/`](../plan/plan/) satellites on demand |
| `docs/architecture/OBSERVABILITY.md` | TOC sections for layers 21, 30 · see Cursor read scope block |
