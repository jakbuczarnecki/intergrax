...
| `docs/plan/MODALITY.md` | **Hub:** Hub §6 open rows · [`plan/plan/`](../plan/plan/) satellites on demand |
| `docs/architecture/MODALITY.md` | TOC sections for layers 29 · see Cursor read scope block |
