...
| `docs/plan/EXPERIMENTATION_AND_DEVELOPER_EXPERIENCE.md` | **Read-scope:** Hub §6 · [`plan/satellites/`](../plan/satellites/) satellites on demand |
...
- `docs/plan/EXPERIMENTATION_AND_DEVELOPER_EXPERIENCE.md` — read-scope block only
