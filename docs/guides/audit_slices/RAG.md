...
| `docs/plan/RAG.md` | **Read-scope:** Hub §6 · [`plan/satellites/`](../plan/satellites/) satellites on demand |
| `docs/architecture/RAG.md` | Read-scope block + TOC sections for layers 14 |
