...
**Parent audit prompt:** [`docs/audit/RAG.md`](../../audit/RAG.md) §0
...
| Source | Read only |
|--------|-----------|
| `docs/guides/IDEAL_HARNESS_AI_ARCHITECTURE.md` | Sections matching audit-map layers 14 |
| `docs/guides/INTEGRAX_HARNESS_AUDIT_MAP.md` | Layers 14 · maturity §5 |
| `docs/guides/SYSTEM_INVARIANTS.md` | Grep SYS-INV-* IDs from audit dimensions only (grep IDs — do not read full file) |
| `docs/plan/RAG.md` | **Hub:** Hub §6 open rows · [`plan/plan/`](../plan/plan/) satellites on demand |
| `docs/architecture/RAG.md` | TOC sections for layers 14 · see Cursor read scope block |
