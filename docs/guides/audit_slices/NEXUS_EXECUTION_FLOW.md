...
| `docs/architecture/NEXUS_EXECUTION_FLOW.md` | §1–§8 hub · [`satellites/NEXUS_EXECUTION_FLOW_extended_depth.md`](../architecture/satellites/NEXUS_EXECUTION_FLOW_extended_depth.md) on demand |
