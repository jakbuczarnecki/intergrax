...
| `docs/plan/SKILLS.md` | **Hub:** Hub §6 open rows · [`plan/plan/`](../plan/plan/) satellites on demand |
| `docs/architecture/SKILLS.md` | TOC sections for layers 12 · see Cursor read scope block |
