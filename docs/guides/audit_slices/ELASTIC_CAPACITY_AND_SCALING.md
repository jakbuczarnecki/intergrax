...
| `docs/plan/ELASTIC_CAPACITY_AND_SCALING.md` | **Hub:** Hub §6 open rows · [`plan/plan/`](../plan/plan/) satellites on demand |
| `docs/architecture/ELASTIC_CAPACITY_AND_SCALING.md` | TOC sections for layers 30 · see Cursor read scope block |
