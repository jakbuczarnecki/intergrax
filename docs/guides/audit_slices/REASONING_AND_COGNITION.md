...
**Parent audit prompt:** [`docs/audit/REASONING_AND_COGNITION.md`](../../audit/REASONING_AND_COGNITION.md) §0
...
| `docs/plan/REASONING_AND_COGNITION.md` | **Hub:** Hub §6 open rows · [`plan/plan/`](../plan/plan/) satellites on demand |
| `docs/architecture/REASONING_AND_COGNITION.md` | TOC sections for layers 7 · see Cursor read scope block |
