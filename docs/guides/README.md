...
| [audit/](../audit/) | **Architecture audit orchestration** — 22 per-domain prompts (Modes A/B/C/I) |
| [bootstrap/](../bootstrap/) | **Cursor session paste files** — copy into new agent chat |
