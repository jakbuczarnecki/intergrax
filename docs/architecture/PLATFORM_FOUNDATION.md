...
**First-party catalog (2026-06-08):** **49** skills · **22** bundles — full table in [`architecture/SKILLS.md`](architecture/SKILLS.md#first-party-catalog-49-skills--22-bundles). Product-facing examples:
