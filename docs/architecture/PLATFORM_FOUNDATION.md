...
**First-party catalog (2026-06-08):** **13** skills · **4** bundles — full table in [`architecture/SKILLS.md`](architecture/SKILLS.md#first-party-catalog-13-skills--4-bundles). Product-facing examples:
