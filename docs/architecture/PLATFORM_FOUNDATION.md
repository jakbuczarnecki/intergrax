...
**First-party catalog (2026-06-08):** **31** skills · **13** bundles — full table in [`architecture/SKILLS.md`](architecture/SKILLS.md#first-party-catalog-31-skills--13-bundles). Product-facing examples:
