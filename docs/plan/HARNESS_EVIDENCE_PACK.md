...
- **EVID-COST (C1–C2 done):** § Mode I — EVID-COST · **EVID-COST-01 Done** · **EVID-COST-02…05** rows · § Evidence ROI roadmap · § Future waves.
...
Estimated remaining tasks for minimal ROI: **4**.

**Progress note:** EVID-COST C1–C2 are Done. Remaining estimated tasks after C2: minimal ROI **4**, strong ROI **6**, polished/adopter-ready ROI **8**.
...
Estimated remaining tasks for strong ROI: **6 total**.
...
Estimated remaining tasks for polished adopter-ready ROI: **8 total**.
...
Recommended next wave: **EVID-COST** — **Mode I approved** (C1–C2 Done; EVID-COST-01 Done; implementation C3–C5 Planned).
