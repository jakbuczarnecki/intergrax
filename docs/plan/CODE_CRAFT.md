...
|-------|-----|------|----------|--------|-------------|------------|
| 1 | **ECC-MAINT-01** | Code | P2 | **Planned** | GAP-ECC-23 — wire `Task.metadata.codecraft_mode` per-task override in orchestrator | Unit test: task metadata overrides profile default |
