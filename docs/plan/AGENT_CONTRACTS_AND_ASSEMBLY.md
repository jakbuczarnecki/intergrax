...
| 3 | **ACP-MAINT-03** | Docs | P3 | **Done** | Sync audit prompt known gaps — AUDIT-IDEAL-19.1/20.1/31.1 **Done** vs stale Planned wording | `docs/guides/audit/AGENT_CONTRACTS_AND_ASSEMBLY.md` matches plan LC closeout |
