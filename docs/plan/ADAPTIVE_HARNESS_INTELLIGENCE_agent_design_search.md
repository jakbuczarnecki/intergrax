...
```text
1. docs/architecture/ADAPTIVE_HARNESS_INTELLIGENCE.md read-scope block
2. docs/architecture/satellites/ADAPTIVE_HARNESS_INTELLIGENCE_agent_design_search.md relevant sections only
3. this file
4. docs/plan/satellites/ADAPTIVE_HARNESS_INTELLIGENCE_agent_design_search.md current phase only
```
