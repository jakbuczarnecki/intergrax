...
Minimal ROI is now closed. Remaining highest-ROI path: end-to-end evidence smoke audit and full onboarding documentation; optional polish remains artifact sanity checking and external one-page harness narrative. The detailed task count and roadmap live in `HARNESS_EVIDENCE_PACK.md` § Evidence ROI roadmap.  
