...
**Status:** HEP-1 **Done**; HEP-2 Trace Evidence Path **In progress** — EVID-TRACE-01/02 **Done**; EVID-TRACE-03…04 **Planned** — see [`HARNESS_EVIDENCE_PACK.md`](HARNESS_EVIDENCE_PACK.md) § Mode I — HEP-2.  
...
| HEP-2 | Trace evidence path (`intergrax trace show` — planned) | EVID-TRACE-01 … EVID-TRACE-04 | **In progress** — EVID-TRACE-01/02 Done; 03–04 Planned (Mode I 2026-06-21) |
