...
This tour explains the supported indexed-knowledge experience without requiring installation or a local run. It is a product walkthrough, not a screenshot of a finished application UI. Readers who want to run the path should use the [LKW Quick Start](applications/local_workspace_application/docs/QUICKSTART.md); technical reviewers should use the [LKW Platform Proof](docs/public-adoption/LKW_PLATFORM_PROOF.md).
