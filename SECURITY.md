...
| Harness audit (security layers) | [docs/project/technical/guides/docs/audit_results/AUDIT_PROTOCOL.md](docs/project/technical/guides/docs/audit_results/AUDIT_PROTOCOL.md) |
