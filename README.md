...
- **What it provides:** Nexus Agent OS, Tier-0 catalogs (**185** integrations · **190** tools · **49** skills in **22** bundles), LLM, RAG, memory, policy, trace, multi-agent graphs, and Tier-3 application hosts.
...
| **Skills** | **49** `skill_id`s · **22** bundles | [`intergrax/skills/`](intergrax/skills/) | [SKILLS.md](docs/architecture/SKILLS.md) | [plan/SKILLS.md](docs/plan/SKILLS.md) | Per-skill `USAGE.md` under `intergrax/skills/providers/<bundle>/<skill_id>/` |
...
**Skill bundles (22):** `harness`, `rag`, `workspace`, `memory`, `research`, `knowledge`, `legal`, `ops`, `dev`, `browser`, `collaboration`, `data`, `platform`, `sandbox`, `hitl`, `graph`, `storage`, `message_bus`, `cache`, `eval`, `modality`, `notify` — full index in [SKILLS.md § First-party catalog](docs/architecture/SKILLS.md#first-party-catalog-49-skills--22-bundles).
...
| **Skills** | **49** skills · **22** bundles · `intergrax/skills/` | [architecture/SKILLS.md](docs/architecture/SKILLS.md) · [plan](docs/plan/SKILLS.md) |
