...
| --- | --- | --- | --- |
| **Multiplayer AI** | Governed multi-principal collaboration among humans, agents, services, and external agents | **Enterprise core MP-1…MP-7 implemented/closed in certified scopes** — full product-facing Multiplayer capability E2E including MP-8 / MP-9 **not established** | [Multiplayer AI architecture](docs/project/capabilities/architecture/MULTIPLAYER_AI.md) |
