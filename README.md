...
**Deep dive:** [Harness AI narrative](docs/guides/INTERGRAX_HARNESS_NARRATIVE.md) · [Technical documentation map](docs/DOCUMENTATION_MAP.md)
...
**Trace excerpt:** `step_started → tool_requested → tool_completed → step_completed`

**Builder and evaluation paths:** [Evaluation Guide](EVALUATION_GUIDE.md) · [Agent Creation Guide](docs/guides/AGENT_CREATION_GUIDE.md) · [Public documentation map](docs/PUBLIC_DOCUMENTATION_MAP.md)
