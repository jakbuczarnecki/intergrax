...
| How progress is verified | [PROOFS.md](PROOFS.md) and named proof paths |
| Release dates | No public date commitment |

## How to read this roadmap

This document describes **user and validation outcomes**, not internal implementation queues. Detailed technical sequencing belongs to owning implementation plans — for example, the [LKW implementation plan](applications/local_workspace_application/docs/IMPLEMENTATION_PLAN.md) (technical detail, not the public roadmap).

[PROOFS.md](PROOFS.md) owns current proof status and claim boundaries. Moving to a later phase requires evidence — bounded verification, repeated use, or real-user feedback — not only completed code.

If you need to decide whether Intergrax fits your problem today, start with [USE_CASES.md](USE_CASES.md) and [BUILD_WITH_INTERGRAX.md](BUILD_WITH_INTERGRAX.md).
...
| Reproducible public proof path | External readers can verify claims | [LKW Platform Proof](docs/public-adoption/LKW_PLATFORM_PROOF.md) remains runnable in documented environment |

Not every outcome above is complete today. See [PROOFS.md](PROOFS.md) for current status.
...
Platform expansion does not override the primary LKW workflow. See [Token Optimization guide](docs/features/token_optimization/README.md).
...
- **Explicit permission and responsibility boundaries** — see [LICENSE](LICENSE) and [COLLABORATION.md](COLLABORATION.md)
- **No expansion without a concrete user workflow**
- **No release-date promises without a validated delivery basis**

## What is not promised

- Finished hosted SaaS
...
| Need | Document |
|------|----------|
| Current proof status | [PROOFS.md](PROOFS.md) |
| LKW guided proof | [LKW Platform Proof](docs/public-adoption/LKW_PLATFORM_PROOF.md) |
| Use-case fit | [USE_CASES.md](USE_CASES.md) |
| Build or evaluate | [BUILD_WITH_INTERGRAX.md](BUILD_WITH_INTERGRAX.md) |
| Public navigation | [Public documentation map](docs/PUBLIC_DOCUMENTATION_MAP.md) |
| Technical implementation detail | [LKW implementation plan](applications/local_workspace_application/docs/IMPLEMENTATION_PLAN.md) |
