...
"""Synthetic corpus for advisory Token Optimization recommendations (TOKEN-7A)."""
...
class AdvisoryRecommendationCorpusCase:
    """One synthetic advisory recommendation case (no raw prompts)."""
    ...
    expected_confidence: TokenOptimizationRecommendationConfidence
    synthetic_marker: str = ADVISORY_RECOMMENDATION_SYNTHETIC_CORPUS_MARKER


ADVISORY_RECOMMENDATION_CORPUS: tuple[AdvisoryRecommendationCorpusCase, ...] = (
    AdvisoryRecommendationCorpusCase(
        case_id="advisory.policy_review_requires_manual_review",
    ...
    AdvisoryRecommendationCorpusCase(
        case_id="advisory.protected_region_risk_escalates_to_full_context",
    ...
    AdvisoryRecommendationCorpusCase(
        case_id="advisory.quality_regression_escalates_to_full_context",
    ...
    AdvisoryRecommendationCorpusCase(
        case_id="advisory.regression_gate_failed_requires_review",
    ...
    AdvisoryRecommendationCorpusCase(
        case_id="advisory.insufficient_data",
    ...
    AdvisoryRecommendationCorpusCase(
        case_id="advisory.high_fallback_disables_strategy",
    ...
    AdvisoryRecommendationCorpusCase(
        case_id="advisory.hot_stable_cache_preserves_prefix",
    ...
    AdvisoryRecommendationCorpusCase(
        case_id="advisory.invalidated_cache_requires_review",
    ...
    AdvisoryRecommendationCorpusCase(
        case_id="advisory.dynamic_tail_reduction_preferred",
    ...
    AdvisoryRecommendationCorpusCase(
        case_id="advisory.measured_safe_savings_enables_strategy",
    ...
    AdvisoryRecommendationCorpusCase(
        case_id="advisory.low_savings_keeps_current",
    ...
    AdvisoryRecommendationCorpusCase(
        case_id="advisory.regression_gate_passed_keeps_current",
