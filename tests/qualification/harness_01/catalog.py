...
HARNESS_01_INDEPENDENT_ZERO_BYPASS_GATE_TEST_NAMES: frozenset[str] = frozenset(
    {
        ...
        "test_harness_01_contracts_do_not_import_nexus",
        "test_harness_01_public_extension_surfaces_do_not_import_nexus",
        "test_harness_01_layer_rules_reject_contract_and_public_nexus_imports",
        "test_harness_01_unknown_importer_is_unclassified_not_legal",
