...
from intergrax.integrations.providers.confluence.bundle import (
...
def test_opens_creates_httpx_client_when_not_injected() -> None:
    ...
    with patch(
        "intergrax.integrations.providers.confluence.opens._create_http_client",
        return_value=mock_client,
    ) as create_mock:
        from intergrax.integrations.providers.confluence.opens import open_confluence_rest_client
