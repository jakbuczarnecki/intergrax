...
from intergrax.integrations.providers.mysql.bundle import (
    MySQLIntegrationBundle,
    create_mysql_integration,
    create_mysql_relational_store,
)
from intergrax.integrations.providers.mysql.config import (
    ENV_MYSQL_DSN,
    ENV_MYSQL_HOST,
...
def test_mysql_opens_uses_pymysql_when_no_connection_factory() -> None:
    ...
    with patch(
        "intergrax.integrations.providers.mysql.opens._import_pymysql",
