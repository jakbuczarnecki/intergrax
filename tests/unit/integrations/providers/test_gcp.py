...
from intergrax.integrations.providers.gcp.bundle import (
    GcpIntegrationBundle,
    create_gcp_cloud_platform,
    create_gcp_integration,
)
from intergrax.integrations.providers.gcp.config import (
    ENV_GCP_PROJECT_ID,
    ENV_GCP_REGION,
...
def test_opens_uses_service_account_file_when_configured() -> None:
    ...
    with patch(
        "intergrax.integrations.providers.gcp.opens._import_google_auth",
    ) as import_mock:
        ...
        from intergrax.integrations.providers.gcp.opens import open_gcp_credentials
