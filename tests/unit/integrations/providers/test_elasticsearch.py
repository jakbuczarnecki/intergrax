...
from intergrax.integrations.providers.elasticsearch.bundle import (
...
def test_opens_creates_httpx_client_when_not_injected() -> None:
    ...
    with patch(
        "intergrax.integrations.providers.elasticsearch.opens._create_http_client",
        return_value=mock_client,
    ) as create_mock:
        from intergrax.integrations.providers.elasticsearch.opens import open_elasticsearch_rest_client
