...
from intergrax.integrations.providers.azure.bundle import (
...
def test_opens_uses_service_principal_when_configured() -> None:
    ...
    with patch(
        "intergrax.integrations.providers.azure.opens._import_azure_identity",
    ) as import_mock:
        ...
        from intergrax.integrations.providers.azure.opens import open_azure_credential
