...
def test_opens_creates_httpx_client_when_not_injected() -> None:
    ...
    with patch(
        "intergrax.integrations.providers.issue_tracker.jira.opens._create_http_client",
        return_value=mock_client,
    ) as create_mock:
        from intergrax.integrations.providers.issue_tracker.jira.opens import open_jira_rest_client
