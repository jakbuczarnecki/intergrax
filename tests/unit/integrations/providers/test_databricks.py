...
from intergrax.integrations.providers.databricks.bundle import (
    DatabricksIntegrationBundle,
    create_databricks_integration,
    create_databricks_relational_store,
)
from intergrax.integrations.providers.databricks.config import (
    ENV_DATABRICKS_HOST,
...
def test_databricks_opens_uses_driver_when_no_connection_factory() -> None:
    ...
    with patch(
        "intergrax.integrations.providers.databricks.opens._import_databricks_sql",
