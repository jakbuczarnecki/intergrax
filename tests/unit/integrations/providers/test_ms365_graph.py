...
from intergrax.integrations.providers.ms365_graph.adapter import Ms365GraphCollaborationSuite
from intergrax.integrations.providers.ms365_graph.bundle import (
    Ms365GraphIntegrationBundle,
    create_ms365_graph_collaboration_suite,
    create_ms365_graph_integration,
)
from intergrax.integrations.providers.ms365_graph.config import (
    ENV_MS365_CLIENT_ID,
...
def test_opens_creates_httpx_client_when_not_injected() -> None:
    ...
    with patch(
        "intergrax.integrations.providers.ms365_graph.opens._create_http_client",
        return_value=mock_client,
    ) as create_mock:
        from intergrax.integrations.providers.ms365_graph.opens import open_graph_rest_client
