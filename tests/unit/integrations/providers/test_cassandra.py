...
from intergrax.integrations.providers.cassandra.bundle import (
...
def test_opens_creates_driver_session_when_not_injected() -> None:
    ...
    with patch(
        "intergrax.integrations.providers.cassandra.opens._open_session",
        return_value=mock_session,
    ) as open_mock:
        from intergrax.integrations.providers.cassandra.opens import open_cassandra_cql_client
