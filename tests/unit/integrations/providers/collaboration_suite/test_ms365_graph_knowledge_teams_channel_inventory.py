...
# --- Teams Channel wiring ---


def test_channel_inventory_graph_client_delegates() -> None:
    ...
    page = _graph_client(http).read_teams_channels_page(team_id=team_id)
    assert len(page.items) == 1
    assert page.items[0] == parse_msgraph_teams_channel(
        {
            "id": channel_id,
            "displayName": "General",
            "membershipType": "standard",
