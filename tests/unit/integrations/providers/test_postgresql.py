...
from intergrax.integrations.providers.postgresql.bundle import (
    PostgreSQLIntegrationBundle,
    create_postgresql_integration,
    create_postgresql_relational_store,
)
from intergrax.integrations.providers.postgresql.config import (
    ENV_POSTGRESQL_DSN,
    ENV_POSTGRESQL_HOST,
...
def test_postgresql_opens_uses_psycopg_when_no_connection_factory() -> None:
    ...
    with patch(
        "intergrax.integrations.providers.postgresql.opens._import_psycopg",
