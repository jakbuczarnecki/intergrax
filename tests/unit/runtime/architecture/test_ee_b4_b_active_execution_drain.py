...
"""EE-B4-B — active root execution drains before flush/terminate."""
...
@pytest.mark.asyncio
async def test_ee_b4_b_active_execution_drains_to_completion() -> None:
    ...
    await gate.wait_until_started(frozenset({"root"}))
