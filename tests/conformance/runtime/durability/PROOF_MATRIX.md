...
| Integrated lifecycle | cross-component | KV/DocumentStore + Checkpoint | `test_integrated_lifecycle_a1_a2_terminal_restart_denies_execution` |
...
| terminal outcome | ExecutionTerminalService |
...
| terminal authority | yes | yes | yes |
