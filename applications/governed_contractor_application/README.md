...
**Architecture:** [`../../docs/project/technical/applications/governed_contractor_application/ARCHITECTURE.md`](../../docs/project/technical/applications/governed_contractor_application/ARCHITECTURE.md) · **Plan:** [`../../docs/project/technical/applications/governed_contractor_application/IMPLEMENTATION_PLAN.md`](../../docs/project/technical/applications/governed_contractor_application/IMPLEMENTATION_PLAN.md)

**Build & deploy:** [`../../docs/project/technical/applications/governed_contractor_application/BUILD_AND_DEPLOY.md`](../../docs/project/technical/applications/governed_contractor_application/BUILD_AND_DEPLOY.md)
