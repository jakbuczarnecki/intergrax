...
Status: **Done** (PoC v2 + EBE-9 — partner handoff on `agent_experiment_runtime`)
...
| EBE-9 | Host-side event signing (EBE-9) | **Done** | High | `host_attestation.py`, golden vector, default manifest |
