...
wires them inside :func:`~legal_agent.pipeline.legal_execution_loop.run_legal_dynamic_execution_loop`
...
:attr:`~legal_agent.config.legal_agent_config.LegalAgentConfig.governance_service`
and
:attr:`~legal_agent.config.legal_agent_config.LegalAgentConfig.legal_tool_plan_governance`
to that instance.

Ready-made subclasses: :mod:`legal_agent.governance.legal_tool_plan_governance_impl`.
"""
