...
Static org clamp (:func:`~legal_agent.governance.legal_tool_plan_governance.enforce_legal_tool_plan_governance`)
...
from legal_agent.domain.legal_tool_plan import (
    LegalToolPlan,
