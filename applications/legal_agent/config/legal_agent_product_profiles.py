...
"""
Named product SKUs for :class:`~legal_agent.config.legal_agent_config.LegalAgentConfig`.
...
:func:`~legal_agent.governance.legal_agent_governance_wiring.with_dual_legal_governance`.
"""
...
from legal_agent.memory.legal_memory_policy import LegalMemoryPolicyPresets
