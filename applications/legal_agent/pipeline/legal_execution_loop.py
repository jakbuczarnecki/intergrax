...
from legal_agent.domain.legal_dynamic_execution_gates import (
...
from legal_agent.governance.legal_tool_plan_governance import (
    enforce_legal_tool_plan_governance,
)
from legal_agent.runtime.legal_tool_runtime_bridge import (
...
async def run_legal_dynamic_execution_loop(
    *,
    ...
    → optional :attr:`~legal_agent.config.legal_agent_config.LegalAgentConfig.legal_tool_plan_governance`
