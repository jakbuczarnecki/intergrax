...
**Rule:** change this file first, then update `IMPLEMENTATION_PLAN.md`. Platform harness work stays in `docs/project/architecture/intergrax_runtime_architecture.md` §6.1.
