...
This document is an **alpha/product-validation narrative**. It is not a finished SaaS offering, a production guarantee, or a license grant. See [LICENSE](../../../../LICENSE) and [docs/project/community/COLLABORATION.md](../../../../docs/project/community/COLLABORATION.md).
...
Share structured feedback via the collaboration tracks in [docs/project/community/COLLABORATION.md](../../../../docs/project/community/COLLABORATION.md) and [docs/project/overview/ROADMAP.md](../../../../docs/project/overview/ROADMAP.md), or through curated public issues when available.
...
| Document | Purpose |
|----------|---------|
| [Local Knowledge Workspace architecture](../ARCHITECTURE.md) | Technical architecture baseline for the Tier-3 application |
| [README.md](../../../../README.md) | Project overview, proof path, documentation index |
| [docs/project/overview/ROADMAP.md](../../../../docs/project/overview/ROADMAP.md) | Public adoption roadmap and collaboration tracks |
| [docs/project/community/COLLABORATION.md](../../../../docs/project/community/COLLABORATION.md) | Collaboration model, permitted use, contact |
| [LICENSE](../../../../LICENSE) | Proprietary terms |
| [Intergrax Harness Narrative](../../../../docs/project/technical/guides/INTERGRAX_HARNESS_NARRATIVE.md) | External harness narrative |
| [Agent Creation Guide](../../../../docs/project/technical/guides/AGENT_CREATION_GUIDE.md) | Authoring agents and applications on Intergrax |
