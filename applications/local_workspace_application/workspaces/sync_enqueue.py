...
def build_managed_workspace_sync_enqueue_input(
    ...
    *,
    ...
    return MessageBusEnqueueInput(
        ...
        idempotency_key=managed_workspace_sync_idempotency_key(
            job,
...
def enqueue_managed_workspace_sync(
    ...
    *,
    ...
    return message_bus_enqueue(
        ctx,
        build_managed_workspace_sync_enqueue_input(job, enqueue_generation=enqueue_generation),
    )
