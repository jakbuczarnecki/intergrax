...
if (-not $env:INTERGRAX_LLM_PROVIDER) { $env:INTERGRAX_LLM_PROVIDER = "llama_cpp" }
if (-not $env:INTERGRAX_LLM_MODEL) { $env:INTERGRAX_LLM_MODEL = "default" }
$env:INTERGRAX_DEFAULT_LLAMA_CPP_EMBED_BASE_URL = $EmbedUrl
if (-not $env:INTERGRAX_EMBEDDING_PROVIDER) { $env:INTERGRAX_EMBEDDING_PROVIDER = "llama_cpp" }
if (-not $env:INTERGRAX_EMBEDDING_MODEL) { $env:INTERGRAX_EMBEDDING_MODEL = "default" }
