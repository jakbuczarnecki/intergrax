...
export INTERGRAX_LLM_PROVIDER="${INTERGRAX_LLM_PROVIDER:-llama_cpp}"
export INTERGRAX_LLM_MODEL="${INTERGRAX_LLM_MODEL:-default}"
export INTERGRAX_DEFAULT_LLAMA_CPP_EMBED_BASE_URL="$EMBED_URL"
export INTERGRAX_EMBEDDING_PROVIDER="${INTERGRAX_EMBEDDING_PROVIDER:-llama_cpp}"
export INTERGRAX_EMBEDDING_MODEL="${INTERGRAX_EMBEDDING_MODEL:-default}"
