...
from intergrax.tools.providers.document.handlers import DocumentParseHandler
from intergrax.tools.providers.document.service import DOCUMENT_PARSE_TOOL_ID
from intergrax.tools.registry.runtime import ToolRegistry
from intergrax.tools.registry.wiring import ToolWiringContext

DOCUMENT_BUNDLE_ID = "document"
DOCUMENT_TOOL_IDS: tuple[str, ...] = (DOCUMENT_PARSE_TOOL_ID,)
