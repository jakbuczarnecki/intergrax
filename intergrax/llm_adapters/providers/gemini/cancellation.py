...
"""Gemini SDK stream termination (W4-D)."""
...
class GeminiNativeTermination(StreamRegistryTerminationPort):
...
def gemini_external_operation_ports() -> tuple[
    RegistryCancellationPort,
    GeminiNativeTermination,
    ProviderStreamTransportRegistry,
]:
    registry = ProviderStreamTransportRegistry()
    termination = GeminiNativeTermination(registry)
