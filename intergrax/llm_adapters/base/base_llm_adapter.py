...
class BaseLLMAdapter(ABC):
    """
    Shared framework/runtime base for shipped and internal LLM adapter implementations.

    Platform consumers depend on ``LLMAdapter`` (execution contract) only.
    Providers may subclass this base for retry, resilience, token counting, and
