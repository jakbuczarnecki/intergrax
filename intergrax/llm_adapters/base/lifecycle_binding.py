...
"""Internal runtime lifecycle composition capability for framework LLM adapters (EBH-2E-R1-R1-R1)."""
...
class LLMRuntimeLifecycleBinding(Protocol):
    """Framework composition-root binding for provider external-operation integration.

    Not a public plugin contract: external providers implement ``LLMAdapter`` only.
    Optional structural implementers may still satisfy this protocol for managed wiring.
    """
...
__all__ = ["LLMRuntimeLifecycleBinding"]
