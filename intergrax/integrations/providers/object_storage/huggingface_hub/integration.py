...
HuggingfaceHubObjectStorageClient = ObjectStorage
...
class HuggingfaceHubObjectStorageIntegration(ObjectStorageIntegrationContract):
    ...
    Legacy catalog factory (create_huggingface_hub_object_storage) owns catalog behavior; legacy factories use from_client().
    """
