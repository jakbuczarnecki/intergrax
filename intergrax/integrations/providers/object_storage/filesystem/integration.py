...
"""Filesystem object storage integration (INTEGRATIONS-2D · INTEGRATIONS-2E runtime cutover)."""
...
FilesystemObjectStorageClient = ObjectStorage

class FilesystemObjectStorageIntegration(ObjectStorageIntegrationContract):
    """
    Single public Filesystem object storage entrypoint.

    Legacy catalog factory (create_filesystem_object_storage) owns catalog behavior; legacy factories use from_client().
    """
...
ObjectStorage.register(FilesystemObjectStorageIntegration)
