...
"""Explicit contract declaration for Minio object storage."""

from __future__ import annotations

from intergrax.integrations.providers.object_storage.minio.bundle import (
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=MinioObjectStorageIntegration,
    contract_class=ObjectStorageIntegrationContract,
    contract_factory=create_minio_object_storage_integration,
    display_name="Minio",
    config_class=MinioObjectStorageIntegrationConfig,
    capabilities=(
