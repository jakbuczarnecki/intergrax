...
"""Gitlab issue tracker integration (INTEGRATIONS-2D · INTEGRATIONS-2E runtime cutover)."""
...
GitlabIssueTrackerClient = IssueTracker

class GitlabIssueTrackerIntegration(IssueTrackerIntegrationContract):
    """
    Single public Gitlab issue tracker entrypoint.

    Legacy catalog factory (create_gitlab_integration) owns catalog behavior; legacy factories use from_client().
    """
...
IssueTracker.register(GitlabIssueTrackerIntegration)
