...
"""Github issue tracker integration (INTEGRATIONS-2D · INTEGRATIONS-2E runtime cutover)."""
...
class GithubIssueTrackerIntegration(IssueTrackerIntegrationContract):
    """
    Single public Github issue tracker entrypoint.

    Legacy catalog factory (create_github_issue_tracker) owns catalog behavior; legacy factories use from_client().
    """
...
IssueTracker.register(GithubIssueTrackerIntegration)
