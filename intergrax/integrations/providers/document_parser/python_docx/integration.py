...
PythonDocxDocumentParserClient = DocumentParser
...
class PythonDocxDocumentParserIntegration(DocumentParserIntegrationContract):
    ...
    Legacy catalog factory (create_python_docx_document_parser) owns catalog behavior; legacy factories use from_client().
    """
