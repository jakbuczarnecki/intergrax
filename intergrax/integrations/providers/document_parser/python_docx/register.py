...
from intergrax.integrations.providers.document_parser.python_docx.contract_spec import CONTRACT_SPECS
from intergrax.integrations.registry.plugin_register import register_from_manifest


def register_python_docx_integration(*, override: bool = False) -> None:
    register_from_manifest(MANIFEST, create_python_docx_document_parser, override=override, contract_specs=CONTRACT_SPECS)
