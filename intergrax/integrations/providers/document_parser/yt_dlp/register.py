...
from intergrax.integrations.providers.document_parser.yt_dlp.contract_spec import CONTRACT_SPECS
from intergrax.integrations.registry.plugin_register import register_from_manifest


def register_yt_dlp_integration(*, override: bool = False) -> None:
    register_from_manifest(MANIFEST, create_yt_dlp_document_parser, override=override, contract_specs=CONTRACT_SPECS)
