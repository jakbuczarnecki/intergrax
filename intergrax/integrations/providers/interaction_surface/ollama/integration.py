...
class OllamaInteractionSurfaceIntegration(InteractionSurfaceIntegrationContract):
    ...
    Legacy catalog factory (create_ollama_interaction_surface) delegates to this class.
    """
    ...
    @classmethod
    def from_runtime(cls, runtime: Any, *, enabled: bool = True) -> OllamaInteractionSurfaceIntegration:
    ...
    def _require_runtime(self) -> Any:
        if self._runtime is None:
            raise IntegrationConfigurationError("Ollama integration requires a runtime delegate")
