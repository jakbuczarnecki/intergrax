...
class OktaIdentityProviderIntegration(IdentityProviderIntegrationContract):
    ...
    Legacy catalog factory (create_okta_identity_provider) delegates to this class.
    """
    ...
    @classmethod
    def from_runtime(cls, runtime: Any, *, enabled: bool = True) -> OktaIdentityProviderIntegration:
    ...
    def _require_runtime(self) -> Any:
        if self._runtime is None:
            raise IntegrationConfigurationError("Okta integration requires a runtime delegate")
