...
class ClerkIdentityProviderIntegration(IdentityProviderIntegrationContract):
    ...
    Legacy catalog factory (create_clerk_identity_provider) delegates to this class.
    """
    ...
    @classmethod
    def from_runtime(cls, runtime: Any, *, enabled: bool = True) -> ClerkIdentityProviderIntegration:
    ...
    def _require_runtime(self) -> Any:
        if self._runtime is None:
            raise IntegrationConfigurationError("Clerk integration requires a runtime delegate")
