...
class WikipediaWikiKnowledgeIntegration(WikiKnowledgeIntegrationContract):
    ...
    Legacy catalog factory (create_wikipedia_wiki_knowledge) delegates to this class.
    """
    ...
    @classmethod
    def from_runtime(cls, runtime: Any, *, enabled: bool = True) -> WikipediaWikiKnowledgeIntegration:
    ...
    def _require_runtime(self) -> Any:
        if self._runtime is None:
            raise IntegrationConfigurationError("Wikipedia integration requires a runtime delegate")
