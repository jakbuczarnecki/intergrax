...
"""Explicit contract declaration for Modal sandbox host."""

from __future__ import annotations

from intergrax.integrations.providers.sandbox_host.modal.bundle import (
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=ModalSandboxHostIntegration,
    contract_class=SandboxHostIntegrationContract,
    contract_factory=create_modal_sandbox_host_integration,
    display_name="Modal",
    config_class=ModalSandboxHostIntegrationConfig,
    capabilities=(
