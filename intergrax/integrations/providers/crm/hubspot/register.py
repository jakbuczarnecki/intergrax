...
from intergrax.integrations.providers.crm.hubspot.contract_spec import CONTRACT_SPECS
from intergrax.integrations.registry.plugin_register import register_from_manifest


def register_hubspot_integration(*, override: bool = False) -> None:
    register_from_manifest(MANIFEST, create_hubspot_crm, override=override, contract_specs=CONTRACT_SPECS)
