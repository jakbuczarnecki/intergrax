...
MotherduckRelationalStoreClient = RelationalStore
...
class MotherduckRelationalStoreIntegration(RelationalStoreIntegrationContract):
    ...
    Legacy catalog factory (create_motherduck_relational_store) owns catalog behavior; legacy factories use from_client().
    """
