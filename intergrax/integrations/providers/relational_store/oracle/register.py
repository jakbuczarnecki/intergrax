...
from intergrax.integrations.providers.relational_store.oracle.contract_spec import CONTRACT_SPECS


def register_oracle_integration(*, override: bool = False) -> None:
    register_from_manifest(MANIFEST, create_oracle_relational_store, override=override, contract_specs=CONTRACT_SPECS)
