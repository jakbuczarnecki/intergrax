...
"""Explicit contract declaration for Timescaledb relational store."""

from __future__ import annotations

from intergrax.integrations.providers.relational_store.timescaledb.bundle import (
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=TimescaledbRelationalStoreIntegration,
    contract_class=RelationalStoreIntegrationContract,
    contract_factory=create_timescaledb_relational_store_integration,
    display_name="Timescaledb",
    config_class=TimescaledbRelationalStoreIntegrationConfig,
    capabilities=(
