...
from intergrax.integrations.providers.relational_store.neon.contract_spec import CONTRACT_SPECS


def register_neon_integration(*, override: bool = False) -> None:
    register_from_manifest(MANIFEST, create_neon_relational_store, override=override, contract_specs=CONTRACT_SPECS)
