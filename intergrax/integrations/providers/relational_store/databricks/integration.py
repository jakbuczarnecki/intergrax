...
class DatabricksRelationalStoreIntegration(RelationalStoreIntegrationContract):
    ...
    Legacy catalog factory (create_databricks_integration) delegates to this class.
    """

    config: DatabricksRelationalStoreIntegrationConfig = DatabricksRelationalStoreIntegrationConfig()
    _client: _DatabricksRelationalStoreClient | None = PrivateAttr(default=None)
    ...
    def from_client(
        cls,
        client: _DatabricksRelationalStoreClient,
        *,
        enabled: bool = False,
    ) -> DatabricksRelationalStoreIntegration:
        integration = cls.for_provider(
