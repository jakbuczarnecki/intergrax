...
from intergrax.integrations.providers.relational_store.azure_sql.contract_spec import CONTRACT_SPECS


def register_azure_sql_integration(*, override: bool = False) -> None:
    register_from_manifest(MANIFEST, create_azure_sql_relational_store, override=override, contract_specs=CONTRACT_SPECS)
