...
"""Explicit contract declaration for Mysql relational store."""
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=MysqlRelationalStoreIntegration,
    contract_class=RelationalStoreIntegrationContract,
    contract_factory=create_mysql_relational_store_integration,
    display_name="Mysql",
    config_class=MysqlRelationalStoreIntegrationConfig,
    capabilities=(
