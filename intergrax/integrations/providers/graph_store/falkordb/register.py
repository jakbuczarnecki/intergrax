...
from intergrax.integrations.providers.graph_store.falkordb.contract_spec import CONTRACT_SPECS


def register_falkordb_integration(*, override: bool = False) -> None:
    register_from_manifest(MANIFEST, create_falkordb_graph_store, override=override, contract_specs=CONTRACT_SPECS)
