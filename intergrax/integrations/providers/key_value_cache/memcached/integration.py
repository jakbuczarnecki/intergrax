...
MemcachedKeyValueCacheClient = KeyValueCache
...
class MemcachedKeyValueCacheIntegration(KeyValueCacheIntegrationContract):
    ...
    Legacy catalog factory (create_memcached_key_value_cache) owns catalog behavior; legacy factories use from_client().
    """
