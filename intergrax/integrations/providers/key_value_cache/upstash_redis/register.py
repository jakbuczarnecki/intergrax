...
from intergrax.integrations.providers.key_value_cache.upstash_redis.contract_spec import CONTRACT_SPECS


def register_upstash_redis_integration(*, override: bool = False) -> None:
    register_from_manifest(MANIFEST, create_upstash_redis_key_value_cache, override=override, contract_specs=CONTRACT_SPECS)
