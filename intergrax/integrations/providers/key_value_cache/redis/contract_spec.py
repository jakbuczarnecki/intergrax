...
"""Explicit contract declaration for Redis key value cache."""

from __future__ import annotations

from intergrax.integrations.providers.key_value_cache.redis.bundle import (
    create_redis_key_value_cache_integration,
)
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=RedisKeyValueCacheIntegration,
    contract_class=KeyValueCacheIntegrationContract,
    contract_factory=create_redis_key_value_cache_integration,
    display_name="Redis",
    config_class=RedisKeyValueCacheIntegrationConfig,
    capabilities=(
