...
class ElasticacheKeyValueCacheIntegration(KeyValueCacheIntegrationContract):
    ...
    Legacy catalog factory (create_elasticache_key_value_cache) delegates to this class.
    """
    ...
    @classmethod
    def from_runtime(cls, runtime: Any, *, enabled: bool = True) -> ElasticacheKeyValueCacheIntegration:
    ...
    def _require_runtime(self) -> Any:
        if self._runtime is None:
            raise IntegrationConfigurationError("Elasticache integration requires a runtime delegate")
