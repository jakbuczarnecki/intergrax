...
"""Explicit contract declaration for Telegram conversation channel."""
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=TelegramConversationChannelIntegration,
    contract_class=ConversationChannelIntegrationContract,
    contract_factory=create_telegram_conversation_channel_integration,
    display_name="Telegram",
    config_class=TelegramConversationChannelIntegrationConfig,
    capabilities=(
