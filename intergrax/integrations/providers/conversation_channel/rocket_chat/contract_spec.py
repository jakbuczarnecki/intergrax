...
"""Explicit contract declaration for Rocket.Chat conversation channel."""
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=RocketChatConversationChannelIntegration,
    contract_class=ConversationChannelIntegrationContract,
    contract_factory=create_rocket_chat_conversation_channel_integration,
    display_name="Rocket.Chat",
    config_class=RocketChatConversationChannelIntegrationConfig,
    capabilities=(
