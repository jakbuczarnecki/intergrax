...
"""Rocket.Chat conversation channel integration (contract-defined, runtime-unbound)."""
...
ROCKET_CHAT_CONVERSATION_CHANNEL_PROVIDER_ID = "rocket_chat"


class RocketChatConversationChannelIntegrationConfig(CategoryIntegrationConfig):
    """Typed config for Rocket.Chat conversation channel integration."""

    pass


class RocketChatConversationChannelIntegration(ConversationChannelIntegrationContract):
    """
    Public Rocket.Chat conversation channel entrypoint.
    ...
    config: RocketChatConversationChannelIntegrationConfig = RocketChatConversationChannelIntegrationConfig()
    ...
    def health(self) -> HealthStatus:
        return probe_client_health(
            ...
            slug=ROCKET_CHAT_CONVERSATION_CHANNEL_PROVIDER_ID,
            default_detail="rocket_chat conversation channel ready probe",
        )
...
ConversationChannelBackend.register(RocketChatConversationChannelIntegration)
