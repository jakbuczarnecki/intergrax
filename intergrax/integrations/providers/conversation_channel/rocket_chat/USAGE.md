# Rocket.Chat conversation channel (`rocket_chat`)

Category: `conversation_channel`

Public Integration class: `RocketChatConversationChannelIntegration`
...
```text
realtime/WebSocket or app integration + REST API
```
