...
"""Explicit contract declaration for Discord conversation channel."""
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=DiscordConversationChannelIntegration,
    contract_class=ConversationChannelIntegrationContract,
    contract_factory=create_discord_conversation_channel_integration,
    display_name="Discord",
    config_class=DiscordConversationChannelIntegrationConfig,
    capabilities=(
