...
"""Explicit contract declaration for Apify browser automation."""

from __future__ import annotations

from intergrax.integrations.providers.browser_automation.apify.bundle import (
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=ApifyBrowserAutomationIntegration,
    contract_class=BrowserAutomationIntegrationContract,
    contract_factory=create_apify_browser_automation_integration,
    display_name="Apify",
    config_class=ApifyBrowserAutomationIntegrationConfig,
    capabilities=(
