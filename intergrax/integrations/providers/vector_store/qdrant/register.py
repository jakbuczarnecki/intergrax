...
from intergrax.integrations.providers.vector_store.qdrant.contract_spec import CONTRACT_SPECS


def register_qdrant_integration(*, override: bool = False) -> None:
    register_from_manifest(MANIFEST, create_qdrant_vector_store, override=override, contract_specs=CONTRACT_SPECS)
