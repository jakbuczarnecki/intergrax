...
"""Explicit contract declaration for Chroma vector store."""
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=ChromaVectorStoreIntegration,
    contract_class=VectorStoreIntegrationContract,
    contract_factory=create_chroma_vector_store_integration,
    display_name="Chroma",
    config_class=ChromaVectorStoreIntegrationConfig,
    capabilities=(
