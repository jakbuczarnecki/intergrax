...
"""Explicit contract declaration for Typesense vector store."""

from __future__ import annotations

from intergrax.integrations.providers.vector_store.typesense.bundle import (
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=TypesenseVectorStoreIntegration,
    contract_class=VectorStoreIntegrationContract,
    contract_factory=create_typesense_vector_store_integration,
    display_name="Typesense",
    config_class=TypesenseVectorStoreIntegrationConfig,
    capabilities=(
