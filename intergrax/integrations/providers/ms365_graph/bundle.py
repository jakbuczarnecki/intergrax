...
from intergrax.integrations.providers.ms365_graph.config import Ms365GraphIntegrationConfig
from intergrax.integrations.providers.ms365_graph.opens import (
