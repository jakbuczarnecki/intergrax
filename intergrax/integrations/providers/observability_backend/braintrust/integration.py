...
"""Braintrust observability vendor integration (INTEGRATIONS-2C)."""
...
class BraintrustObservabilityIntegration(ObservabilityVendorIntegrationContract):
    """
    Braintrust observability vendor integration.

    Consumes only policy-sanitized ObservabilityExportEnvelope records via map_envelope().
    The legacy ObservabilityBackend query facade (create_braintrust_observability_backend)
    ...
    def from_transport(
        ...
        *,
        ...
        integration = cls.for_provider(
            ...
            supported_signals=supported_signals or _BRAINTRUST_SUPPORTED_SIGNALS,
