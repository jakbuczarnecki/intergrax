...
"""Explicit contract declaration for Braintrust observability backend."""

from __future__ import annotations

from intergrax.integrations.providers.observability_backend.braintrust.bundle import (
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=BraintrustObservabilityIntegration,
    contract_class=ObservabilityVendorIntegrationContract,
    contract_factory=create_braintrust_observability_integration,
    integration_kind=OBSERVABILITY_VENDOR_INTEGRATION_KIND,
    display_name="Braintrust",
    config_class=BraintrustObservabilityIntegrationConfig,
    capabilities=(
