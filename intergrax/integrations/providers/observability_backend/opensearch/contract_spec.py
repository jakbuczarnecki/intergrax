...
"""Explicit contract declaration for Opensearch observability backend."""

from __future__ import annotations

from intergrax.integrations.providers.observability_backend.opensearch.bundle import (
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=OpensearchObservabilityIntegration,
    contract_class=ObservabilityVendorIntegrationContract,
    contract_factory=create_opensearch_observability_integration,
    integration_kind=OBSERVABILITY_VENDOR_INTEGRATION_KIND,
    display_name="Opensearch",
    config_class=OpensearchObservabilityIntegrationConfig,
    capabilities=(
