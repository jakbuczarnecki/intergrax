...
"""Phoenix observability vendor integration (INTEGRATIONS-2C · INTEGRATIONS-2E runtime cutover)."""
...
class PhoenixObservabilityIntegration(ObservabilityVendorIntegrationContract[PhoenixObservabilityIntegrationConfig]):
    """
    ...
    def from_client(
        ...
        *,
        ...
        signals = supported_signals or PHOENIX_SUPPORTED_SIGNALS
    ...
    def from_transport(
        ...
        *,
        ...
        integration = cls.for_provider(
            provider_id=PHOENIX_OBSERVABILITY_PROVIDER_ID,
            supported_signals=supported_signals or PHOENIX_SUPPORTED_SIGNALS,
            display_name="Phoenix",
            config=PhoenixObservabilityIntegrationConfig(enabled=enabled),
        )
