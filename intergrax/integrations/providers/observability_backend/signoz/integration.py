...
"""Signoz observability vendor integration (INTEGRATIONS-2C · INTEGRATIONS-2E runtime cutover)."""
...
class SignozObservabilityIntegration(ObservabilityVendorIntegrationContract[SignozObservabilityIntegrationConfig]):
    """
    Single public Signoz observability entrypoint.

    Legacy catalog factory (create_signoz_observability_backend) owns catalog query behavior; legacy factories use from_client().
    """
    ...
    def from_client(
        ...
        *,
        ...
        signals = supported_signals or SIGNOZ_SUPPORTED_SIGNALS
    ...
    def from_transport(
        ...
        *,
        ...
        integration = cls.for_provider(
            provider_id=SIGNOZ_OBSERVABILITY_PROVIDER_ID,
            supported_signals=supported_signals or SIGNOZ_SUPPORTED_SIGNALS,
            display_name="Signoz",
            config=SignozObservabilityIntegrationConfig(enabled=enabled),
        )
