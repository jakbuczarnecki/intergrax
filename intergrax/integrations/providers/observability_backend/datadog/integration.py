...
"""Datadog observability vendor integration (INTEGRATIONS-2C · INTEGRATIONS-2E runtime cutover)."""
...
class DatadogObservabilityIntegration(ObservabilityVendorIntegrationContract[DatadogObservabilityIntegrationConfig]):
    """
    Single public Datadog observability entrypoint.

    Legacy catalog factory (create_datadog_observability_backend) owns catalog query behavior; legacy factories use from_client().
    """
    ...
    def from_client(
        ...
        *,
        ...
        signals = supported_signals or DATADOG_SUPPORTED_SIGNALS
    ...
    def from_transport(
        ...
        *,
        ...
        integration = cls.for_provider(
            provider_id=DATADOG_OBSERVABILITY_PROVIDER_ID,
            supported_signals=supported_signals or DATADOG_SUPPORTED_SIGNALS,
            display_name="Datadog",
            config=DatadogObservabilityIntegrationConfig(enabled=enabled),
        )
