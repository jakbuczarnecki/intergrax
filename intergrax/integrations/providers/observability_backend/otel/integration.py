...
"""Otel observability vendor integration (INTEGRATIONS-2C · INTEGRATIONS-2E runtime cutover)."""
...
class OtelObservabilityIntegration(ObservabilityVendorIntegrationContract[OtelObservabilityIntegrationConfig]):
    """
    Single public Otel observability entrypoint.

    Legacy catalog factory (create_otel_observability_backend) owns catalog query behavior; legacy factories use from_client().
    """
    ...
    def from_client(
        ...
        *,
        ...
        signals = supported_signals or OTEL_SUPPORTED_SIGNALS
    ...
    def from_transport(
        ...
        *,
        ...
        integration = cls.for_provider(
            provider_id=OTEL_OBSERVABILITY_PROVIDER_ID,
            supported_signals=supported_signals or OTEL_SUPPORTED_SIGNALS,
            display_name="Otel",
            config=OtelObservabilityIntegrationConfig(enabled=enabled),
        )
