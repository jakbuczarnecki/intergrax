...
"""Explicit contract declaration for Otel observability backend."""

from __future__ import annotations

from intergrax.integrations.providers.observability_backend.otel.bundle import (
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=OtelObservabilityIntegration,
    contract_class=ObservabilityVendorIntegrationContract,
    contract_factory=create_otel_observability_integration,
    integration_kind=OBSERVABILITY_VENDOR_INTEGRATION_KIND,
    display_name="Otel",
    config_class=OtelObservabilityIntegrationConfig,
    capabilities=(
