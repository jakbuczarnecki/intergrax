...
"""Honeycomb observability vendor integration (INTEGRATIONS-2C · INTEGRATIONS-2E runtime cutover)."""
...
class HoneycombObservabilityIntegration(ObservabilityVendorIntegrationContract[HoneycombObservabilityIntegrationConfig]):
    """
    Single public Honeycomb observability entrypoint.

    Legacy catalog factory (create_honeycomb_observability_backend) owns catalog query behavior; legacy factories use from_client().
    """
    ...
    def from_client(
        ...
        *,
        ...
        signals = supported_signals or HONEYCOMB_SUPPORTED_SIGNALS
    ...
    def from_transport(
        ...
        *,
        ...
        integration = cls.for_provider(
            provider_id=HONEYCOMB_OBSERVABILITY_PROVIDER_ID,
            supported_signals=supported_signals or HONEYCOMB_SUPPORTED_SIGNALS,
            display_name="Honeycomb",
            config=HoneycombObservabilityIntegrationConfig(enabled=enabled),
        )
