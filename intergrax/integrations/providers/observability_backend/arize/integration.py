...
"""Arize observability vendor integration (INTEGRATIONS-2C · INTEGRATIONS-2E runtime cutover)."""
...
class ArizeObservabilityIntegration(ObservabilityVendorIntegrationContract[ArizeObservabilityIntegrationConfig]):
    """
    Single public Arize observability entrypoint.

    Legacy catalog factory (create_arize_observability_backend) owns catalog query behavior; legacy factories use from_client().
    """
    ...
    def from_client(
        ...
        *,
        ...
        signals = supported_signals or ARIZE_SUPPORTED_SIGNALS
    ...
    def from_transport(
        ...
        *,
        ...
        integration = cls.for_provider(
            provider_id=ARIZE_OBSERVABILITY_PROVIDER_ID,
            supported_signals=supported_signals or ARIZE_SUPPORTED_SIGNALS,
            display_name="Arize",
            config=ArizeObservabilityIntegrationConfig(enabled=enabled),
        )
