...
"""Langsmith observability vendor integration (INTEGRATIONS-2C · INTEGRATIONS-2E runtime cutover)."""
...
class LangsmithObservabilityIntegration(ObservabilityVendorIntegrationContract[LangsmithObservabilityIntegrationConfig]):
    """
    Single public Langsmith observability entrypoint.

    Legacy catalog factory (create_langsmith_observability_backend) owns catalog query behavior; legacy factories use from_client().
    """
    ...
    def from_client(
        ...
        *,
        ...
        signals = supported_signals or LANGSMITH_SUPPORTED_SIGNALS
    ...
    def from_transport(
        ...
        *,
        ...
        integration = cls.for_provider(
            provider_id=LANGSMITH_OBSERVABILITY_PROVIDER_ID,
            supported_signals=supported_signals or LANGSMITH_SUPPORTED_SIGNALS,
            display_name="Langsmith",
            config=LangsmithObservabilityIntegrationConfig(enabled=enabled),
        )
