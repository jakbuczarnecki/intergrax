...
"""Explicit contract declaration for Elasticsearch observability backend."""
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    contract_factory=create_elasticsearch_observability_integration,
    integration_kind=OBSERVABILITY_VENDOR_INTEGRATION_KIND,
    display_name="Elasticsearch",
    config_class=ElasticsearchObservabilityIntegrationConfig,
    capabilities=(
