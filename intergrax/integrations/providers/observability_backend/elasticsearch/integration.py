...
"""Elasticsearch observability vendor integration (INTEGRATIONS-2C)."""
...
class ElasticsearchObservabilityIntegration(ObservabilityVendorIntegrationContract):
    """
    Elasticsearch observability vendor integration.

    Consumes only policy-sanitized ObservabilityExportEnvelope records via map_envelope().
    The legacy ObservabilityBackend query facade (create_elasticsearch_observability_backend)
    ...
    def from_transport(
        ...
        *,
        ...
        integration = cls.for_provider(
            ...
            supported_signals=supported_signals or _ELASTICSEARCH_SUPPORTED_SIGNALS,
