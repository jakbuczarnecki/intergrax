...
"""Sentry observability vendor integration (INTEGRATIONS-2C)."""
...
class SentryObservabilityIntegration(ObservabilityVendorIntegrationContract):
    """
    Sentry observability vendor integration.

    Consumes only policy-sanitized ObservabilityExportEnvelope records via map_envelope().
    The legacy ObservabilityBackend query facade (create_sentry_observability_backend)
    ...
    def from_transport(
        ...
        *,
        ...
        integration = cls.for_provider(
            ...
            supported_signals=supported_signals or _SENTRY_SUPPORTED_SIGNALS,
            display_name="Sentry",
