...
"""Explicit contract declaration for Loki observability backend."""

from __future__ import annotations

from intergrax.integrations.providers.observability_backend.loki.bundle import (
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=LokiObservabilityIntegration,
    contract_class=ObservabilityVendorIntegrationContract,
    contract_factory=create_loki_observability_integration,
    integration_kind=OBSERVABILITY_VENDOR_INTEGRATION_KIND,
    display_name="Loki",
    config_class=LokiObservabilityIntegrationConfig,
    capabilities=(
