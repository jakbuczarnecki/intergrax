...
"""Explicit contract declaration for Opentelemetry Collector observability backend."""
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=OpenTelemetryCollectorObservabilityIntegration,
    contract_class=ObservabilityVendorIntegrationContract,
    contract_factory=create_opentelemetry_collector_observability_integration,
    integration_kind=OBSERVABILITY_VENDOR_INTEGRATION_KIND,
    display_name="Opentelemetry Collector",
    config_class=OpenTelemetryCollectorObservabilityIntegrationConfig,
    capabilities=(
