...
"""Explicit contract declaration for Posthog observability backend."""

from __future__ import annotations

from intergrax.integrations.providers.observability_backend.posthog.bundle import (
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=PosthogObservabilityIntegration,
    contract_class=ObservabilityVendorIntegrationContract,
    contract_factory=create_posthog_observability_integration,
    integration_kind=OBSERVABILITY_VENDOR_INTEGRATION_KIND,
    display_name="Posthog",
    config_class=PosthogObservabilityIntegrationConfig,
    capabilities=(
