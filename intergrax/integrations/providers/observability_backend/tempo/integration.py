...
"""Tempo observability vendor integration (INTEGRATIONS-2C · INTEGRATIONS-2E runtime cutover)."""
...
class TempoObservabilityIntegration(ObservabilityVendorIntegrationContract[TempoObservabilityIntegrationConfig]):
    """
    Single public Tempo observability entrypoint.

    Legacy catalog factory (create_tempo_observability_backend) owns catalog query behavior; legacy factories use from_client().
    """
    ...
    def from_client(
        ...
        *,
        ...
        signals = supported_signals or TEMPO_SUPPORTED_SIGNALS
    ...
    def from_transport(
        ...
        *,
        ...
        integration = cls.for_provider(
            provider_id=TEMPO_OBSERVABILITY_PROVIDER_ID,
            supported_signals=supported_signals or TEMPO_SUPPORTED_SIGNALS,
            display_name="Tempo",
            config=TempoObservabilityIntegrationConfig(enabled=enabled),
        )
