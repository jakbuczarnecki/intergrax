...
"""Explicit contract declaration for Tempo observability backend."""

from __future__ import annotations

from intergrax.integrations.providers.observability_backend.tempo.bundle import (
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=TempoObservabilityIntegration,
    contract_class=ObservabilityVendorIntegrationContract,
    contract_factory=create_tempo_observability_integration,
    integration_kind=OBSERVABILITY_VENDOR_INTEGRATION_KIND,
    display_name="Tempo",
    config_class=TempoObservabilityIntegrationConfig,
    capabilities=(
