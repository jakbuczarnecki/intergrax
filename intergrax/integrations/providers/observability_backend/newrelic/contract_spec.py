...
"""Explicit contract declaration for Newrelic observability backend."""

from __future__ import annotations

from intergrax.integrations.providers.observability_backend.newrelic.bundle import (
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=NewRelicObservabilityIntegration,
    contract_class=ObservabilityVendorIntegrationContract,
    contract_factory=create_newrelic_observability_integration,
    integration_kind=OBSERVABILITY_VENDOR_INTEGRATION_KIND,
    display_name="Newrelic",
    config_class=NewRelicObservabilityIntegrationConfig,
    capabilities=(
