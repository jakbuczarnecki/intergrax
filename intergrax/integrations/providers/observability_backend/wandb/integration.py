...
"""Wandb observability vendor integration (INTEGRATIONS-2C · INTEGRATIONS-2E runtime cutover)."""
...
class WandbObservabilityIntegrationConfig(ObservabilityVendorIntegrationConfig):
    """Typed config for Wandb observability vendor integration."""
...
class WandbObservabilityIntegration(ObservabilityVendorIntegrationContract):
    ...
    Legacy catalog factory (create_wandb_observability_backend) owns catalog query behavior; legacy factories use from_client().
    """
    ...
    def from_client(
        ...
        *,
        ...
        signals = supported_signals or WANDB_SUPPORTED_SIGNALS
    ...
    def from_transport(
        ...
        *,
        ...
        integration = cls.for_provider(
            provider_id=WANDB_OBSERVABILITY_PROVIDER_ID,
            supported_signals=supported_signals or WANDB_SUPPORTED_SIGNALS,
            display_name="Wandb",
            config=WandbObservabilityIntegrationConfig(enabled=enabled),
        )
