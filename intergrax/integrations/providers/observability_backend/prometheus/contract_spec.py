...
"""Explicit contract declaration for Prometheus observability backend."""
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=PrometheusObservabilityIntegration,
    contract_class=ObservabilityVendorIntegrationContract,
    contract_factory=create_prometheus_observability_integration,
    integration_kind=OBSERVABILITY_VENDOR_INTEGRATION_KIND,
    display_name="Prometheus",
    config_class=PrometheusObservabilityIntegrationConfig,
    capabilities=(
