...
from intergrax.integrations.providers.search_provider.bing.contract_spec import CONTRACT_SPECS
from intergrax.integrations.registry.plugin_register import register_from_manifest


def register_bing_integration(*, override: bool = False) -> None:
    register_from_manifest(MANIFEST, create_bing_search_provider, override=override, contract_specs=CONTRACT_SPECS)
