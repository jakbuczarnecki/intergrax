...
from intergrax.integrations.providers.search_provider.perplexity.contract_spec import CONTRACT_SPECS
from intergrax.integrations.registry.plugin_register import register_from_manifest


def register_perplexity_integration(*, override: bool = False) -> None:
    register_from_manifest(MANIFEST, create_perplexity_search_provider, override=override, contract_specs=CONTRACT_SPECS)
