...
"""Explicit contract declaration for Arxiv."""

from __future__ import annotations

from intergrax.integrations.providers.search_provider.arxiv.bundle import (
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=ArxivSearchProviderIntegration,
    contract_class=SearchProviderIntegrationContract,
    contract_factory=create_arxiv_search_provider_integration,
    display_name="Arxiv",
    config_class=ArxivSearchProviderIntegrationConfig,
    capabilities=(
