...
"""Explicit contract declaration for Tavily."""

from __future__ import annotations

from intergrax.integrations.providers.search_provider.tavily.bundle import (
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=TavilySearchProviderIntegration,
    contract_class=SearchProviderIntegrationContract,
    contract_factory=create_tavily_search_provider_integration,
    display_name="Tavily",
    config_class=TavilySearchProviderIntegrationConfig,
    capabilities=(
