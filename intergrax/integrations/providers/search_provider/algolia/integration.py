...
AlgoliaSearchProviderClient = SearchProvider

class AlgoliaSearchProviderIntegration(SearchProviderIntegrationContract):
    """
    Single public Algolia search provider entrypoint.

    Legacy catalog factory (create_algolia_search_provider) owns catalog behavior; legacy factories use from_client().
    """
