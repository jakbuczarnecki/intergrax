...
from intergrax.integrations.providers.document_store.cassandra.contract_spec import CONTRACT_SPECS


def register_cassandra_integration(*, override: bool = False) -> None:
    register_from_manifest(MANIFEST, create_cassandra_document_store, override=override, contract_specs=CONTRACT_SPECS)
