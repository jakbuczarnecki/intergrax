...
from intergrax.integrations.providers.document_store.mongodb.contract_spec import CONTRACT_SPECS


def register_mongodb_integration(*, override: bool = False) -> None:
    register_from_manifest(MANIFEST, create_mongodb_document_store, override=override, contract_specs=CONTRACT_SPECS)
