...
from intergrax.integrations.providers.rerank_provider.jina_rerank.contract_spec import CONTRACT_SPECS
from intergrax.integrations.registry.plugin_register import register_from_manifest


def register_jina_rerank_integration(*, override: bool = False) -> None:
    register_from_manifest(MANIFEST, create_jina_rerank_provider, override=override, contract_specs=CONTRACT_SPECS)
