...
"""Unleash feature flag integration (INTEGRATIONS-2D · INTEGRATIONS-2E runtime cutover)."""
...
class UnleashFeatureFlagIntegration(FeatureFlagIntegrationContract):
    """
    Single public Unleash feature flag entrypoint.

    Legacy catalog factory (create_unleash_feature_flag) delegates to this class.
    """
    ...
    @classmethod
    def from_runtime(cls, runtime: Any, *, enabled: bool = True) -> UnleashFeatureFlagIntegration:
    ...
    def _require_runtime(self) -> Any:
        if self._runtime is None:
            raise IntegrationConfigurationError("Unleash integration requires a runtime delegate")
...
FeatureFlagBackend.register(UnleashFeatureFlagIntegration)
