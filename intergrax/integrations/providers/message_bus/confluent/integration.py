...
"""Confluent message bus integration (INTEGRATIONS-2D · INTEGRATIONS-2E runtime cutover)."""
...
ConfluentMessageBusClient = MessageBus

class ConfluentMessageBusIntegration(MessageBusIntegrationContract):
    """
    Single public Confluent message bus entrypoint.

    Legacy catalog factory (create_confluent_message_bus) owns catalog behavior; legacy factories use from_client().
    """
...
MessageBus.register(ConfluentMessageBusIntegration)
