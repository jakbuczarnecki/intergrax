...
"""Rabbitmq message bus integration (INTEGRATIONS-2D · INTEGRATIONS-2E runtime cutover)."""
...
RabbitmqMessageBusClient = MessageBus

class RabbitmqMessageBusIntegration(MessageBusIntegrationContract):
    """
    Single public Rabbitmq message bus entrypoint.

    Legacy catalog factory (create_rabbitmq_integration) owns catalog behavior; legacy factories use from_client().
    """
...
MessageBus.register(RabbitmqMessageBusIntegration)
