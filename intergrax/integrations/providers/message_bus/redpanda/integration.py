...
"""Redpanda message bus integration (INTEGRATIONS-2D · INTEGRATIONS-2E runtime cutover)."""
...
RedpandaMessageBusClient = MessageBus

class RedpandaMessageBusIntegration(MessageBusIntegrationContract):
    """
    Single public Redpanda message bus entrypoint.

    Legacy catalog factory (create_redpanda_message_bus) owns catalog behavior; legacy factories use from_client().
    """
...
MessageBus.register(RedpandaMessageBusIntegration)
