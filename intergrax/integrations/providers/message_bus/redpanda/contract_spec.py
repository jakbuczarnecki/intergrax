...
"""Explicit contract declaration for Redpanda message bus."""

from __future__ import annotations

from intergrax.integrations.providers.message_bus.redpanda.bundle import (
...
CONTRACT_SPEC = declare_integration_contract(
    ...
    integration_class=RedpandaMessageBusIntegration,
    contract_class=MessageBusIntegrationContract,
    contract_factory=create_redpanda_message_bus_integration,
    display_name="Redpanda",
    config_class=RedpandaMessageBusIntegrationConfig,
    capabilities=(
