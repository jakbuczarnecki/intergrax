...
class GithubActionsCiCdIntegration(CiCdIntegrationContract):
    ...
    Legacy catalog factory (create_github_actions_ci_cd) delegates to this class.
    """
    ...
    @classmethod
    def from_runtime(cls, runtime: Any, *, enabled: bool = True) -> GithubActionsCiCdIntegration:
    ...
    def _require_runtime(self) -> Any:
        if self._runtime is None:
            raise IntegrationConfigurationError("Github Actions integration requires a runtime delegate")
