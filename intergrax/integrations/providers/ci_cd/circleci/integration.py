...
class CircleciCiCdIntegration(CiCdIntegrationContract):
    ...
    Legacy catalog factory (create_circleci_ci_cd) delegates to this class.
    """
    ...
    @classmethod
    def from_runtime(cls, runtime: Any, *, enabled: bool = True) -> CircleciCiCdIntegration:
    ...
    def _require_runtime(self) -> Any:
        if self._runtime is None:
            raise IntegrationConfigurationError("Circleci integration requires a runtime delegate")
