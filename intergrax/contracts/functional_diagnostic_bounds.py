...
# Operator projection caps (DIAG-FUNCTIONAL-4) — aligned with analysis bounds.
MAX_FUNCTIONAL_OPERATOR_FAILURES = MAX_FUNCTIONAL_DIAGNOSTIC_CHECKS
MAX_FUNCTIONAL_OPERATOR_LIMITATIONS = MAX_FUNCTIONAL_DIAGNOSTIC_ANALYSIS_LIMITATIONS
MAX_FUNCTIONAL_OPERATOR_PASS_RESULTS = MAX_FUNCTIONAL_DIAGNOSTIC_CHECKS
