...
"""Typed functional validation evidence contract (DIAG-FUNCTIONAL-1)."""
...
PLATFORM_FUNCTIONAL_VALIDATION_EVIDENCE_SCHEMA = (
    "platform_functional_validation_evidence.v1"
)
...
class FunctionalValidatorRef(BaseModel):
    ...
    def _require_non_empty_identifier(cls, value: str) -> str:
        ...
        if value != normalized:
            raise ValueError(
                "validator identifiers must not contain leading or trailing whitespace"
            )
        return normalized
