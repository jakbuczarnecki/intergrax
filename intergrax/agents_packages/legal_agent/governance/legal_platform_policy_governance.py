...
Static org clamp (:func:`~intergrax.agents_packages.legal_agent.governance.legal_tool_plan_governance.enforce_legal_tool_plan_governance`)
still runs first; this layer applies **additional** caps (AND with the plan).

See also :mod:`intergrax.agents_packages.legal_agent.governance.legal_execution_policy_sources` (tenant registry,
request metadata, policy chains) and :mod:`intergrax.agents_packages.legal_agent.governance.legal_agent_governance_wiring`.
"""
...
from intergrax.agents_packages.legal_agent.domain.legal_tool_plan import (
    LegalToolPlan,
