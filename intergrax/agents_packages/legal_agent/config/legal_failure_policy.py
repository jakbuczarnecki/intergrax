...
on :class:`~intergrax.agents_packages.legal_agent.config.legal_agent_config.LegalAgentConfig`
...
:class:`~intergrax.agents_packages.legal_agent.steps.legal_extract_clauses_step.LegalExtractClausesStep`,
:func:`~intergrax.agents_packages.legal_agent.runtime.legal_tool_runtime_bridge.run_legal_tool_runtime_bridge`,
...
:func:`~intergrax.agents_packages.legal_agent.pipeline.legal_execution_loop._legal_post_wave_early_exit_ok`,
:func:`~intergrax.agents_packages.legal_agent.pipeline.legal_execution_loop._evaluate_legal_run_llm`,
:class:`~intergrax.agents_packages.legal_agent.steps.legal_finalize_answer_step.LegalFinalizeAnswerStep`.
"""
