...
wires them inside :func:`~intergrax.agents_packages.legal_agent.legal_execution_loop.run_legal_dynamic_execution_loop`
...
:attr:`~intergrax.agents_packages.legal_agent.legal_agent_config.LegalAgentConfig.governance_service`
and
:attr:`~intergrax.agents_packages.legal_agent.legal_agent_config.LegalAgentConfig.legal_tool_plan_governance`
to that instance.

Ready-made subclasses: :mod:`intergrax.agents_packages.legal_agent.legal_tool_plan_governance_impl`.
"""
