...
"""
Named product SKUs for :class:`~intergrax.agents_packages.legal_agent.legal_agent_config.LegalAgentConfig`.
...
:func:`~intergrax.agents_packages.legal_agent.legal_agent_governance_wiring.with_dual_legal_governance`.
"""
