...
"""Ingress dedup and canonical root launch for host-available bound capabilities (UCA-6C-R6-R5.8-H1-R1)."""
...
class ExecutionBoundCapabilityExecutionDispatchService(
    ExecutionBoundCapabilityExecutionDispatchPort,
):
    """Process-local ingress dedup — shares handler registry with qualified path."""
    ...
    def __init__(
        ...
        *,
        ...
        runtime_delegate: ExecutionBoundCapabilityExecutionRuntimeDelegate,
    ) -> None:
    ...
    def dispatch(
        ...
        with self._lock:
            ...
            payload = ExecutionBoundCapabilityExecutionIntakePayload(
...
__all__ = ["ExecutionBoundCapabilityExecutionDispatchService"]
