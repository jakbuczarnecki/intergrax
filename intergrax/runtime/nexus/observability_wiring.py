...
def wire_nexus_observability(
    *,
    ...
    elif integration_profile is not None:
        resolved_trace = open_trace_store_from_profile(integration_profile, db_path=trace_db_path)
        resolved_trace_path = trace_db_path or resolve_trace_db_path(None)
    else:
    ...
    if runtime_event_store is not None:
        ...
        resolved_events = open_runtime_event_store_from_profile(
            integration_profile,
            db_path=runtime_events_db_path,
        )
        resolved_events_path = runtime_events_db_path or resolve_runtime_events_db_path(None)
    else:
