...
"""Shared helpers for injecting RAG/websearch context into LLM message lists."""
...
def insert_context_before_last_user(
    ...
    """Insert context messages right before the last user message (or append)."""
...
def format_rag_context(chunks: Iterable[Any], *, max_chars: int = 4000) -> str:
    """Best-effort compact formatter resilient to different chunk shapes."""
    lines: List[str] = []
    total = 0
