...
def format_investigation_follow_up_context(
    *,
    ...
    return (
        ...
        "\n"
        "CONTRACT:\n"
        f"If additional evidence is necessary, emit exactly one {PLANNER_ROUND_TOOL_ID} call.\n"
        "If existing evidence is sufficient, return the final answer without a tool call.\n"
        "When calling planner.round, include action_context with evidence_basis_references "
        "(at least one exact value from "
