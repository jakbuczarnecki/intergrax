...
HOOK_COVERAGE: dict[HookPoint, HookCoverage] = {
    ...
    HookPoint.BEFORE_LLM_INFERENCE: HookCoverage.WIRED,
    HookPoint.AFTER_LLM_INFERENCE: HookCoverage.PARTIAL,
    HookPoint.BEFORE_LLM_OUTPUT: HookCoverage.NOT_WIRED,
    HookPoint.AFTER_LLM_OUTPUT: HookCoverage.WIRED,
