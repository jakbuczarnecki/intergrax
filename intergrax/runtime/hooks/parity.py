...
HOOK_COVERAGE: dict[HookPoint, HookCoverage] = {
    ...
    HookPoint.BEFORE_AGENT_SELECTION: HookCoverage.NOT_WIRED,
    HookPoint.AFTER_AGENT_SELECTION: HookCoverage.NOT_WIRED,
    ...
    HookPoint.BEFORE_TOOL_CALL: HookCoverage.NOT_WIRED,
    HookPoint.AFTER_TOOL_CALL: HookCoverage.NOT_WIRED,
    HookPoint.BEFORE_VALIDATION: HookCoverage.WIRED,
    HookPoint.AFTER_VALIDATION: HookCoverage.WIRED,
    HookPoint.BEFORE_DECISION: HookCoverage.NOT_WIRED,
    HookPoint.AFTER_DECISION: HookCoverage.NOT_WIRED,
    HookPoint.BEFORE_INTERRUPT: HookCoverage.NOT_WIRED,
    HookPoint.AFTER_INTERRUPT: HookCoverage.NOT_WIRED,
    HookPoint.BEFORE_HUMAN_APPROVAL: HookCoverage.WIRED,
    HookPoint.AFTER_HUMAN_APPROVAL: HookCoverage.WIRED,
    HookPoint.BEFORE_RETRY: HookCoverage.NOT_WIRED,
    HookPoint.AFTER_RETRY: HookCoverage.NOT_WIRED,
    ...
    HookPoint.BEFORE_TRACE_PERSIST: HookCoverage.PARTIAL,
    HookPoint.AFTER_TRACE_PERSIST: HookCoverage.PARTIAL,
}
