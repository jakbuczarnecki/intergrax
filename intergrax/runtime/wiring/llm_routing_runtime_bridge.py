...
"""Nexus runtime wiring for live LLM routing context."""
...
def make_config_routing_context_provider(config: RuntimeConfig):
...
def sync_llm_routing_snapshot_for_state(state: RuntimeState) -> RoutingContext:
    """Refresh routing snapshot from live Nexus ``RuntimeState``."""
