...
from dispute_scenario.steps.pipeline import build_pipeline, run_domain_step
...
class DisputeScenarioAgent(Agent):
    ...
    def get_steps(self, context: RuntimeContext) -> list[AgentStep]:
        ...
        return pipeline_agent_steps(
            step_id="dispute_scenario_step",
            step_name="dispute_scenario_step",
            trace_label="dispute.scenario",
    ...
    def decide_after_step(
        ...
        _ = step, output, ctx
        return pipeline_step_complete(reason="dispute_scenario step finished")
