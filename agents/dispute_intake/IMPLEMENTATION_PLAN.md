...
|----|------|--------|----------|-------|
| DISPUTE_INTAKE-1 | Replace scaffold stub in `steps/pipeline.py` | Planned | High | One PR per domain step |
| DISPUTE_INTAKE-2 | Extend `prompts/system.md` for domain | Planned | Medium | Keep prompts versioned here |
| DISPUTE_INTAKE-3 | Register skills/tools on `contract.py` | Planned | Medium | See `docs/architecture/SKILLS.md` |
