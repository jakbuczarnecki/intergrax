...
from local_synthesizer.steps.pipeline import build_pipeline, run_domain_step
...
class LocalSynthesizerAgent(Agent):
    ...
    def get_steps(self, context: RuntimeContext) -> list[AgentStep]:
        ...
        return pipeline_agent_steps(
            step_id="local_synthesizer_step",
            step_name="local_synthesizer_step",
            trace_label="local.workspace.synthesize",
    ...
    def decide_after_step(
        ...
        _ = step, output, ctx
        return pipeline_step_complete(reason="local_synthesizer step finished")
