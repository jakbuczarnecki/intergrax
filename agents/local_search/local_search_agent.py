...
from local_search.steps.pipeline import build_pipeline, run_domain_step
...
class LocalSearchAgent(Agent):
    ...
    def get_steps(self, context: RuntimeContext) -> list[AgentStep]:
        ...
        return pipeline_agent_steps(
            step_id="local_search_step",
            step_name="local_search_step",
            trace_label="local.workspace.search",
    ...
    def decide_after_step(
        ...
        _ = step, output, ctx
        return pipeline_step_complete(reason="local_search step finished")
