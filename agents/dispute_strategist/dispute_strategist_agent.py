...
from dispute_strategist.steps.pipeline import build_pipeline, run_domain_step
...
class DisputeStrategistAgent(Agent):
    ...
    def get_steps(self, context: RuntimeContext) -> list[AgentStep]:
        ...
        return pipeline_agent_steps(
            step_id="dispute_strategist_step",
            step_name="dispute_strategist_step",
            trace_label="dispute.strategy",
    ...
    def decide_after_step(
        ...
        _ = step, output, ctx
        return pipeline_step_complete(reason="dispute_strategist step finished")
