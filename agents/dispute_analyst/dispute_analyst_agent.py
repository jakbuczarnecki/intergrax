...
from dispute_analyst.steps.pipeline import build_pipeline, run_domain_step
...
class DisputeAnalystAgent(Agent):
    ...
    def get_steps(self, context: RuntimeContext) -> list[AgentStep]:
        ...
        return pipeline_agent_steps(
            step_id="dispute_analyst_step",
            step_name="dispute_analyst_step",
            trace_label="dispute.analyze",
    ...
    def decide_after_step(
        ...
        _ = step, output, ctx
        return pipeline_step_complete(reason="dispute_analyst step finished")
