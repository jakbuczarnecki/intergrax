...
"""Provider-neutral Tier-2 external-work adapter (GEC-3).

Owns mapping / correlation / normalization only. Does not own governance,
HITL, policy, payments, receipts, polling, or transport.
"""
