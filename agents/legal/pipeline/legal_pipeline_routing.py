...
from legal.memory.legal_memory_policy import build_legal_conversation_snippet
...
from legal.steps.legal_extract_clauses_step import (
    LegalExtractClausesStep,
)
from legal.steps.legal_finalize_answer_step import (
    LegalFinalizeAnswerStep,
)
from legal.steps.legal_normalize_clauses_step import (
    LegalNormalizeClausesStep,
)
from legal.steps.legal_policy_compliance_step import (
    LegalPolicyComplianceStep,
)
from legal.steps.legal_recommendation_step import (
    LegalRecommendationStep,
)
from legal.steps.legal_risk_analysis_step import (
