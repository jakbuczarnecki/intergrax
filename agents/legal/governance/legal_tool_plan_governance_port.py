...
wires them inside :func:`~legal.pipeline.legal_execution_loop.run_legal_dynamic_execution_loop`
...
:attr:`~legal.config.legal_agent_config.LegalAgentConfig.governance_service`
and
:attr:`~legal.config.legal_agent_config.LegalAgentConfig.legal_tool_plan_governance`
to that instance.
