...
"""
Named product SKUs for :class:`~legal.config.legal_agent_config.LegalAgentConfig`.
...
:func:`~legal.governance.legal_agent_governance_wiring.with_dual_legal_governance`.
"""
...
from legal.memory.legal_memory_policy import LegalMemoryPolicyPresets
