...
on :class:`~legal.config.legal_agent_config.LegalAgentConfig`
...
:class:`~legal.steps.legal_extract_clauses_step.LegalExtractClausesStep`,
:func:`~legal.runtime.legal_tool_runtime_bridge.run_legal_tool_runtime_bridge`,
...
:func:`~legal.pipeline.legal_execution_loop._legal_post_wave_early_exit_ok`,
:func:`~legal.pipeline.legal_execution_loop._evaluate_legal_run_llm`,
:class:`~legal.steps.legal_finalize_answer_step.LegalFinalizeAnswerStep`.
"""
