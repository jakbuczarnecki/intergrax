...
from legal.domain.legal_shaped_client_response import (
...
from legal.domain.legal_product_observability import (
    LegalProductObservability,
)
from legal.tracing.legal_finalize_answer_step_diag_v1 import (
