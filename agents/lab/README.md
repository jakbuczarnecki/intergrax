...
For real harness reference agents use `agents/echo` or `agents/signoff_probe`. See [ARCHITECTURE.md](../echo/ARCHITECTURE.md) and `docs/project/technical/guides/AGENT_CREATION_GUIDE.md`.
