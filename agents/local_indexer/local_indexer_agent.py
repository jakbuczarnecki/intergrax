...
from local_indexer.steps.pipeline import build_pipeline, run_domain_step
...
class LocalIndexerAgent(Agent):
    ...
    def get_steps(self, context: RuntimeContext) -> list[AgentStep]:
        ...
        return pipeline_agent_steps(
            ...
            trace_label="local.workspace.index",
    ...
    def decide_after_step(
        ...
        _ = step, output, ctx
        return pipeline_step_complete(reason="local_indexer step finished")
