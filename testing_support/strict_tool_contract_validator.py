...
class StrictToolContractValidationError(ValueError):
...
def validate_tool_calls_against_canonical_definitions(
    ...
    tool_definitions: Sequence[CanonicalFunctionToolDefinition | Mapping[str, Any]],
) -> None:
    ...
    definitions_by_name = {
        _tool_name_from_definition(definition): definition for definition in definitions
    }
