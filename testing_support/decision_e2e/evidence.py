...
def scenario_execution_evidence_ref(
    ...
    detail = (
        ...
        f"requested_provider={evidence.requested_provider or 'default'};"
        f"requested_model={evidence.requested_model or 'default'};"
        f"resolved_provider={evidence.resolved_provider or evidence.provider};"
        f"resolved_model={evidence.resolved_model or evidence.model or 'default'};"
        f"binding_source={evidence.binding_source or 'unknown'};"
