...
"""Deterministic fake executor for qualification plan certification and unit tests."""
...
class FakeQualificationSuiteExecutor:
    def __init__(
        ...
        *,
        ...
        status_overrides: Mapping[str, QualificationSuiteStatus] | None = None,
    ) -> None:
        ...
        self._status_overrides: dict[str, QualificationSuiteStatus] = dict(
            status_overrides or (),
        )
