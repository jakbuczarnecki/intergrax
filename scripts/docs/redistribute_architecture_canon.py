...
Snapshots and conformance CI validate registry shape before release (`scripts/maintenance/check_agents_lifecycle_metadata.py`, harness registry guards).
...
| `scripts/release/phase_v_capability_graph_guard.py` | CI guard |
